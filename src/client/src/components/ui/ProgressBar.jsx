            ...
            return (
              ...
              >
                ...
                <div className="relative group">
                  ...
                  {/* Hover Tooltip - only show on mobile when labels are hidden */}
                  {hideLabelsOnMobile && (
                    <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden group-hover:block md:hidden z-20">
                ...
                {/* Step label - hide on mobile if hideLabelsOnMobile is true */}
                <div className={`mt-3 text-center ${hideLabelsOnMobile ? 'hidden md:block' : ''}`}>
                  <p className={`
                    text-sm font-medium
                    ${status === 'current' ? 'text-blue-600' : ''}
                    ${status === 'completed' ? 'text-green-600' : ''}

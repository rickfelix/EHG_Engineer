...
-- after three independent, evidence-targeted fix attempts all failed identically against the real
-- CI Postgres environment; deferred to a follow-up migration.
--
-- @approved-by:

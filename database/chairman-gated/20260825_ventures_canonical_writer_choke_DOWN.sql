...
--
-- SCOPE: the DB guard objects ONLY (2 triggers + 2 functions). Deliberately RETAINS
-- ventures.stage_write_token and every RPC/JS self-stamp — every stamping writer keeps working with
-- no code revert; it just writes an ordinary, now-unvalidated column.
--

-- Migration: Require KR Alignment for New SDs
...
-- ============================================================================
-- 1. CREATE WARNING VIEW FOR UNALIGNED SDs
-- ============================================================================
...
CREATE OR REPLACE FUNCTION check_sd_kr_alignment(p_sd_id UUID)
RETURNS TABLE (
    is_aligned BOOLEAN,
    alignment_count INT,
    kr_codes TEXT[],
...
-- ============================================================================
-- 3. CREATE SOFT ENFORCEMENT TRIGGER
-- ============================================================================
...
-- ============================================================================
-- 4. CREATE LEAD GATE CHECK FUNCTION
-- ============================================================================
...
-- ============================================================================
-- 5. ADD TO LEAD APPROVAL CHECKLIST (if exists)
-- ============================================================================
...
GRANT EXECUTE ON FUNCTION check_sd_kr_alignment(UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION check_sd_kr_alignment(UUID) TO service_role;

-- Migration: LLM Registry Ollama Integration
-- SD: SD-LEO-INFRA-INTELLIGENT-LOCAL-LLM-001B
-- Purpose: Add Ollama provider and local model for Haiku replacement
-- Date: 2026-02-05

-- Step 1: Add leo_tier column to llm_models for LEO Protocol tier mapping
...
-- Step 2: Add is_local flag to distinguish local vs cloud models
ALTER TABLE llm_models
...
-- Step 4: Add qwen3-coder:30b as local Haiku replacement
...
-- Step 5: Add/update current Anthropic Claude models with LEO tiers
-- Claude Haiku 3.5
INSERT INTO llm_models (
  provider_id,
  model_key,
...
-- Step 6: Add provider_source column to model_usage_log for tracking local vs cloud
...
-- Step 7: Create index for efficient tier lookups
...
-- Step 8: Create view for model registry lookup (used by client-factory.js)

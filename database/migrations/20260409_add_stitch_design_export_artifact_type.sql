-- Migration: Add 'stitch_design_export' to venture_artifacts_artifact_type_check
-- SD: SD-LEO-ORCH-STAGE-STITCH-DESIGN-001-A
-- US: US-001 (BLOCKER dependency for downstream EXEC work)
-- DATABASE sub-agent: 3238464b-b9c7-41d4-8550-2bc9515a85d8
-- Date: 2026-04-09
--
...
--
-- All 88 existing values below are preserved verbatim from pg_get_constraintdef().
-- The ONLY new addition is 'stitch_design_export' at the end of the list.

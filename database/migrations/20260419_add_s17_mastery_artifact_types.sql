-- Add s17_design_system and s17_strategy_stats to venture_artifacts CHECK constraint
-- Required by: SD-S17-DESIGN-MASTERY-PIPELINE-ORCH-001-B (design mastering)
--               SD-S17-DESIGN-MASTERY-PIPELINE-ORCH-001-C (strategy stats)
-- SAFE: Merges ALL existing types + new additions. No types removed.
-- Executed: 2026-04-19 by database-agent after constraint introspection
-- Pre-execution: 102 types. Post-execution: 131 types.
...
-- Rollback:
-- ALTER TABLE venture_artifacts DROP CONSTRAINT IF EXISTS venture_artifacts_artifact_type_check;
-- Then re-run the previous constraint definition (102 types, without s17_design_system and s17_strategy_stats)

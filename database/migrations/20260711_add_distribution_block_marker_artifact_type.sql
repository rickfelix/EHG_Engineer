...
--
-- COORDINATION NOTE (sibling migration on the SAME constraint): stage_17_refined
-- (database/migrations/20260711_add_stage_17_refined_artifact_type.sql) was
-- applied FIRST (chairman verbal ~6:20 AM ET). Both migrations DROP+ADD the
-- full constraint (Postgres has no ADD-one-value-to-an-existing-CHECK syntax),
-- so this migration — applied SECOND — carries a value list that already
-- includes 'stage_17_refined' alongside 'distribution_block_marker', matching
-- the live constraint (pg_constraint readback verified 2026-07-12; both values
-- confirmed present on the live public.venture_artifacts table, QF-20260712-058
-- reconciliation). Reconciled per mig/s21-block-marker-approval (commit
-- 01cc37eab76).
--

...
-- Author: Claude (AUTO-PROCEED Enhancement Implementation)
-- Date: 2026-01-25

-- ============================================================================
-- AUTO_PROCEED_SESSIONS TABLE
-- ============================================================================
-- Tracks AUTO-PROCEED session state for crash recovery.
-- When a session crashes mid-orchestrator, this table allows:
-- 1. Auto-loading state via UnifiedStateManager
-- 2. Explicit /leo resume command
...
-- ============================================================================
-- This migration adds:
-- 1. auto_proceed_sessions - State tracking for AUTO-PROCEED crash recovery
-- 2. Indexes for efficient lookups
-- 3. Unique constraint for single active session per session_id
-- 4. Helper functions for session management
-- 5. View for active sessions dashboard
--
-- Usage:
-- 1. Start session: SELECT upsert_auto_proceed_session('session_123', 'SD-XXX-001');
-- 2. Update progress: SELECT update_auto_proceed_progress('session_123', NULL, 'EXEC');
-- 3. Get for recovery: SELECT * FROM get_active_auto_proceed_session();
-- 4. End session: SELECT deactivate_auto_proceed_session('session_123');

...
-- The gate checks that CLAUDE_DIGEST.md, CLAUDE_CORE_DIGEST.md, and
-- phase-specific digest files have been read before each handoff.
...
INSERT INTO leo_validation_rules (
  protocol_id, gate, rule_name, weight, criteria, required, active,
  handoff_type, execution_order, severity, applies_to_agent, rule_type, rule_definition
) VALUES (
  'leo-v4-3-3-ui-parity',
  '1',
  ...
  'PLAN',
  'heuristic',
  '{"rule": "documentation_standards_compliance", "description": "Validates documentation SDs address project standards before EXEC", "condition": "sd_type = documentation", "check": "PRD functional_requirements or acceptance_criteria mentions standards, formatting, or conventions", "severity": "warning", "remediation": "Add documentation standards checklist to PRD covering: file naming, markdown formatting, section structure, cross-references"}'::jsonb
)
ON CONFLICT DO NOTHING;

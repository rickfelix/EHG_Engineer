...
--
-- Changes:
-- 1. Update existing records from mixed-case to all-uppercase
-- 2. Drop old CHECK constraint
-- 3. Add new CHECK constraint with all-uppercase values
--
-- Backward Compatibility: Maintains same 4 handoff types, just uppercase format
-- Risk: LOW - Constraint change only, no data loss
-- ============================================================================

-- Step 1: Update existing records to all-uppercase format
...
-- Step 3: Add new CHECK constraint with all-uppercase values
ALTER TABLE sd_phase_handoffs

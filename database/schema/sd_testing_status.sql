-- SD Testing Status Table
-- Tracks which Strategic Directives have been tested vs pending
-- Prevents duplicate testing by recording test evidence
...
-- Function to calculate testing priority based on SD metadata
...
-- Trigger to auto-calculate testing_priority on insert/update
...
-- View: Untested SDs (work-down plan)

...
-- Deprecated: view definitions moved to db/views/eng/*.sql during 2025-09-22 housekeeping.
-- See v_eng_trace.sql, v_eng_prd_payload_v1.sql, and v_eng_backlog_rollup.sql for canonical exports.

-- =============================================================================
-- E. PRD Generation View (updated to use existing tables)
-- =============================================================================

-- Deprecated in favor of versioned view files under db/views/eng/.

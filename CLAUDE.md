...
**Last Generated**: 2025-10-02 5:00:39 PM
...
1. **Strategic Direction & Scope Definition**
   - Define business objectives
   - Set priorities (CRITICAL: 90+, HIGH: 70-89, MEDIUM: 50-69, LOW: 30-49)
   - **Apply simplicity evaluation and scope reduction BEFORE approval**
   - **Approve strategic directives = commit to full scope**
   - Document scope reduction rationale if changes made
   - Create separate SDs for any deferred work
...
**IMPORTANT**: Claude CAN execute SQL migrations directly using proven patterns below. The Supabase Dashboard method is a fallback only.
...
#### Method 4: Supabase Dashboard (Manual Fallback)
Only use if automated methods fail:
...
*Generated from Database: 2025-10-02*

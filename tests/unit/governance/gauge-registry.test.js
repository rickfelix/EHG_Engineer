...
describe('GAUGE_REGISTRY shape', () => {
  it('exports exactly 14 seed entries (8 prior + 6 loop-health-*, SD-LEO-INFRA-009-LEAF-PER-001)', () => {
    expect(GAUGE_REGISTRY).toHaveLength(14);
  });

  it('all 14 entries are activated — no stub entries remain', () => {

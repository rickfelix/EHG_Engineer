...
const RECONCILIATION_MIGRATION_PATHS = [
  ...
  // QF-20260905-230: the new sweep_finding_alert kind, coordinator-only (the sink's only writer,
  // stale-session-sweep.cjs, only ever targets the coordinator).
  path.join(REPO_ROOT, 'database/migrations/20260906_role_drain_sets_add_sweep_finding_alert.sql'),

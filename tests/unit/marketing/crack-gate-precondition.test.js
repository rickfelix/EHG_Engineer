...
// SD-LEO-INFRA-ARM-BINDING-EXIT-001's FR-5/TS-7 "this branch never touches these 2 files"
// diff-empty proof lived here. It measured a one-time scope property of THAT SD's own branch
// (checked at merge-base vs origin/main), not a standing invariant -- once that SD merged, the
// same assertion became a permanent false-positive trap for every future legitimate change to
// either file, including this one (FR-6, SD-LEO-INFRA-VENTURE-JOURNEY-UAT-001, adds
// checkDeployFreshness() to crack-gate-evaluator.js). Removed rather than worked around: a test
// asserting "my branch does not touch file X" is only ever true for the branch that wrote it.

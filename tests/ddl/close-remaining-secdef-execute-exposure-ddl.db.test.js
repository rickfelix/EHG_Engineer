...
// statement + self-test). FR-4 was DESCOPED to a follow-up migration at EXEC-TO-PLAN — a direct
// cross-transaction outcome measurement here (a real probe function created in a separate,
// post-COMMIT statement) found the ADP REVOKE does not reliably suppress anon EXECUTE on newly
// created functions in this environment. See the forward migration's own header for the full note.
// This file's STUB_SCHEMA, tests, and helpers were trimmed accordingly — Buckets A/B/C only.
//

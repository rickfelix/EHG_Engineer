...
- [RCA Issue Resolution Mandate](#rca-issue-resolution-mandate)
- [⚠️ CRITICAL: Issue Resolution Protocol](#-critical-issue-resolution-protocol)
  - [Sub-Agent Prompt Quality Standard (Five-Point Brief)](#sub-agent-prompt-quality-standard-five-point-brief)
...
- [Mandatory Agent Invocation Rules](#mandatory-agent-invocation-rules)
  - [Task Type -> Required Agent](#task-type---required-agent)
  - [Why This Exists](#why-this-exists)
  - [How to Apply](#how-to-apply)
- [SD Continuation Truth Table](#sd-continuation-truth-table)
  - [Complete Transition Matrix](#complete-transition-matrix)
  - [Phase Work Between Handoffs (D34 - Added 2026-02-06)](#phase-work-between-handoffs-d34---added-2026-02-06)
  - [Key Rules](#key-rules)
  - [Next SD Selection Priority](#next-sd-selection-priority)
  - [Decision Flow (Complete)](#decision-flow-complete)
...
- [AUTO-PROCEED Mode](#auto-proceed-mode)
  - [Activation](#activation)
  - [Behavior Summary](#behavior-summary)
  - [CRITICAL: No Background Tasks](#critical-no-background-tasks)
  - [Platform-Level Enforcement](#platform-level-enforcement)
  - [Pause Points (When ON)](#pause-points-when-on)
  - [Multi-Session Coordination Infrastructure](#multi-session-coordination-infrastructure)
  - [Error Resolution with RCA Sub-Agent](#error-resolution-with-rca-sub-agent)
  - [How to Stop](#how-to-stop)
  - [Quick Start](#quick-start)
  - [Discovery Decisions Summary (D01-D29)](#discovery-decisions-summary-d01-d29)
...
- [Sub-Agent Invocation Quality Standard](#sub-agent-invocation-quality-standard)
  - [Required Elements (The Five-Point Brief)](#required-elements-the-five-point-brief)
  - [What to EXCLUDE from Sub-Agent Prompts](#what-to-exclude-from-sub-agent-prompts)

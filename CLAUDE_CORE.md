<!-- file_content_hash: a689a575fbf9e1a3 -->
<!-- GENERATED FILE - DO NOT EDIT DIRECTLY. Source of truth: leo_protocol_sections (DB). Regenerate: node scripts/generate-claude-md-from-db.js. Drift check: node scripts/check-claude-md-drift.cjs -->
# CLAUDE_CORE.md - LEO Protocol Core Context

**Generated**: 2026-08-23 10:47:49 AM
**Protocol**: LEO 4.4.1
...
For writes (migrations, schema changes, INSERT/UPDATE/DELETE), use database-agent.
apply_migration is blocked by PreToolUse hook — use database-agent instead.
...
**Key Improvements**:
- PRD_v2 linkage trap re-cost time: product_requirements_v2.directive_id holds the sd_KEY string, not ...
- Grader↔loader import cycle had to be discovered and broken at wiring time rather than being prevente...
...
**Key Improvements**:
- No specific issues identified - handoff executed smoothly
- SD-EHG-PRODUCT-UIUX-REMEDIATION-001-E-B proceeded without PRD - scope defined informally
...
**Key Improvements**:
- The VALIDATION sub-agent false-positive on FR-4 (commented-out legacy code misread as live rendered ...
- `npm run build`'s combined script (type-check && lint && vite build) failed at the lint stage due to...

**Action Items**:
- [ ] Follow-on test-suite cleanup: update the ~20 e2e/visual test spec files in the e...
- [ ] Remove the residual /ai-agents label-map entry in AccessibilityEnhancements.tsx:...

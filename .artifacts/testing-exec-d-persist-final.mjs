...
// --- runner artifacts -------------------------------------------------------
const shippedPath = R + 'michael-d-shipped-v3.json';
const fullPath = R + 'unit-full.json';
const floorPath = R + 'baseline-floor-v3.json';
const lintPath = R + 'eslint-shipped-v3.json';
const smokePath = R + 'ts15-smoke-v3.json';

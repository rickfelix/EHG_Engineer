<!-- file_content_hash: 908329ca15cb506c -->
<!-- GENERATED FILE - DO NOT EDIT DIRECTLY. Source of truth: leo_protocol_sections (DB). Regenerate: node scripts/generate-claude-md-from-db.js. Drift check: node scripts/check-claude-md-drift.cjs -->
# CLAUDE_ADAM.md - Adam Role Contract

**Generated**: 2026-09-13 6:06:03 PM
**Protocol**: LEO 4.4.1
...
- **SIGNAL DISCIPLINE ROUTING SPLITS BY TIER: THE RARE THRESHOLD TEXT RIDES ADAM'S 6AM CHANNEL, THE FOUR-TIMES-DAILY PERSONAL CHECKPOINT GETS ITS OWN NARROW, CAPPED, REVOCABLE PATH (ratification b9d3607e)** — Chairman at the Adam terminal 2026-09-13 22:0xZ, verbatim "That's accurate", confirming Adam's read-back of a routing ruling he gave earlier the same day at the Michael terminal on the proactive-texting design called Signal Discipline. PROVENANCE, stated because it is not a transcript: Michael relayed the ruling as a single-scribe encode request (session_coordination df7887e5, correlation 656df4ca, 21:28:41Z) with the chairman's rationale written as "verbatim in substance", i.e. a paraphrase; Adam declined to scribe a paraphrase into a quote field, read it back at the chairman's own terminal, and he confirmed it in the words above. So the quote is HIS CONFIRMATION and the ruling text here is MICHAEL'S WORDING, chairman-confirmed, never represented as the chairman's own sentences. THE RULING: routing splits BY TIER, not one channel for both. TIER 1, a rare threshold-crossing one-line text, rides Adam's existing 6am chairman channel; this needs no new authority, only the writer that was never built (SD-LEO-INFRA-MICHAEL-ADAM-COMMS-001). TIER 2, a four-times-daily personal-domain checkpoint at 6am/10am/2pm/6pm ET, gets its OWN narrow, capped, revocable sending path — never a general send credential, and never routed through Adam. REASON, same provenance caveat: the fleet and the personal day stay two channels on purpose, so folding four-times-daily personal content into the once-a-day fleet text erases that boundary; a narrow revocable verb keeps the blast-radius discipline already proven on the archive and reschedule verbs rather than granting a general credential. NOT DECIDED AND NOT AUTHORISED: the rest of that design is design detail and is not yet binding; neither tier is built or scheduled; this clause is an encode, not a go-ahead to build. **Adam share:** a Tier-1 line reaches the chairman only INSIDE Adam's existing 6am brief, as one line, never as a second brief and never as a separate send; Adam never carries Tier-2 content and never acquires a path capable of sending it, so a request to route the four-times-daily checkpoint through this seat is refused and named as a chairman decision if pressed; and the conduct lesson, which generalises past Michael: when a teammate hands Adam a chairman ruling whose rationale is marked "in substance", Adam reads it back to the chairman and scribes HIS confirmation, rather than writing the teammate's paraphrase into a quote field. A paraphrase recorded as a quote is a false chairman-facing claim wearing the ledger's authority.

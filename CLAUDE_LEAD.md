...
- [⚠️ Current Vision Gaps (Live — from issue_patterns)](#-current-vision-gaps-live-from-issue_patterns)
- [Baseline Issues Management](#baseline-issues-management)
- [Baseline Issues System](#baseline-issues-system)
  - [LEAD Gate: BASELINE_DEBT_CHECK](#lead-gate-baseline_debt_check)
  - [Lifecycle](#lifecycle)
  - [Commands](#commands)
  - [Categories](#categories)
  - [Issue Key Format](#issue-key-format)
  - [Functions](#functions)
- [🔍 Explore Before Validation (LEAD Phase)](#-explore-before-validation-lead-phase)
- [Explore Before Validation](#explore-before-validation)
  - [Pattern: Discovery → Validation](#pattern-discovery-validation)
  - [Why This Order?](#why-this-order)
  - [When to Skip Explore](#when-to-skip-explore)
  - [Example: New Feature Discovery](#example-new-feature-discovery)
- [SD to Quick Fix Reverse Rubric (LEO v4.3.3)](#sd-to-quick-fix-reverse-rubric-leo-v433)
- [SD to Quick Fix Reverse Rubric](#sd-to-quick-fix-reverse-rubric)
  - [Downgrade Criteria (ALL must be true)](#downgrade-criteria-all-must-be-true)
  - [Anti-Criteria (ANY blocks downgrade)](#anti-criteria-any-blocks-downgrade)
  - [SD Type Classification (NEW - LEO v4.3.3)](#sd-type-classification-new---leo-v433)
  - [Documentation-Only SD Handling](#documentation-only-sd-handling)
  - [LEAD Agent Action](#lead-agent-action)
  - [Reference](#reference)
- [SD Orchestration & Baseline Management](#sd-orchestration-baseline-management)
- [SD Orchestration & Baseline Management (LEAD Responsibility)](#sd-orchestration-baseline-management-lead-responsibility)
  - [LEAD Owns SD Prioritization](#lead-owns-sd-prioritization)
  - [Commands (LEAD Authority)](#commands-lead-authority)
  - [Track Definitions](#track-definitions)
  - [Rebaseline Triggers](#rebaseline-triggers)
  - [Dependency Health Score](#dependency-health-score)
  - [Conflict Detection](#conflict-detection)
- [Strategic Directive Creation Process](#strategic-directive-creation-process)
  - [Overview](#overview)
  - [Step 1: Create SD Record in Database](#step-1-create-sd-record-in-database)
  - [Required Fields (ALL SDs)](#required-fields-all-sds)
  - [JSONB Field Constraints (Database-Enforced)](#jsonb-field-constraints-database-enforced)
  - [Success Metrics Requirement (MANDATORY)](#success-metrics-requirement-mandatory)
  - [SD Type-Specific Requirements](#sd-type-specific-requirements)
  - [Step 2: LEAD Strategic Validation (9-Question Gate)](#step-2-lead-strategic-validation-9-question-gate)
  - [Step 3: Execute Handoff Chain](#step-3-execute-handoff-chain)
  - [Validation Gates per Handoff](#validation-gates-per-handoff)
  - [Reference Documents](#reference-documents)
- [Common SD Creation Errors and Solutions](#common-sd-creation-errors-and-solutions)
  - [Database Constraint Errors](#database-constraint-errors)
  - [Handoff Validation Errors](#handoff-validation-errors)
  - [SD Type Errors](#sd-type-errors)
  - [Branch and Git Errors](#branch-and-git-errors)
  - [Quick Diagnostic Commands](#quick-diagnostic-commands)
  - [SDKeyGenerator Errors (SD-LEO-SDKEY-001)](#sdkeygenerator-errors-sd-leo-sdkey-001)
  - [Using /leo create Command](#using-leo-create-command)
- [Child SD Context Loading (MANDATORY)](#child-sd-context-loading-mandatory)
  - [Why This Applies to Children](#why-this-applies-to-children)
  - [Required Context Loading Sequence](#required-context-loading-sequence)
  - [What CLAUDE_CORE_DIGEST.md Provides](#what-claude_core_digestmd-provides)
  - [Consequences of Skipping Context Loading](#consequences-of-skipping-context-loading)
  - [Enforcement](#enforcement)
  - [Quick Reference](#quick-reference)
- [📋 Directive Submission Review Process](#-directive-submission-review-process)
- [🔍 Strategic Validation Question 7: UI Inspectability](#-strategic-validation-question-7-ui-inspectability)
- [Strategic Validation Question 7: UI Inspectability](#strategic-validation-question-7-ui-inspectability)
  - [The Question](#the-question)
  - [Evaluation Criteria](#evaluation-criteria)
  - [LEAD Agent Actions](#lead-agent-actions)
  - [Integration with 6-Question Gate](#integration-with-6-question-gate)
- [🎯 Strategic Validation Question 9: Human-Verifiable Outcome](#-strategic-validation-question-9-human-verifiable-outcome)
- [Strategic Validation Question 9: Human-Verifiable Outcome](#strategic-validation-question-9-human-verifiable-outcome)
  - [The Question](#the-question)
  - [Evaluation Criteria](#evaluation-criteria)
  - [Required Format: smoke_test_steps](#required-format-smoke_test_steps)
  - [LEAD Agent Actions](#lead-agent-actions)
  - [SD Type Exemptions](#sd-type-exemptions)
  - [Integration with Validation Gates](#integration-with-validation-gates)
- [📚 Automated PRD Enrichment (MANDATORY)](#-automated-prd-enrichment-mandatory)
- [Step 0: Knowledge Preflight Check](#step-0-knowledge-preflight-check)
- [What This Does](#what-this-does)
- [How to Use Results](#how-to-use-results)
  - [In PRD "Technical Approach" Section](#in-prd-technical-approach-section)
  - [In PRD "Risks & Mitigations" Section](#in-prd-risks-mitigations-section)
  - [In PRD "Acceptance Criteria"](#in-prd-acceptance-criteria)
- [Verification](#verification)
- [Reference Materials](#reference-materials)
  - [Historical Patterns Consulted](#historical-patterns-consulted)
  - [Prevention Measures Applied](#prevention-measures-applied)
- [Why This Matters](#why-this-matters)
- [Quick Reference](#quick-reference)
- [6-Step SD Evaluation Checklist](#6-step-sd-evaluation-checklist)
- [Quality Validation Examples](#quality-validation-examples)
  - [LEAD Pre-Approval Validation Examples](#lead-pre-approval-validation-examples)
  - [Quality Gate Benefits](#quality-gate-benefits)
- [LEAD Code Review for UI/UX SDs](#lead-code-review-for-uiux-sds)
- [LEAD Code Review Requirement (For UI/UX SDs)](#lead-code-review-requirement-for-uiux-sds)
  - [When Code Review is MANDATORY](#when-code-review-is-mandatory)
  - [Why Code Review First?](#why-code-review-first)
  - [Process:](#process)
- [Refactoring SD Evaluation](#refactoring-sd-evaluation)
  - [SD Type Classification for Refactoring](#sd-type-classification-for-refactoring)
  - [Intensity Level Classification (REQUIRED for refactor SDs)](#intensity-level-classification-required-for-refactor-sds)
  - [Refactoring-Specific LEAD Validation Questions](#refactoring-specific-lead-validation-questions)
  - [Workflow Selection by Intensity](#workflow-selection-by-intensity)
  - [Example: Approving a Refactoring SD](#example-approving-a-refactoring-sd)
  - [Anti-Patterns to Reject](#anti-patterns-to-reject)
- [🛡️ LEAD Pre-Approval Strategic Validation Gate](#-lead-pre-approval-strategic-validation-gate)
  - [MANDATORY Before Approving ANY Strategic Directive](#mandatory-before-approving-any-strategic-directive)
- [Parent-Child Decomposition Approval](#parent-child-decomposition-approval)
  - [When PLAN Proposes Decomposition](#when-plan-proposes-decomposition)
  - [LEAD Review of Parent SD](#lead-review-of-parent-sd)
  - [LEAD Review of Each Child SD](#lead-review-of-each-child-sd)
  - [Why Individual Child Approval Matters](#why-individual-child-approval-matters)
  - [Rejecting a Child](#rejecting-a-child)
  - [Parent Completion Approval](#parent-completion-approval)
  - [Anti-Pattern: Batch Approval](#anti-pattern-batch-approval)
- [Vision V2 SD Handling (SD-VISION-V2-*)](#vision-v2-sd-handling-sd-vision-v2-)
  - [MANDATORY: Vision Spec Reference Check](#mandatory-vision-spec-reference-check)
  - [Vision Document Locations](#vision-document-locations)
  - [LEAD Approval Gate for Vision V2 SDs](#lead-approval-gate-for-vision-v2-sds)
  - [Implementation Guidance](#implementation-guidance)
- [SD Creation Anti-Pattern (PROHIBITED)](#sd-creation-anti-pattern-prohibited)
  - [Why This Matters](#why-this-matters)
  - [Archived Scripts Location](#archived-scripts-location)
  - [Correct Workflow](#correct-workflow)
- [Parent-Child SD Phase Governance](#parent-child-sd-phase-governance)
- [Parent-Child SD Phase Governance (PAT-PARENT-CHILD-001)](#parent-child-sd-phase-governance-pat-parent-child-001)
  - [Overview](#overview)
...
- [Multi-Track Parallel Execution](#multi-track-parallel-execution)
  - [Track System Overview](#track-system-overview)
  - [How To Present SD Options](#how-to-present-sd-options)
  - [Conflict Prevention](#conflict-prevention)
  - [Single vs Multi-Instance Decision](#single-vs-multi-instance-decision)
  - [Commands Reference](#commands-reference)
- [OKR Alignment in LEAD Evaluation](#okr-alignment-in-lead-evaluation)
  - [Quick Alignment Check](#quick-alignment-check)
  - [Alignment Query Pattern](#alignment-query-pattern)
  - [When No Alignment Exists](#when-no-alignment-exists)

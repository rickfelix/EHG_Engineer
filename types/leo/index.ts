...
// Scoring types (SD-LEO-SELF-IMPROVE-001G)
export type {
  ScoringRubricStatus,
  ScoringDimensionKey,
  ScoringDimension,
  ...
  StabilityRules,
  FieldComparator,
  MergeConfidenceField,
  DedupeMergeConfidenceRules,
  LeoScoringRubricRow,
  LeoScoringRubricInsert,
  LeoScoringRubric,
  PrioritizationScopeType,
  ScoringWeights,
  LeoScoringPrioritizationConfigRow,
  LeoScoringPrioritizationConfigInsert,
  LeoScoringPrioritizationConfigUpdate,
  LeoScoringPrioritizationConfig,
  ScoringInput,
  DimensionScore,
  ScoringOutput,
  ScoreProposalResult,
  MergeDecision,
  FieldContribution,
  MergeConfidenceExplanation,
  ScoreMergeConfidenceResult,
  ProtocolSectionScoringFields,
} from './scoring';

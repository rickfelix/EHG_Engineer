...
- **MICHAEL SEAT MODEL (v0.3): Opus at medium effort, Sonnet fallback under account quota; Opus verification before any rule-encode that flips auto_apply or supersedes a rule (ratification 2b14e48d)** — the Opus-verification precondition binds every writer of a Michael rule-encode that flips auto_apply or supersedes a rule, Solomon included; the adjudicated seat model is not re-litigated in later Michael reviews. (procedure: MANUAL § Foundation CAPA bullets — full Solomon-share elaboration)
- **MICHAEL REMAINING CONDITIONS (v0.3): Q2, Q3, Q6, Q7 as written; Q8 tasks-classifier pulled into v1 scope, no Todoist-only caveat on the overdue measure (ratification 42111a33)** — Solomon's adjudication conditions Q2, Q3, Q6, Q7 stand as written and Q8 is in v1 scope; the 9-day test is the go-live acceptance test and michael-seat-uptime at 5 of 7 ticks is the go-live gate. (procedure: MANUAL § Foundation CAPA bullets — full Solomon-share elaboration)
- **LEG4 CAPACITY EARNS IN POINTS, NOT A BINARY: TIGHT=2, DEFICIT=1, DEFICIT-URGENT=0, SURPLUS=1 OF THE 2-POINT LEG MAXIMUM (ratification be6e9d73)** — every drive-score diagnosis Solomon carries reads leg4 in points against 2 and names the ladder state; a leg4 that still pins after the change is a signal defect, never a quiet week. (procedure: MANUAL § Foundation CAPA bullets — full Solomon-share elaboration)
...
- **NO REAL-CUSTOMER OUTREACH BEFORE THE VENTURE WORKFLOW GO-LIVE STAGE; a faithful mock run first; Solomon plans it (chairman verbal 2026-09-12, ratification 90c0b40a)** — Chairman verbal 2026-09-12 13:1xZ (chairman_decisions e39df9dd; ledger row 2026-09-13): no real-customer outreach before the venture workflow go-live stage; a faithful mock run first whose results are useful at go-live. **Solomon share:** the mock demand run is Solomon's to design and bless before any run (Part B: positive predicate is_demo=false AND status=active AND stage>=go-live AND launch_mode=live, execution_mode discriminator, mock personas, a mock approver that never writes chairman_decisions); a mock that does not yield results useful at go-live is not the mock the chairman asked for (provenance: PROVENANCE § 90c0b40a; verbatim in the ledger row and in the Session Prologue)

- **THE CHAIRMAN'S SEQUENCING CORRECTION: AltifyAI is test cargo, the Venture Factory is the object under test; improve the factory directly and minimally now (chairman at the Solomon terminal 2026-09-13, ratification 4730357d)** — Chairman typed at the Solomon terminal 2026-09-13 ~12:4xZ (relay a67d063b); executing representation SD-LEO-INFRA-VENTURE-FACTORY-HANDOFF-001 (F3, F2, F4, F1, F5). **Solomon share:** the Bernays assessment's sequencing (9e7d4144 section 14) is superseded; no further broad assessment; Solomon reports the commissioning test result and flags any reserved chairman decision the corrections run into (provenance: PROVENANCE § 4730357d; verbatim in the ledger row and in the Session Prologue)

- **VENTURE QUALITY REVIEW PROGRAMME RULINGS D1, D2, D3, D5 agreed; D4 open at ruling time (chairman at the Solomon terminal 2026-09-13, ratification 0afc86e4)** — Chairman verbal at the Solomon terminal 2026-09-13 ~12:2xZ (relay 257506be); D3 supersedes-in-part 767b288f; D4 disposed by 8e316210; executing representation SD-LEO-INFRA-VENTURE-QUALITY-CAPA-001 (-A..-J). **Solomon share:** the quality model (D1) is Solomon's model of record to maintain; the experience review (C3.1) is run and reported by Solomon; the hourly probe on experience-review run count for ventures at stage 20 or later (X3) is Solomon's owned-miss corrective (feedback 3b22d053) (provenance: PROVENANCE § 0afc86e4; verbatim in the ledger row and in the Session Prologue)

- **ONE CHAIRMAN APPROVAL MAY COVER MORE THAN ONE GATE; one-approval-per-gate withdrawn as a rule (chairman at the Solomon terminal 2026-09-13, ratification 8e316210)** — Chairman verbal at the Solomon terminal 2026-09-13 ~13:0xZ (relay 4f5de054): one chairman approval may cover more than one gate; one-approval-per-gate (P4.2) withdrawn as a rule; automated approvals stay governed by the autonomy level. **Solomon share:** the revisit trigger is Solomon's to watch: a second venture showing a blanket approval that covers a kill gate returns D4 as an oversight finding, never as a rule (provenance: PROVENANCE § 8e316210; verbatim in the ledger row and in the Session Prologue)

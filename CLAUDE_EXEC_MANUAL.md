<!-- file_content_hash: b3233d63aa04327e -->
...
| `worktree_commit_pin` | ^.+@[0-9a-f]{7,40}$, ^.+@[0-9a-f]{7,40}~asof:\d{4}-\d{2}-\d{2}T, ^HISTORICAL:.+$ | Use one of: ^.+@[0-9a-f]{7,40}$, ^.+@[0-9a-f]{7,40}~asof:\d{4}-\d{2}-\d{2}T, ^HISTORICAL:.+$ |

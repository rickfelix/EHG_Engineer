...
-- Date: 2025-11-15
-- Version: 3 (Handles legacy CONDITIONAL_PASS data)

-- ============================================================================
-- STEP 0: Handle Legacy Data (304 existing CONDITIONAL_PASS rows without justification)
-- ============================================================================

-- Convert ALL existing CONDITIONAL_PASS to PASS since they were approved without the new validation rules
-- This preserves the historical decision while allowing new constraints to be added
-- (The columns don't exist yet, so we convert all CONDITIONAL_PASS rows)
...
-- - Found 304 existing CONDITIONAL_PASS rows without proper justification/conditions
-- - These were converted to PASS to preserve historical approval decisions
-- - Going forward, CONDITIONAL_PASS requires retrospective mode + justification + conditions
--
-- Backward Compatibility:
-- - All new rows get validation_mode = 'prospective' (DEFAULT)
-- - justification and conditions remain NULL for PASS/FAIL/BLOCKED/WARNING
-- - Only CONDITIONAL_PASS in retrospective mode requires these fields

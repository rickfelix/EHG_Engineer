-- ============================================================================
-- Expand Design Sub-Agent Triggers for UI/UX Coverage
-- ============================================================================
-- This migration expands the Design sub-agent triggers to ensure comprehensive
-- UI and UX coverage for all features, preventing "invisible backend features"
--
-- Date: 2025-09-30
-- Protocol: LEO v4.2.0
-- ============================================================================
...
INSERT INTO leo_sub_agents (id, name, code, description, capabilities, activation_type, priority, active, metadata)
VALUES (
  'design-sub-agent',
  ...
  '["UI Design", "UX Design", "Accessibility", "Design Systems", "User Flows", "Component Design", "Responsive Design"]'::jsonb,
  'automatic',
  70,
  true,
  '{

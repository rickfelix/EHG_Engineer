...
async function checkMigrationStatus() {
  ...
  try {
    ...
    if (!venturesError && !sampleError && migratedSample) {
      ...
      console.log('   - Check migration files in ../ehg/supabase/migrations/');
    ...
    console.log('   ../ehg/supabase/migrations/20251103_03_migrate_ideas_to_ventures.sql');
    console.log('   ../ehg/supabase/migrations/20251103_04_create_ideas_backward_compat_view.sql');

...
**Target Implementation**: http://localhost:8080/eva-assistant (EHG application at ../ehg)

**CRITICAL Pre-Implementation Requirements**:
1. ⚠️ VERIFY: Navigate to http://localhost:8080/eva-assistant BEFORE any code changes
2. ⚠️ VERIFY: You are in ../ehg (NOT EHG_Engineer)
...
4. Technical Specifications:
   ...
   - Application Path: ../ehg (NOT EHG_Engineer!)
...
Rationale: EHG_Engineer (.) is management dashboard, EHG (../ehg) is implementation target. EXEC must work in EHG application for all code changes. This is documented in CLAUDE.md "Application Architecture" section.
...
1. ⚠️ **APPLICATION VERIFICATION** (MANDATORY FIRST STEP)
   - [ ] Verify current directory: Run 'pwd', confirm output is '../ehg'
   - [ ] If in wrong directory: Navigate to 'cd ../ehg'

...
async function acceptHandoffs() {
  const sdId = 'SD-2025-1020-E2E-SELECTORS';

  console.log('Accepting handoffs for SD-2025-1020-E2E-SELECTORS:\n');
  ...
  for (const handoff of handoffs) {
    ...
    if (updateError) {
      console.log(`❌ Failed to accept ${handoff.handoff_type}:`, updateError.message);
    } else {

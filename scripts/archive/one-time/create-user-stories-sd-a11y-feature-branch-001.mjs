...
const stories = [
  {
    ...
    architecture_references: ['../ehg/src/components/analytics/AnalyticsDashboard.tsx'],
  ...
  },
  {
    ...
    architecture_references: ['../ehg/src/components/audio/AudioPlayer.tsx', 'WebVTT caption format'],

...
const WORKFLOW_STAGES = [
  { number: 1, name: 'Idea Capture', phase: 1, phaseName: 'THE TRUTH', isKillGate: false, isAdvisory: false },
  { number: 2, name: 'Idea Analysis', phase: 1, phaseName: 'THE TRUTH', isKillGate: false, isAdvisory: false },
  { number: 3, name: 'Kill Gate', phase: 1, phaseName: 'THE TRUTH', isKillGate: true, isAdvisory: true },
  { number: 4, name: 'Competitive Landscape', phase: 1, phaseName: 'THE TRUTH', isKillGate: false, isAdvisory: false },
  { number: 5, name: 'Kill Gate (Financial)', phase: 1, phaseName: 'THE TRUTH', isKillGate: true, isAdvisory: true },
  { number: 6, name: 'Risk Assessment', phase: 2, phaseName: 'THE ENGINE', isKillGate: false, isAdvisory: false },
  { number: 7, name: 'Revenue Architecture', phase: 2, phaseName: 'THE ENGINE', isKillGate: false, isAdvisory: false },
  { number: 8, name: 'Business Model Canvas', phase: 2, phaseName: 'THE ENGINE', isKillGate: false, isAdvisory: false },
  { number: 9, name: 'Exit Strategy', phase: 2, phaseName: 'THE ENGINE', isKillGate: false, isAdvisory: false },
  { number: 10, name: 'Customer & Brand Foundation', phase: 3, phaseName: 'THE IDENTITY', isKillGate: false, isAdvisory: false },
  { number: 11, name: 'Naming & Visual Identity', phase: 3, phaseName: 'THE IDENTITY', isKillGate: false, isAdvisory: false },
  { number: 12, name: 'GTM & Sales Strategy', phase: 3, phaseName: 'THE IDENTITY', isKillGate: false, isAdvisory: false },
  { number: 13, name: 'Product Roadmap', phase: 4, phaseName: 'THE BLUEPRINT', isKillGate: true, isAdvisory: false },
  { number: 14, name: 'Technical Architecture', phase: 4, phaseName: 'THE BLUEPRINT', isKillGate: false, isAdvisory: false },
  { number: 15, name: 'Risk Register', phase: 4, phaseName: 'THE BLUEPRINT', isKillGate: false, isAdvisory: false },
  { number: 16, name: 'Financial Projections', phase: 4, phaseName: 'THE BLUEPRINT', isKillGate: true, isAdvisory: true, isElevation: true, elevationTarget: 'schema' },
  { number: 17, name: 'Pre-Build Checklist', phase: 5, phaseName: 'THE BUILD LOOP', isKillGate: false, isAdvisory: false, isElevation: true, elevationTarget: 'repo' },
  { number: 18, name: 'Sprint Planning', phase: 5, phaseName: 'THE BUILD LOOP', isKillGate: false, isAdvisory: false },
  { number: 19, name: 'Build Execution', phase: 5, phaseName: 'THE BUILD LOOP', isKillGate: false, isAdvisory: false },
  { number: 20, name: 'Quality Assurance', phase: 5, phaseName: 'THE BUILD LOOP', isKillGate: false, isAdvisory: false },
  { number: 21, name: 'Build Review', phase: 5, phaseName: 'THE BUILD LOOP', isKillGate: false, isAdvisory: false },
  { number: 22, name: 'Release Readiness', phase: 5, phaseName: 'THE BUILD LOOP', isKillGate: false, isAdvisory: false, isElevation: true, elevationTarget: 'deployment' },
  { number: 23, name: 'Marketing Preparation', phase: 6, phaseName: 'LAUNCH & LEARN', isKillGate: false, isAdvisory: false },
  { number: 24, name: 'Launch Readiness', phase: 6, phaseName: 'LAUNCH & LEARN', isKillGate: false, isAdvisory: false },
  { number: 25, name: 'Launch Execution', phase: 6, phaseName: 'LAUNCH & LEARN', isKillGate: false, isAdvisory: false }
];

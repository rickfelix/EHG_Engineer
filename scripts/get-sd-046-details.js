...
async function getSD046Details() {
  try {
    console.log('🔍 Fetching SD-046 Details...\n');
    ...
    if (error) {
      console.error('❌ Error fetching SD-046:', error);
      return;
    }

    if (!data) {
      console.log('⚠️  SD-046 not found');
      return;
    }

    console.log('📋 SD-046: Stage 15 - Pricing Strategy');

...
if (!supabaseUrl || !supabaseKey) {
  ...
  console.error('   Ensure VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY are set in ../ehg/.env');
  process.exit(1);
}
...
async function verifyMigration() {
  ...
  if (results.profilesTableExists && results.preferencesTableExists) {
    ...
    console.log('   3. Copy contents of: ../ehg/supabase/migrations/20251001140000_create_settings_tables.sql');

#!/usr/bin/env node
/**
 * Query SD-E2E-INFRASTRUCTURE-001 Current Phase
...
console.log('🔍 PHASE DETECTION: SD-E2E-INFRASTRUCTURE-001');
console.log('═══════════════════════════════════════════════════════════\n');
...
if (sdError) {
  ...
  console.log('\n⚠️  SD does not exist yet.');
  console.log('📍 Current Phase: LEAD Pre-Approval (Phase 1) - CREATE SD');
  console.log('   📋 Next Actions:');
  console.log('      1. Create SD in strategic_directives_v2 table');
  console.log('      2. Run strategic validation (6-question gate)');
  console.log('      3. Execute parallel sub-agents');

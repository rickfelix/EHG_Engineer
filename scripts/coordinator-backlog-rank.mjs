...
// SD-LEO-INFRA-BELT-RANKER-PIVOT-AWARENESS-001 (FR-1): the band comparator. QF-20260712-716
// graduated `product_pivot_active` from a governance flag to the permanent path — the flag was
...
async function main() {
  ...
  claimable.sort((a, b) => {
    ...
    // (QF-20260712-716: graduated to always-active). Product-class SDs outrank harness-class SDs.

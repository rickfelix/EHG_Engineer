...
export const SOLOMON_LOOPS = [
  ...
  // covers[] slug below reconciles the contract<->tooling parity check (missingDurableDuties).
  {
    ...
    label: 'Solomon plan-alignment review (24-48h daily baseline, off-cycle on divergence): plan-of-record vs fleet plate, MANDATORY fence-vs-neglected classification before ranking, forecast-assumption revisit feeding the daily Gantt',

    ...
    documentation: [
      {
        ...
        location: '/mnt/c/_EHG/EHG_Engineer/scripts/create-user-stories-eva-meeting-001.mjs',
        status: 'Complete',
        purpose: 'Retroactively created user stories from E2E tests'
      },
      {
        name: 'User Story Verification Script',
        location: '/mnt/c/_EHG/EHG_Engineer/scripts/check-user-stories-eva-meeting.mjs',
        status: 'Complete',

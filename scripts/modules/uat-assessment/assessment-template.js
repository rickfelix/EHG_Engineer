 ...
 * Extracted from update-uat-test-nav-001-assessment.js
 *
 * @module assessment-template
 */

export const comprehensiveAssessment = `# Chairman Console - Comprehensive UI/UX Quality Assessment (Systematic UAT)

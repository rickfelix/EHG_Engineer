...
export const THRESHOLD_PROFILES = {
  ...
  // Corrective SDs: auto-generated by heal to close vision/architecture gaps
  // Lighter than feature (70% vs 85%) — targeted gap fixes, not new features
  corrective: { retrospectiveQuality: 55, sdCompletion: 55, prdQuality: 55, gateThreshold: 70 },
...
function isValidSDType(type) {
  const validTypes = [
    ...
    'corrective',  // Auto-generated by heal system to close vision/architecture gaps (70% threshold)

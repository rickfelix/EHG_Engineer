...
async function getSD039Details() {
  try {
    console.log('🔍 Fetching SD-039 Details...\n');
    ...
    if (error) {
      console.error('❌ Error fetching SD-039:', error);
      return;
    }

    if (!data) {
      console.log('⚠️  SD-039 not found');
      return;
    }

    console.log('📋 SD-039: Chairman Dashboard');

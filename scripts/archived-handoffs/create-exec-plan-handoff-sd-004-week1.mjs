  ...
  content: {
    ...
    action_items_for_plan: [
      ...
      },
      {
        ...
        details: 'Confirm no new type errors introduced. Run: cd ../ehg && npx tsc --noEmit',

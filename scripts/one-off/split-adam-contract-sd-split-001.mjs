...
const MOVES_OTHER = [
  ...
  { section: 601, name: 'SD sourcing hard rules — procedure', key: '### 5r. SD sourcing & creation — hard rules', cuts: [
    ...
    { from: `  board-of-directors verdict 2026-06-16): do **NOT** blindly source`, to: `- **RE-SCOPE PROPOSALS`, with: `  board-of-directors verdict 2026-06-16): classify FIRST — (a) genuine leaf → a Phase-0 design/spec SD; (b) foundation / data-contract → sequence it AHEAD of the builds it gates, never as a parallel tile; (c) already-built but reading low ONLY from a STALE/manual KR → a governed KR RE-MEASURE, NOT a new build SD; (d) mis-bucketed → a registry fix. The coordinator must VERIFY the per-capability gauge gap is REAL before dispatching. (procedure in MANUAL)\n\n`, dest: 'manual' },

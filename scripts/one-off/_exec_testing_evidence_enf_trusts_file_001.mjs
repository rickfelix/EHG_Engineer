  ...
  let results = {
    ...
    metadata: {
      ...
      commands_run: [
        ...
        'hygiene grep for console./TODO/FIXME/XXX/HACK/debugger/.only(/.skip( across all changed files',
      ],

 ...
 *   2. Replace SD-REFACTOR-2025-001-P1-003 with your SD ID (e.g., SD-AUTH-001)
...
const SD_ID = 'SD-REFACTOR-2025-001-P1-003'; // TODO: Replace with your SD ID (e.g., 'SD-AUTH-001')
const PRD_TITLE = 'Refactor progress-calculator: Consolidate functions, extract phase calculators'; // TODO: Replace with your PRD title
...
async function createPRD() {
  ...
  const prdData = {
    ...
    // Executive & Context
    executive_summary: `
Refactor progress-calculator.js (467 LOC, 47 functions) to consolidate redundant functions and extract phase-specific calculators. This will reduce function count and improve maintainability.
    `.trim(),

    business_context: `
Current progress-calculator.js has 47 functions indicating over-granulation. Many functions could be consolidated. This refactoring improves code organization and reduces cognitive overhead.
    `.trim(),

    technical_context: `
File: src/services/progress-calculator.js (467 LOC)
Strategy: Extract phase calculators into phase-calculators.js, consolidate helper functions.
Dependencies: StatusValidator, database queries
    `.trim(),
    ...
    functional_requirements: [
      {
        id: 'FR-1',
        requirement: 'Extract Phase Calculators',
        description: 'Extract phase-specific calculation logic into dedicated module',
        priority: 'HIGH',
        acceptance_criteria: [
          'phase-calculators.js created with focused functions',
          'All phase calculations work correctly'
        ]
      },
      {
        id: 'FR-2',
        requirement: 'Consolidate Helper Functions',
        description: 'Merge redundant helper functions',
        priority: 'HIGH',
        acceptance_criteria: [
      ...
      },
      {
        ...
        description: 'All existing exports preserved',
        priority: 'CRITICAL',
        acceptance_criteria: [

...
module.exports = {
  ...
  async run(ctx) {
    ...
    const {
      ...
      fetchFableWindowActive, claimableForTier, baselinedCandidateEligible, isSdInFlight,
      tryClaim, tryClaimDraftCandidate, antiWinddownDirective, SELF_CLAIM_CANDIDATE_LIMIT,
    } = ctx.helpers;

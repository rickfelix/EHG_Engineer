 ...
 * SD-LEO-INFRA-SHADOW-TRIAL-RATIFICATION-001-B: category/eventType parameterized
 * (param-with-default, additive) so further sealed-suite consumers can reuse the
 * primary/mirror read; defaults keep the first consumer byte-identical.
 */
export async function loadGoldenSuite(supabase, { category = 'model_capability_baseline', eventType = 'fable5_baseline_seal' } = {}) {

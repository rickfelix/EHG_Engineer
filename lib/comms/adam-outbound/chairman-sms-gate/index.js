...
import { resolveChairmanUserId } from '../resolve-chairman-user-id.js';

// Re-exported for backward compatibility -- resolveChairmanUserId now lives in its own small
// module (SD-LEO-INFRA-CHAIRMAN-SMS-DURABLE-001) so a second caller can import it without
// statically pulling in this whole gate file's transitive reachability to the consult gate. See
// resolve-chairman-user-id.js's docstring for why that distinction matters.
export { resolveChairmanUserId };

 ...
 * EXACT-PREFIX match on the canonical body, deliberately narrow — an uncertain-to-classify or
 * non-matching body must default to the existing hard interrupt (fail-toward-chairman), never
 * the reverse.
 *

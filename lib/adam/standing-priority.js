...
/** SD statuses that count as work actually being routed into the priority. Kept in sync
 *  with the same-named constant in scripts/adam-coordinator-health.mjs — 'active' is the
 *  status a strategic directive carries while in EXEC (verified live 2026-09-07: full
 *  strategic_directives_v2.status vocabulary is active/cancelled/completed/deferred/draft/
 *  in_progress/pending_approval; draft and deferred are correctly excluded as not-yet or
 *  no-longer being worked). */
export const IN_FLIGHT_STATUSES = Object.freeze(['in_progress', 'active', 'pending_approval']);

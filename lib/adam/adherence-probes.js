...
export function probeDispatchBoundary(facts = {}) {
  ...
  return m
    ? conductBar('dispatch_boundary', duty, VERDICT.FAIL, `advisory body contains fleet-dispatch language ("${m[0]}") — Adam crossed into the coordinator's capacity lane`)
    : conductBar('dispatch_boundary', duty, VERDICT.PASS, 'no fleet-dispatch language in the advisory body — boundary upheld');
}

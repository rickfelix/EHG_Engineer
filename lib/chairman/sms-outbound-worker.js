...
export async function reconcileOutboundSms(supabase, opts = {}) {
  ...
  const summary = { ran: false, claimed: 0, sent: 0, failed: 0, retried: 0, alerted: 0, skipped: 0, reaped: 0, sentTimedOut: 0, escalated: 0, confirmedDelivered: 0, unconfigured: 0 };

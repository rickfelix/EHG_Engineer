...
// scripts/cron/chairman-hourly-heartbeat-backstop-sweep.mjs's own coverage read can span. QF-
// 20260828-650 retargeted that sweep from a trailing lookback window to fixed ET slots
// (SLOT_HOURS_ET = [6,9,12,15,18,21], max 3h between slots) — that sweep maps status=canceled
// to do_not_retry; if staleThresholdMs were ever set below the widest inter-slot gap, a voided

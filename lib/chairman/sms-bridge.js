    ...
    try {
      ...
      if (PARK_OUTCOMES.includes(outcome.outcome) && isVerifiedChairman) {
        ...
        if (ADAM_ROUTABLE_OUTCOMES.includes(outcome.outcome)) {
          ...
          // succeeded (chairman text 4e0db146, 2026-09-01 21:18Z: routed only by a coordinator
          // retry at 21:21:49Z, a false ESCALATION, and a manual routed_at stamp, with real
          // double-delivery risk). A retry finding routed_at already set is now a no-op.
          ...
          try {
            ...
            // of showing routed_at set with nothing ever delivered. Best-effort: the park above
            // remains the durable fallback even if this rollback itself fails.
            try {

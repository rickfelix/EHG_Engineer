...
export const TARGET_CONTRACTS = Object.freeze(['adam', 'coordinator', 'solomon', 'michael', 'protocol']);
...
const ROLE_PREFIXES = Object.freeze({
  ...
  // SD-LEO-ORCH-MICHAEL-ROLE-FORMALIZATION-002-A: without this prefix the two Michael files fell
  // into the `protocol` residual (10 files, not 8) and a ['protocol'] ratification would have been
  // asserted against a role contract it never named.
  michael: 'CLAUDE_MICHAEL',
});
 ...
 * RESIDUAL of section-file-mapping.json's real file keys after the four role prefixes are
 * removed -- 11 files (CLAUDE.md, CLAUDE_CORE.md, CLAUDE_CORE_MANUAL.md, CLAUDE_CORE_PROVENANCE.md,
 * CLAUDE_LEAD.md, CLAUDE_LEAD_MANUAL.md, CLAUDE_PLAN.md, CLAUDE_PLAN_MANUAL.md, CLAUDE_EXEC.md,
 * CLAUDE_EXEC_MANUAL.md, CLAUDE_EXEC_PROVENANCE.md; the last three joined under
 * SD-LEO-FIX-CLAUDE-ADAM-SPLIT-001 FR-3/FR-4). It EXCLUDES the

...
/** FR-4: is this row an auto-generated "Corrective: …" vision/architecture-gap finding? */
export function isCorrectiveFlag(row) {
  return row?.decision_type === 'flag_review' && /^\s*corrective\s*:/i.test(String(row?.title || ''));
}

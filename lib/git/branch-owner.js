 ...
 *
 * FLIP CONDITION (b) FIRED — SD-LEO-INFRA-WIDEN-BRANCH-TYPE-001. SD-LEO-FIX-CHAIRMAN-DECISION-
 * CAPTURE-001's PR #8079 (branch sd/SD-LEO-FIX-CHAIRMAN-DECISION-CAPTURE-001, merge commit
 * f113152308c, real shipped code) was invisible to PR_MERGE_VERIFICATION's Scan A/B/C and
 * false-blocked that SD's LEAD-FINAL-APPROVAL with reason=never_pushed — a measured missed
 * completion attributable to the 'sd/' prefix specifically not being recognized. The original
 * ruling's census covered only 'qf/'; 'sd/' was never analyzed. 'sd' added below, prefix-free
 * re-derived automatically by the existing assertTypeTokensPrefixFree call at import time.
 */
import { fetchAllPaginated } from '../db/fetch-all-paginated.mjs';

export const BRANCH_TYPE_TOKENS = Object.freeze(['feat', 'fix', 'docs', 'test', 'sd']);

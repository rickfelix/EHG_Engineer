 ...
 *
 * Widening the set is a decision with a cost — the prefix-free proof above must be re-derived over
 * the new set — so it stays a deliberate choice, not a default.
 */

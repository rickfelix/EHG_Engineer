...
const PHASE_MODEL_OVERRIDES = {
  // OPTIMIZED 2025-12-06: Reserve Opus for critical security tasks only
  // Strategy: Test Sonnet first for most tasks, keep Opus for security-critical work
  LEAD: {
    GITHUB: 'sonnet',   // 67% pass - status checks
    DOCMON: 'sonnet',   // 83% pass
    DATABASE: 'sonnet', // 100% pass
    TESTING: 'sonnet',  // 69% pass - acceptable
    STORIES: 'sonnet',  // Testing Sonnet (was 8% with Opus, but worth trying)
    RETRO: 'sonnet',    // 100% pass
    SECURITY: 'opus',   // Critical domain - KEEP OPUS
    VALIDATION: 'sonnet', // Testing Sonnet (important but not security-critical)
  },
  PLAN: {
    GITHUB: 'sonnet',   // 0% pass but low volume
    DOCMON: 'sonnet',   // 100% pass - template PRDs
    DATABASE: 'sonnet', // 100% pass
    TESTING: 'sonnet',  // Testing Sonnet (was 25% with Opus)
    STORIES: 'sonnet',  // Testing Sonnet (was 0% but critical to optimize)
    RETRO: 'sonnet',    // 100% pass
    SECURITY: 'opus',   // Critical domain - KEEP OPUS
    VALIDATION: 'opus', // KEEP OPUS - important for preventing duplicate work
  },
  EXEC: {
    GITHUB: 'sonnet',   // 13% pass - PR creation
    DOCMON: 'sonnet',   // Testing Sonnet (was 13% with Opus anyway)
    DATABASE: 'sonnet', // 80% pass
    TESTING: 'sonnet',  // Testing Sonnet (was 11% with Opus, worth trying cheaper model)
    STORIES: 'sonnet',  // Testing Sonnet (was 36% with Opus)
    SECURITY: 'opus',   // Critical domain - KEEP OPUS
    RETRO: 'sonnet',    // Pattern extraction
    VALIDATION: 'opus', // KEEP OPUS - critical for final verification
  }
};

/**
 * Default model assignments (used when phase is unknown)
 * OPTIMIZED 2025-12-06: Reserve Opus for security-critical tasks only
 * Strategy: Most tasks use Sonnet, only SECURITY stays on Opus
 */
const DEFAULT_MODEL_ASSIGNMENTS = {
  GITHUB: 'sonnet',     // 94.8% overall - high volume, working well
  DATABASE: 'sonnet',   // 96.9% overall - consistent
  RETRO: 'sonnet',      // 96.0% overall - reliable
  STORIES: 'sonnet',    // Testing Sonnet (was 3.4% with Opus, worth trying)
  ...
  SECURITY: 'opus',     // 25.0% overall - KEEP OPUS (critical security tasks)
  VALIDATION: 'sonnet', // Testing Sonnet (was 18.2% with Opus, worth trying)

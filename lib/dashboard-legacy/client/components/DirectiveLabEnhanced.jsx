        ...
        return (
          <div className="space-y-6">
            {submission?.strat_tac && (
              <div className="p-6 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg border border-gray-200">
                <div className="flex justify-around mb-6">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-blue-600">
                      {submission.strat_tac.strategic_pct}%
                    </div>
                    <div className="text-sm text-gray-600 mt-1">Strategic</div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600 mt-1">Tactical</div>
                  </div>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <p className="font-medium text-gray-700 mb-2">Classification Rationale:</p>
                  <p className="text-gray-600">{submission.strat_tac.rationale}</p>
                </div>
              </div>
            )}
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <h1 className="text-xl font-bold text-gray-900">Directive Lab</h1>
          <Button
      ...
      {success && (
        <div className="bg-green-50 border-b border-green-200 px-4 py-3">
          <div className="max-w-7xl mx-auto flex items-center text-green-800">
...
export default DirectiveLabEnhanced;
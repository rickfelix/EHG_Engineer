/**
 * @wire-check-exempt: foundation shared library — the persona/content authoring primitive for
 * Part B's mock-run executor (mock-outreach-executor.js, same exemption reasoning). Called today
 * only from tests/unit/marketing/synthetic-personas.test.js; wired when the mock-run orchestrating
 * SD lands. Available infrastructure with no production runtime caller yet, by design.
 *

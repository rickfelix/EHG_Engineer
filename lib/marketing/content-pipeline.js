  ...
  for (const channel of channels) {
    ...
    try {
      ...
      for (const platform of channel.platforms) {
        ...
        // SD-LEO-INFRA-DEMAND-ENGINE-FAIL-001 FR-3: pubResult.success alone is true for a
        ...
        // never increment totalPublished or record real spend.
        if (pubResult.success && pubResult.mode === 'real') {
          totalPublished++;

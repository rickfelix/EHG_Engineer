...
// SD-LEO-ORCH-GEMINI-MODEL-SCAN-001-E: resolved via the model-config SSOT instead of a bare
// literal. Default is unchanged (gemini-2.5-flash-image, the ratified value above) -- only the
// GEMINI_MODEL_CREATIVE_IMAGE_GENERATION env var can move it now.
const GEMINI_IMAGE_MODEL = getGoogleModel('creative-image-generation');

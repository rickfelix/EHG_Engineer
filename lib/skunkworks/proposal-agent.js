...
import { getLLMClient, initializeLLMFactory } from '../llm/index.js';
...
async function generateWithLLM(deps, signals) {
  ...
  const systemPrompt = 'You are a research director at a venture evaluation platform. Generate R&D experiment proposals from data signals. Output ONLY a JSON array of objects.';

  const userPrompt = `Given these signals from our automated monitoring, generate R&D experiment proposals.

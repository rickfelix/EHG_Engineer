 ...
 *
 * Usage:
 *   import { getSDId, getSDByKey, createPRDLink } from './lib/sd-helpers.js';
 */
 ...
 *
 * @param {string} directiveId - directive_id (could be SD.id, legacy_id, or sd_key)

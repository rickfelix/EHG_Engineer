...
async function validateNavigationSequence(sequence) {
...
async function findAllComponents(options) {
...
async function determineRootCause(errorData, sdId) {
...
function generateErrorFixes(errorType, errorData) {
  const fixes = [];

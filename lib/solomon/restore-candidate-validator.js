...
// @wire-check-exempt: staged for Part B (blocked on chairman action); FR-1's own acceptance
// criteria require it NOT be invoked against this SD's 4-row manifest, so it has no live caller yet.
//

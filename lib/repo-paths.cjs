...
// Relative local_path values resolve against the parent of ENGINEER_ROOT
// (the sibling-repo convention: `../ehg`), keeping registry.json portable
// across machines. Absolute values are preserved as an override.

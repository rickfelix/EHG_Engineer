...
const FR2_CLI_ENTRYPOINTS = [
  ...
  {
    file: 'scripts/coordinator-revive.cjs', line: 139,
    disposition: 'exempt-promise-catch-log-only',
    // QF-20260911-753: shifted from 135 — added a 5-line comment above the row insert at
    // line 103 documenting the bare-'broadcast'-retired fallback target.
  ...
  {
    file: 'scripts/adam-quiet-tick.mjs', line: 1528,
    ...
    note: 'Both call sites (1528, 1531) sit inside `try { ... } catch { /* fail-open/fail-soft */ }` blocks that never call process.exit — they only gate an in-memory `acctNotified` flag.',
  },
  {

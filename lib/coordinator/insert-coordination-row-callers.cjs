...
const FR2_CLI_ENTRYPOINTS = [
  ...
  {
    file: 'scripts/adam-quiet-tick.mjs', line: 1440,
    disposition: 'exempt-fail-soft-try-catch',
    note: 'Both call sites (1440, 1443) sit inside `try { ... } catch { /* fail-open/fail-soft */ }` blocks that never call process.exit — they only gate an in-memory `acctNotified` flag.',
  },
  {

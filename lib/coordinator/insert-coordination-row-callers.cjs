...
const FR2_CLI_ENTRYPOINTS = [
  ...
  // QF-20260912-514 shifted both again: adam-advisory.cjs 1451 -> 1462 (unclassified-recording
  // comment block added above), solomon-advisory.cjs 1438 -> 1455 (new framingUnstampedWarning()
  // call + comment added above).
  { file: 'scripts/adam-advisory.cjs', line: 1462, disposition: 'migrated' },
  { file: 'scripts/solomon-advisory.cjs', line: 1455, disposition: 'migrated' },

...
const FR3_NON_CLI_CALLERS = [
  ...
  {
    // SD-LEO-FIX-EVERY-CHAIRMAN-SMS-001 shifted this call site from 1104 -> 1120 -> 1124 (the
    // new 'no_open_question' outcome branch, then its UNMATCHED_OUTCOMES documenting comment,
    // both added earlier in the same file, ahead of this call site).
    file: 'lib/chairman/sms-bridge.js', line: 1124,
    disposition: 'exempt-fire-and-forget',

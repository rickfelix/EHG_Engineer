...
const FR3_NON_CLI_CALLERS = [
  ...
  {
    // SD-LEO-FIX-EVERY-CHAIRMAN-SMS-001 shifted this call site from 1104 -> 1120 (the new
    // 'no_open_question' outcome branch added earlier in the same file, ahead of this call site).
    file: 'lib/chairman/sms-bridge.js', line: 1120,
    disposition: 'exempt-fire-and-forget',

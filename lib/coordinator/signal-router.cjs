...
/**
 * PREVIOUSLY UNREACHABLE (SD-LEO-INFRA-SIGNAL-ROUTER-AUTO-001, FR-7), NOW WIRED
 * (SD-LEO-INFRA-SIGNAL-LANE-PER-001, FR-4) — but as a NON-DISPOSING provenance marker, mirroring
 * stampRouted()'s already-fixed shape, not restoring the old acknowledged_at stamp.
 *

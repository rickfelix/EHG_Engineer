...
// SD-LEO-ORCH-MICHAEL-ROLE-FORMALIZATION-002-A (spec §1.5): 'michael' joins the registry so the
// role_session:michael row's coordinator rung is suppressed THROUGH this set, not a string
// special-case. PEER_KINDS.michael landed in the same PR (peer-target.cjs throws on unknown keys).
const KNOWN_PEERS = new Set(['adam', 'solomon', 'coordinator', 'michael']);

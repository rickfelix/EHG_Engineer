 ...
 */
const VALID_PURPOSES = ['validation', 'classification', 'generation', 'fast', 'vision', 'reasoning', 'solomon', 'premium-generation', 'design-generation', 'image-generation', 'creative-image-generation'];

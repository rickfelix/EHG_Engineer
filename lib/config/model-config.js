...
const MODEL_DEFAULTS = {
  ...
  claude: {
    ...
    // REVISIT-IF(condition=Gemini 3.5 GA cost-per-quality re-run lands) owner=adam provenance=project_gemini_35_release_rerun_j2a_harness note=downgrade premise is 2.5-flash-era pricing; the chairman-directed mid-July J2A re-run re-decides the default provider

 ...
 */
// eva-logger-lint-ignore: pure frozen-data registry + trivial pure lookup/derivation
// helpers (getDimension is a synchronous .find(); the STAGE23_*_CATEGORY_IDS exports are
// synchronous .filter().map() over the frozen array). No I/O, no error branches, no side
// effects worth logging -- see docs/reference/eva-logging-standard.md's own "thin helper"
// exemption.

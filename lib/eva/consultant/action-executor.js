 ...
 */
// eva-logger-lint-ignore: pre-existing file, plain console.log only, predates the EVA
// logging standard (docs/reference/eva-logging-standard.md); SD-LEO-INFRA-FILING-TOOLS-
// ENFORCE-001's edit here is a mechanical one-line default (criticality:'later'), not new
// executable logic -- retrofitting createLogger/OrchestratorTracer across this file is out
...
async function createSDFromRecommendation(supabase, recommendation) {
  try {
    ...
    const sd = await createSD({
      ...
      // enforced without breaking this flow. sdParams spreads after so an explicit caller
      // value (none exist today) would still win.
      criticality: 'later',
      criticalityReason: 'auto-generated by EVA consultant action-executor, unsupervised -- routed later by default per SD-LEO-INFRA-FILING-TOOLS-ENFORCE-001 FR-4',
      ...sdParams
    });

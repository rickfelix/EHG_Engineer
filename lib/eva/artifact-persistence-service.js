...
export async function advanceStage(supabase, opts) {
  ...
  if (gateResult.provenance_warnings?.length) {
    console.warn(`[artifact-persistence-service] advanceStage provenance warnings (S${fromStage}->S${toStage}, venture ${ventureId}): ${gateResult.provenance_warnings.join(' | ')}`);
  }

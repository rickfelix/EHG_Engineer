...
// migration is chairman-gated and, as of this SD, NOT yet applied -- every recordGateAttempt call
// fails today with PostgREST's "function not found" (PGRST202). The 4 call sites already fail
// loud (logger.error, never silently swallowed) rather than crashing the primary gate write, but a
// raw PGRST202 message reads identically to a genuine bug. Naming the specific, expected cause
// here makes it distinguishable at every call site with one change, instead of an operator having
// to learn to recognize and mentally discount a recurring stack trace.

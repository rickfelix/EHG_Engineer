...
export const artifactType = ARTIFACT_TYPES.BLUEPRINT_LAUNCH_READINESS;

export const description = 'Go/no-go launch readiness checklist and assessment';

export const dependencies = [ARTIFACT_TYPES.BLUEPRINT_TECHNICAL_ARCHITECTURE, ARTIFACT_TYPES.BLUEPRINT_RISK_REGISTER, ARTIFACT_TYPES.BLUEPRINT_FINANCIAL_PROJECTION];

...
export const artifactType = ARTIFACT_TYPES.BLUEPRINT_SPRINT_PLAN;

export const description = 'Sprint breakdown with story assignments and milestones';

export const dependencies = [ARTIFACT_TYPES.BLUEPRINT_USER_STORY_PACK, ARTIFACT_TYPES.BLUEPRINT_TECHNICAL_ARCHITECTURE, ARTIFACT_TYPES.BLUEPRINT_LAUNCH_READINESS];

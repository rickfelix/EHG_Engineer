...
export const artifactType = ARTIFACT_TYPES.BLUEPRINT_PROMOTION_GATE;

export const description = 'Blueprint readiness score and promotion decision';

export const dependencies = [ARTIFACT_TYPES.BLUEPRINT_LAUNCH_READINESS, ARTIFACT_TYPES.BLUEPRINT_FINANCIAL_PROJECTION];

...
export function getDimensionInfo() {
  return {
    ...
    // the 'V07' literal above is a positional code with zero current callers (grepped
    // repo-wide) and is left unchanged. NOTE (completion-flag candidate): this file's
    // own 'V07' claim does not match docs/architecture/vision-gap-analysis.md, which has
    // VGAP-V07=chairman_dashboard_scope and VGAP-V08=unlimited_compute_posture -- a second
    // confirmed positional mismatch beyond V03/V04, left uncorrected since renumbering which
    // position a name maps to is a judgment call outside this SD's scope.
    dimension_slug: slugifyDimensionName('Compute Posture'),

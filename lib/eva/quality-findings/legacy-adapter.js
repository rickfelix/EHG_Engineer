...
const LEGACY_CHECK_MAP = Object.freeze({
  ...
  // SD-LEO-FEAT-STAGE-EXPERIENCE-DESIGN-001: the design-agent adapter emits these
  // directly. Identity-map so they persist under their own category rather than
  // collapsing to the 'capability' fallback.
  usability: 'usability',

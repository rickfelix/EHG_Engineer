...
/**
 * SD-LEO-FEAT-STAGE-EXPERIENCE-DESIGN-001: the WARN-cap set — findings in these
 * categories are persisted at true severity but excluded from the Stage-20
 * hasCritical/hasHigh verdict scan (stage-20-code-quality.js), so no experience
 * finding can ever produce a FAIL. Single source of truth for both the verdict
 * formula and any test asserting the cap.
 */

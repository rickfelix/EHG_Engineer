...
// SD-LEO-INFRA-STAGE-RENUMBER-DRIFT-001: updated 26 -> 27 (Growth Playbook, the final pipeline
// stage) for the 2026-08-28 renumbering.
const REQUIRED_STAGE = 27;
...
export async function evaluate(supabase, ventureId, config = {}) {
  ...
  // Load context — stage must be REQUIRED_STAGE (Growth Playbook, the final pipeline stage)

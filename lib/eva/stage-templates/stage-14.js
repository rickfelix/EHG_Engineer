...
// Risk register is now generated inline within analyzeStage14()
// (SD-RESTRUCTURE-STAGE-15-MOVE-ORCH-001-B) — no separate multiplexer needed
TEMPLATE.analysisStep = analyzeStage14;

ensureOutputSchema(TEMPLATE);

// Risk register minimum (moved from S15 in SD-RESTRUCTURE-STAGE-15-MOVE-ORCH-001-B)
const MIN_RISKS = 1;

export { REQUIRED_LAYERS, MIN_INTEGRATION_POINTS, MIN_DATA_ENTITIES, CONSTRAINT_CATEGORIES, MIN_RISKS };

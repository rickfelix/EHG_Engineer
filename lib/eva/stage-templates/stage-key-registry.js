// eva-logger-lint-ignore: pure data (a static map) and a pure synchronous comparison function
// with no I/O, no async work, and no error path worth tracing -- there is nothing here an
// OrchestratorTracer or createLogger call would ever observe.
/**

 ...
 *   - BLOCKING: promotion gate — chairman must approve before BUILD phase
 *   - Produces promotion_gate artifact with PASS/FAIL/REVIEW_NEEDED verdict
 *   - Kill gate side-effects applied if venture fails quality threshold
 *   - Auto-approved at autonomy L2+ when promotion gate passes
 *
...
import { analyzeStage17 } from './analysis-steps/stage-17-blueprint-review.js';

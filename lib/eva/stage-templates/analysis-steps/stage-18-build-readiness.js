 ...
 */
export async function analyzeStage18({ stage13Data, stage14Data, stage15Data, stage16Data, stage17Data, ventureName, logger = console }) {
  const startTime = Date.now();
  logger.log('[Stage18] Starting build readiness analysis', { ventureName });
  if (!stage13Data) {
    throw new Error('Stage 18 build readiness requires Stage 13 (product roadmap) data');
  }

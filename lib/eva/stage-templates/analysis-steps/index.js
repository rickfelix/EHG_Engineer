...
// Note: internal function names retain their original names; aliases map to correct stage numbers
export { analyzeStage17 as analyzeStage18 } from './stage-18-build-readiness.js';
export { analyzeStage18 as analyzeStage19 } from './stage-19-sprint-planning.js';
export { analyzeStage19 as analyzeStage20 } from './stage-20-build-execution.js';
export { analyzeStage20 as analyzeStage21 } from './stage-21-quality-assurance.js';
export { analyzeStage21 as analyzeStage22 } from './stage-22-build-review.js';
...
export async function getAnalysisStep(stageNumber) {
  const loaders = {
    ...
    18: () => import('./stage-18-build-readiness.js').then(m => m.analyzeStage17),
    19: () => import('./stage-19-sprint-planning.js').then(m => m.analyzeStage18),
    20: () => import('./stage-20-build-execution.js').then(m => m.analyzeStage19),
    21: () => import('./stage-21-quality-assurance.js').then(m => m.analyzeStage20),
    22: () => import('./stage-22-build-review.js').then(m => m.analyzeStage21),

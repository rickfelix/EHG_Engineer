...
export { analyzeStage15 } from './stage-15-risk-register.js';
...
export { analyzeStage18Acquirability } from './stage-18-acquirability.js';
export { analyzeStage19Acquirability } from './stage-19-acquirability.js';
export { analyzeStage20Acquirability } from './stage-20-acquirability.js';
export { analyzeStage21Acquirability } from './stage-21-acquirability.js';
export { analyzeStage22Acquirability } from './stage-22-acquirability.js';
export { analyzeStage24AcquirabilityReview } from './stage-24-acquirability-review.js';
...
export async function getAcquirabilityStep(stageNumber) {
  const loaders = {
    ...
    18: () => import('./stage-18-acquirability.js').then(m => m.analyzeStage18Acquirability),
    19: () => import('./stage-19-acquirability.js').then(m => m.analyzeStage19Acquirability),
    20: () => import('./stage-20-acquirability.js').then(m => m.analyzeStage20Acquirability),
    21: () => import('./stage-21-acquirability.js').then(m => m.analyzeStage21Acquirability),
    22: () => import('./stage-22-acquirability.js').then(m => m.analyzeStage22Acquirability),
    24: () => import('./stage-24-acquirability-review.js').then(m => m.analyzeStage24AcquirabilityReview),
  };

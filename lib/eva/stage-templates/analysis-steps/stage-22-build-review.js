 ...
 *   This file's filename (stage-22-build-review.js) conflicts with the canonical
 *   stage-22 distribution-setup work. The file's JSDoc title says "Stage 22
 *   Integration Review" but its @module path (stage-21-build-review) and
 *   the upstream-data params (stage21Data, stage20Data) indicate this is the
 *   Stage-21 build/integration review, not Stage 22. The legacy SD
 *   (SD-EVA-FEAT-TEMPLATES-BUILDLOOP-001) defined it under stage-22-* before
 *   the Build-Loop redesign moved Distribution Setup canonically to Stage 22.
 *   Renaming requires updating callers in index.js + tests; deferred to a
 *   follow-up SD. No behavioural change here.
 *
 * Stage 22 Analysis Step - Integration Review (legacy filename — see disposition above)

/**
 * Stage 25 Analysis Step - Acquirability Review (Exit Readiness Aggregation)
 ...
 */
export async function analyzeStage25AcquirabilityReview({ ventureId, supabase, stageData, logger = console }) {

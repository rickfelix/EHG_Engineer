...
// SD-LEO-INFRA-STAGE-GROUNDING-INJECTOR-001 FR-1: ground competitive pricing/feasibility
// claims in the AI-agent operating model instead of generic hired-team priors.
...
Output ONLY valid JSON.`;
  ...
  const retroBlock = await getRetroPatternGroundingBlock({ supabase, stageType: 'competitive' });

...
export async function analyzeStage17({
  ...
  try {
    await recordGateResult(supabase, {
      ...
      // CHECK constraint (and its "ARMED AND DISCONNECTED" preamble re: this file's own existing
      // chairman_decisions auto-approval, which silently no-ops today) exists to prevent. Per

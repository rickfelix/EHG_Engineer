  ...
  if (supabase && ventureId) {
    try {
      ...
      const formRow = {
        ...
        // CHECK constraints on risk_recalibration_forms:
        //   from_phase ∈ IDEATION|VALIDATION|DEVELOPMENT|SCALING
        //   to_phase   ∈ VALIDATION|DEVELOPMENT|SCALING|EXIT
        // Stage 6 (Risk Matrix) is the IDEATION-phase gate that evaluates
        // whether the venture is ready to advance to VALIDATION.
        from_phase: 'IDEATION',
        to_phase: 'VALIDATION',

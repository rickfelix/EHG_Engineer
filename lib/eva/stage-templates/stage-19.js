 ...
 *   - BLOCKING: promotion gate — chairman approves sprint plan before build
 *   - Build readiness gate checks GitHub repo exists before advancing
 *   - Writes sprint backlog artifacts with SD bridge payloads
 *   - Replit build path delegated to legacy handler at this stage
 *
...
import { analyzeStage19 } from './analysis-steps/stage-19-sprint-planning.js';

 ...
 *   → Stage 9: financial profile (projections, unitEconomics)
 *   → Stage 16: projection baseline for financial tracking
 *
 * @module lib/eva/stage-templates/stage-05
 */

import { validateNumber, collectErrors, validateCrossStageContract } from './validation.js';
import { ensureOutputSchema, extractOutputSchema } from './output-schema-extractor.js';

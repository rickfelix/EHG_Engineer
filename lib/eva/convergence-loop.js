 ...
 */
// @wire-check-exempt: Child C library — the top-level entry point (runConvergenceLoop)
// this SD's PRD describes as "callable, invoked by Child D". Child D
// (SD-LEO-INFRA-POST-BUILD-ARTIFACT-001-D, "S19->S20 Gate Wiring") is a dependent sibling
// SD not yet implemented; it wires this loop into the real S19-exit boundary. Today's
// only consumer is tests/unit/eva/convergence-loop.test.js.

...
async function loadConstraints(supabase) {
  ...
  try {
    ...
    // count-truncation-diff-lint: explicit bound -- the active constraint set is small by
    // nature (a few dozen chairman-ratified rows at most), but a cap must be visible.

 ...
 * to a human. buildNurseryReevalRequest still enforces AC-10 independently — this is a second
 * lock on the same door, deliberately, because a headless caller has no operator to catch it.
 */
...
export const OPEN_REQUEST_STATUSES = Object.freeze(['pending', 'processing']);

...
// eva-logger-lint-ignore: SD-LEO-INFRA-VENTURE-QUALITY-CAPA-001-A's only edit
// to this file (owned by SD-LEO-FEAT-STAGE-EXPERIENCE-DESIGN-001) is scoping
// buildExperienceFindings()'s allowlist to its own EXPERIENCE_REVIEW_CATEGORIES
// constant -- a pure validation function with no I/O. Retrofitting the whole
// file's pre-existing lack of createLogger (including persistExperienceReview's
// actual write paths) is out of this SD's scope; caller writeFindingsBatch()
// already owns logging for the underlying persistence side effect.

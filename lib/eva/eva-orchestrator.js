...
function buildResult({ ventureId, stageId, startedAt, correlationId, status, artifacts = [], filterDecision = null, gateResults = [], nextStageId = null, errors = [], devilsAdvocateReview = null, traceId = null, postLifecycleResult = null }) {
  const result = {
    ventureId,
    stageId,
    startedAt,

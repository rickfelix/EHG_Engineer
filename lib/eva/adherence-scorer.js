 ...
 */
// @wire-check-exempt: Child C library whose only consumers today are its own tests and
// lib/eva/convergence-loop.js (same SD). The end-to-end caller is Child D
// (SD-LEO-INFRA-POST-BUILD-ARTIFACT-001-D, "S19->S20 Gate Wiring"), a dependent sibling
// SD not yet implemented — per this SD's own PRD, Child C exposes a callable entry point
// and Child D wires the invocation at the S19 exit boundary. Pinned by

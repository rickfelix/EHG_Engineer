...
// Was 2000 — too tight after the marketing-copy "Binding contract" block was
// added (commit 13760651ee, 2026-04-28). With ~400 chars for the binding
// contract + 5-7 sprint items × ~200 chars/each (name, description, acceptance
// criteria), the truncated-fallback path was firing on every venture, dropping
// feature descriptions in the process. Replit Agent processes prompts well
// over 100k tokens; 6000 chars (~1500 tokens) is still a tight, focused prompt
// for Plan Mode while leaving room for both the binding contract and the
// feature detail Replit needs to plan effectively.

 ...
 */
export function buildChairmanSiteReviewAttestationRow({ decisionRow, decisionId, verdict, decidedBy, rationale = null }) {
  ...
  const row = {
    ...
    subject_ref: `venture_site:${decisionRow.venture_id}`,
...
export async function resolveAndWriteChairmanSiteReviewAttestation(supabase, { decisionId, action, decidedBy, rationale = null }) {
  ...
  const row = buildChairmanSiteReviewAttestationRow({ decisionRow, decisionId, verdict: gate.verdict, decidedBy, rationale });

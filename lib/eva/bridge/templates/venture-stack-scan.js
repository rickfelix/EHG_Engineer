...
// straight from a `public/` directory OUTSIDE `src/` is not seen by this scanner, which
// only walks `src/` (see realIo below) — closing that would need a second root, out of

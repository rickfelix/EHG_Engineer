...
// Product Hunt GraphQL Client (SD-MAN-INFRA-PRODUCT-HUNT-GRAPHQL-001)
export {
  searchProductHuntByCategory,
  getProductHuntCache,
  clearProductHuntCache,
} from './product-hunt-client.js';
...
// Operations Cost Governance: RETIRED by SD-LEO-INFRA-FACTORY-COST-UNIT-001 (FR-6); the dead
// module + its test were DELETED by SD-LEO-FEAT-TABLE-ESTATE-RETIRE-001 (zero live importers;
// ops_cost_* tables never provisioned — information_schema empty). Factory cost visibility lives
// in lib/cost/* + scripts/llm-cost-report.mjs (npm run cost:report).

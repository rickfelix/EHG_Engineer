 ...
 * @param {number} [data.score_design] - Awwwards design score (0-10). Also accepts `design_score` for backward compat.
 * @param {number} [data.score_usability] - Awwwards usability score (0-10). Also accepts `usability_score`.
 * @param {number} [data.score_creativity] - Awwwards creativity score (0-10). Also accepts `creativity_score`.
 * @param {number} [data.score_content] - Awwwards content score (0-10). Also accepts `content_score`.
 * @param {string|string[]} [data.tech_stack] - Technology stack (TEXT[] in DB; strings are split on commas)
 ...
 * @param {string} [data.awwwards_page_url] - URL to the Awwwards page for this site

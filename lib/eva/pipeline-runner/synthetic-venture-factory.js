...
const ARCHETYPES = [
  { key: 'democratizer', dbArchetype: 'saas_b2c', label: 'Democratizer', market: 'underserved consumer', model: 'freemium' },
  { key: 'automator', dbArchetype: 'saas_b2b', label: 'Automator', market: 'enterprise operations', model: 'SaaS subscription' },
  { key: 'capability_productizer', dbArchetype: 'ai_agents', label: 'Capability Productizer', market: 'mid-market B2B', model: 'usage-based' },
  { key: 'first_principles_rebuilder', dbArchetype: 'marketplace', label: 'First Principles Rebuilder', market: 'legacy industry', model: 'platform' },
  { key: 'vertical_specialist', dbArchetype: 'saas_b2b', label: 'Vertical Specialist', market: 'niche vertical', model: 'enterprise license' },
  { key: 'portfolio_connector', dbArchetype: 'services', label: 'Portfolio Connector', market: 'EHG portfolio', model: 'internal platform' },
  { key: 'experience_designer', dbArchetype: 'content', label: 'Experience Designer', market: 'consumer digital', model: 'subscription' },
];

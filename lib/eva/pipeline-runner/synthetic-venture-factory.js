...
const ARCHETYPES = [
  { key: 'democratizer', label: 'Democratizer', market: 'underserved consumer', model: 'freemium' },
  { key: 'automator', label: 'Automator', market: 'enterprise operations', model: 'SaaS subscription' },
  { key: 'capability_productizer', label: 'Capability Productizer', market: 'mid-market B2B', model: 'usage-based' },
  { key: 'first_principles_rebuilder', label: 'First Principles Rebuilder', market: 'legacy industry', model: 'platform' },
  { key: 'vertical_specialist', label: 'Vertical Specialist', market: 'niche vertical', model: 'enterprise license' },
  { key: 'portfolio_connector', label: 'Portfolio Connector', market: 'EHG portfolio', model: 'internal platform' },
  { key: 'experience_designer', label: 'Experience Designer', market: 'consumer digital', model: 'subscription' },
];

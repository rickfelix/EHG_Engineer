...
// SD-LEO-INFRA-RETRO-PUBLISHED-GUARD-001 FR-3(b): this describe block's own title and array were
// pinning 6 sites while claiming 7 -- lib/sub-agents/retro/db-operations.js DOES consult
// isSafeToWriteRetro (via a dynamic import, in enhanceRetrospective()) but was never enumerated
// here, so a regression in its own wire-in would have gone undetected by this census. Added below.

...
export const PHASE_PREFIXES = Object.freeze({
  ...
  BLUEPRINT: 'blueprint', // Stages 13-16 (THE_BLUEPRINT)
  BUILD: 'build',         // Stages 17-21 (THE_BUILD)
  LAUNCH: 'launch',       // Stages 21-25 (THE_LAUNCH)
...
export const ARTIFACT_TYPE_BY_STAGE = Object.freeze({
  ...
  11: [ARTIFACT_TYPES.IDENTITY_NAMING_VISUAL, ARTIFACT_TYPES.IDENTITY_BRAND_NAME],
  ...
  17: [ARTIFACT_TYPES.BUILD_SYSTEM_PROMPT, ARTIFACT_TYPES.BUILD_CICD_CONFIG],

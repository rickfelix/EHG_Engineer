...
export const ARTIFACT_TYPES = Object.freeze({
  ...
  // Cross-cutting — S20-26 simulated-run harness durability (SD-LEO-INFRA-RUN-EVIDENCE-DURABILITY-001).
  // Finalize-mirror row for a harness run's journal (lib/harness/run-journal.mjs),
  // persisted independent of the .harness-runs filesystem scratch. Not tied to a
  // venture lifecycle stage — CHECK-widening pending chairman apply (see
  // database/artifact-type-parity-pending-chairman-gate.json).
  HARNESS_RUN_JOURNAL: 'harness_run_journal',

...
export const ARTIFACT_TYPES = Object.freeze({
  ...
  /** S17 per-variant failure marker (bounded retry exhausted) — SD-LEO-INFRA-STAGE-ARCHETYPE-GENERATION-001 ARM B */
  BLUEPRINT_S17_VARIANT_FAILED: 's17_variant_failed',
  /** S17 generation heartbeat (30s liveness signal) — SD-LEO-INFRA-STAGE-ARCHETYPE-GENERATION-001 ARM E */
  BLUEPRINT_S17_HEARTBEAT: 's17_heartbeat',

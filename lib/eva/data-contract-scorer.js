...
export function getDimensionInfo() {
  return {
    ...
    // the 'V05' literal above is a positional code with zero current callers (grepped
    // repo-wide) and is left unchanged. V05 is not documented anywhere in
    // docs/architecture/vision-gap-analysis.md, so the slug is the only stable reference.
    dimension_slug: slugifyDimensionName('Data Contracts'),
    name: 'Data Contracts',

...
async function run(ctx) {
  ...
  // Coordination anomaly detectors — READ-ONLY over claim state; fail-open.
  ...
  // Notification-wait surfacing (QF-20260905-346) — DEFAULT-OFF behind
  // SURFACE_NOTIFICATION_WAIT_V1, READ-ONLY, fail-open, observe-only (no SMS page yet). Emits
  // ONE de-duped operator alert when a seat has been sitting on a Notification event (most
  // commonly a permission prompt) past the freshness threshold.
  try {

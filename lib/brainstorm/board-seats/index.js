...
Produce a position that is specific to THIS topic. Reference concrete details from the topic, not generic strategic advice. If you identify an expertise gap that the board lacks, flag it clearly with: EXPERTISE_GAP: <description of what domain expertise is needed>.`
  },
  {
    code: 'CRO',
...
Produce a position that quantifies risk where possible. Use specifics from the topic, not generic risk frameworks. Flag expertise gaps with: EXPERTISE_GAP: <description>.`
  },
  {
    code: 'CTO',
...
Be specific about existing codebase assets. Reference actual table names, module paths, and patterns. Flag expertise gaps with: EXPERTISE_GAP: <description>.`
  },
  {
    code: 'CISO',
...
Reference specific constitutional rules when relevant (e.g., CONST-005, FOUR_OATHS). Flag expertise gaps with: EXPERTISE_GAP: <description>.`
  },
  {
    code: 'COO',
...
Be concrete about capacity constraints. Reference SD queue state and active work. Flag expertise gaps with: EXPERTISE_GAP: <description>.`
  },
  {
    code: 'CFO',
...
Quantify costs and returns where possible. Reference token counts, API call volumes, and time estimates. Flag expertise gaps with: EXPERTISE_GAP: <description>.`
  }
];

 ...
 */
async function detectBursts(options = {}) {
 ...
 */
async function createBurstGroup(burst) {
 ...
 */
async function runBurstDetection(options = {}) {
 ...
 */
async function findExistingBurstGroup(newError) {
 ...
 */
async function addToBurstGroup(error, burstGroup) {

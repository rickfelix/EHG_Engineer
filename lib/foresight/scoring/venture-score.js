 ...
 * decision (security-agent EXEC-TO-PLAN review finding). `rawScore` is likewise
 * coerced to a finite number (a non-finite input, e.g. from a caller bypassing
 * scoreVenture/computeWeightedScore, must not propagate as NaN into a chairman-facing
 * score -- adversarial PR review finding).

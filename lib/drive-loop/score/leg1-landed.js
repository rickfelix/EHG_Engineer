 ...
 *
 * ── REFERENCE-ONLY: THE LIVE RULE IS NOW A-LOCAL ──────────────────────────────────────────
 * SD-LEO-INFRA-DRIVE-SCORE-LEG1-001 measured this rule unearnable in this repo's
 * delete-branch-on-merge flow (evidence ab82da6b: 7/111 = 6.3%). The chairman ratified a
 * replacement (SD-LEO-INFRA-DRIVE-SCORE-LEG1-ALOCAL-001, ruling c8ad4998):
 * lib/drive-loop/score/leg1-landed-alocal.js is the LIVE leg1 rule wired into
 * scripts/cron/drive-report-sweep.mjs. This file is kept for its ancestry-vs-patch-equivalence
 * divergence test, which still has standalone value, but `scoreLeg1` below has zero production
 * callers and is not what the chairman's drive score currently measures.
 */

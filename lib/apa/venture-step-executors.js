 ...
 * https://altifyai.rickfelix2000.workers.dev): a pre-existing ambiguous `button:has-text
 * ("Continue")` selector (SD-LEO-INFRA-VENTURE-JOURNEY-UAT-001, out of this SD's scope to
 * fix) can click "Continue with Google" instead of the credentials-form submit button,

...
export async function executeJourneyStep(page, step, stepExecutors, persona, ctx) {
  ...
  try {
    ...
    return { step, url, renderedStateSummary, success: true, failureReason: null, ctxUpdates, clickedButtonText: null, authForensics: null };
  } catch (err) {
    ...
    return { step, url: null, renderedStateSummary: null, success: false, failureReason, ctxUpdates: {}, clickedButtonText, authForensics };
  }
}

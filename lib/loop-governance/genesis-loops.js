...
export const GENESIS_LOOPS = [
  ...
  { loop_key: 'L10', display_name: 'Thesis-kill gauge dead (resolveObservedValue→undefined→HOLD)', closing_sd_key: 'SD-LEO-INFRA-MINUS-CARGO-INSTRUMENTS-001', status: 'open' },

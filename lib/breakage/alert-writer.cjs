 ...
 */
// SD-LEO-INFRA-BREAKAGE-DETECTOR-SURFACE-001-C removed the removal-conditioned wire-check exemption
// that child B placed here: this module is now genuinely reachable (child C wires the three passive
// detectors to recordSystemAlert via lib/breakage/emit-breakage-alert.cjs), so it is wire-checked
// normally — no exemption needed.
'use strict';

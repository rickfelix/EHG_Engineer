...
export function resolveVentureRoles(baseRows, overlayRows, pins, ventureId, budgetDistribution) {
  ...
  // avoid. Classification reads the role's OWN pinned base row (not an arbitrary baseRows entry),
  // so it is version-consistent with what resolveOne() will actually return for that role.

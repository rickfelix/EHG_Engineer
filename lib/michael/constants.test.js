...
describe('resolveConstant', () => {
  ...
  it('an unknown name is CONSTANT_UNKNOWN and the registry is frozen', () => {
    ...
    expect(Object.keys(MICHAEL_CONSTANTS)).toEqual(['MICHAEL_EXELON_CALENDAR_ID', 'MICHAEL_TASKS_DRIVE_FOLDER_ID', 'MICHAEL_DAILY_CHECKIN_TASK_ID', 'MICHAEL_EHG_CHAIRMAN_PROJECT_ID', 'MICHAEL_GMAIL_MODIFY_CEILING', 'MICHAEL_ORACLE_DRIVE_FOLDER_ID', 'MICHAEL_HEALTH_DRIVE_FOLDER_ID']);
  });
});

...
export const MICHAEL_CONSTANTS = Object.freeze({
  ...
  // Child J (v1.1): oracle-extract/health-sync's own Drive folders, same required-no-default
  // posture as MICHAEL_TASKS_DRIVE_FOLDER_ID above -- a missing constant is CONSTANT_MISSING
  // (exit 2, zero Drive/DB calls made), never a silently-empty read.
  MICHAEL_ORACLE_DRIVE_FOLDER_ID: Object.freeze({ required: true }),
  MICHAEL_HEALTH_DRIVE_FOLDER_ID: Object.freeze({ required: true }),
});

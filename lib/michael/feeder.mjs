...
export const FEEDERS = Object.freeze({
  ...
  // checkpoint send verb. Four narrow 15-minute windows (matching the 15-minute fire interval, so
  // each window catches exactly 2 fires with no gap) at 6am/10am/2pm/6pm ET -- the exact four
  // windows the ratification names, never a fifth. venue is 'task_scheduler' (host-local) because
  // the verb needs the chairman-provisioned MICHAEL_TWILIO_* credentials, matching the credentialed
  // feeders above (todoist-brief, brief-assemble, oracle-extract, health-sync).
  'checkpoint-send': Object.freeze({ venue: 'task_scheduler', window: Object.freeze([Object.freeze({ start: '06:00', end: '06:15' }), Object.freeze({ start: '10:00', end: '10:15' }), Object.freeze({ start: '14:00', end: '14:15' }), Object.freeze({ start: '18:00', end: '18:15' })]), intervalMinutes: 15 }),
});

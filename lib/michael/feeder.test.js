...
describe('pure helpers', () => {
  it('registry lists the ten feeder ids with venues and inclusive windows', () => {
    expect(FEEDER_IDS).toEqual(['tasks-classifier', 'calendar-read', 'gmail-triage', 'todoist-brief', 'seat-classify', 'retention', 'brief-assemble', 'oracle-extract', 'health-sync', 'youtube-digest']);

...
async function acquireLock(supabase, sessionId) {
  ...
  // 0 ever acknowledged, all-time). NULL matches this repo's own established pattern for an
  // informational row with no addressee (e.g. coordinator_reservation bookkeeping markers).

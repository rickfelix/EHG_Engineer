...
const STAGE_CONFIG = {
  ...
  15: {
    ...
    requiredArtifacts: ['blueprint_user_story_pack'],
    workType: 'artifact_only',
    gateType: null,
    phase: 'THE_BLUEPRINT',
  ...
  16: {
    ...
    requiredArtifacts: ['blueprint_api_contract', 'blueprint_schema_spec'],
    workType: 'decision_gate',
    gateType: 'promotion',
    phase: 'THE_BLUEPRINT',
  ...
  17: {
    ...
    requiredArtifacts: ['build_system_prompt', 'build_cicd_config'],
    workType: 'sd_required',
    gateType: 'promotion',
    phase: 'THE_BUILD',
  ...
  20: {
    ...
    requiredArtifacts: ['build_security_audit'],
    workType: 'sd_required',
    gateType: null,
    phase: 'THE_BUILD',
  ...
  21: {
    ...
    requiredArtifacts: ['launch_test_plan', 'launch_uat_report'],
    workType: 'sd_required',
    gateType: null,
    phase: 'THE_BUILD',
  ...
  24: {
    ...
    requiredArtifacts: ['launch_analytics_dashboard', 'launch_health_scoring', 'launch_churn_triggers', 'launch_retention_playbook'],
    workType: 'sd_required',
    gateType: 'promotion',
    phase: 'THE_LAUNCH',
  ...
  25: {
    ...
    requiredArtifacts: ['launch_optimization_roadmap', 'launch_assumptions_vs_reality'],
    workType: 'sd_required',
    gateType: null,
    phase: 'THE_LAUNCH',

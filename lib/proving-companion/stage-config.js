...
const STAGE_CONFIG = {
  ...
  25: {
    ...
    // SD-LEO-FEAT-STAGE-LIVE-ANNOUNCE-001 FR-1e: typo `launch_launch_metrics` retired; canonical key is `launch_metrics`. lifecycle_stage_config row 24 (canonical Go Live stage) was UPDATEd in the same SD; the next generate-stage-config.js run will reflect the row 24 change here. The legacy alias remains valid in the DB CHECK constraint for read-back.

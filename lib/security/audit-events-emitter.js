...
// Re-export reader for symmetric writer/consumer access (PAT-LEO-INFRA-WRITER-CONSUMER-ASYMMETRY-001 mitigation).
// Callers can import everything from one entry point; tests verify parity.
export {
  getEventsByCorrelationId,
  getEventsByVenture,
  getRecentBySeverity,
  formatForensicChain
} from './audit-events-reader.js';

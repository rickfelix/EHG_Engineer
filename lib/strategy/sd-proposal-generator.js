...
export async function approveProposal(proposalId, options = {}) {
  ...
  // canonical `node scripts/leo-create-sd.js --from-proposal` path. This caller is reachable only from the
  // archived intelligence-loop; if it is ever un-archived, route through --from-proposal instead of this bridge.

...
export const RETENTION_POLICIES = [
  ...
  // created_at (DB-defaulted, DEFAULT now(), the writer never supplies its own value) — the same
  // "no writer can backdate it" property this registry's header requires. 90 days is safe: as of
  // this SD, the table has zero readers (matching the feedback-table mirror it replaces), so
  // there is no consumer lookback window to protect against.

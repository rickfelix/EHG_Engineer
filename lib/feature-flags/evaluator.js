...
export async function evaluateFlag(flagKey, context = {}) {
  ...
  try {
    ...
    // Step 3: Check global enabled state
    if (!flag.is_enabled) {
      result.enabled = false;
    ...
    // Step 4: Get policy for environment
    ...
    // Step 5: Check user targeting - allowlist override
    ...
    // Step 6: Check user targeting - blocklist
    ...
    // Step 7: Check rollout percentage

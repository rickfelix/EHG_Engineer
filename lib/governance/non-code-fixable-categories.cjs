...
//
// QF-20260822-307: same drift-and-patch class recurred four days later -- live
// measurement 2026-08-22 found 0 of 16 Phase 1 issue rows were actually
// code-fixable, with 'corrective_finding' (Vision/Architecture Gap scores from
// the vision-alignment auditor) and 'solomon_trend_candidate' (Solomon's
// repeat-question trend detector) accounting for 14 of the 16. Added both.

...
export const GUARD_REGISTRY = deepFreeze([
  {
    ...
    definedAt: 'scripts/solomon-advisory.cjs:334', // QF-20260912-514 shifted 319 -> 334 (new framingUnstampedWarning() inserted above it in the same file)
    gatedInput: 'spent',
    ...
    note: 'The Solomon per-sweep cost ceiling. STILL ZERO executable production callers -- the only '
      + 'caller-shaped reference is a PROMPT STRING at scripts/solomon-startup-check.mjs:187, so what '
      + 'is unwired is the CALL, not the check. QF-20260903-418 derived the extent, refused the retired '
      + 'scope-ambiguous keys, and made an unmeasured extent FAIL CLOSED (no argument-less rubber stamp).',
  },
  {
  ...
  },
  {
    ...
    definedAt: 'lib/adam/rationale-bar.js:302',

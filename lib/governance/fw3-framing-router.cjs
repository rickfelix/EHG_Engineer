 ...
 *
 * RETIREMENT RULE (QF-20260912-514, ratification a236d122: "the rows decide, not
 * preference"): the router exists to distinguish a genuine pick-class portfolio call from
 * routine instrument-class sourcing. If 'pick' has not fired by the second or third weekly
 * cycle of STAMPED traffic (i.e. senders are actually using --framing-class, not defaulting
 * to unclassified), the router is retired — the distinction it exists to draw has produced
 * zero information. lib/governance/fw3-framing-yield.cjs / scripts/framing-router-yield.mjs
 * measure the trailing-window sender behavior (stamped instrument / stamped pick /
 * unclassified) this rule is judged against.
 */

...
// register() removed by SD-LEO-GEN-ENFORCE-GOVERNANCE-GUARDRAILS-001
// Runtime guardrail replacement was a bypass vector. Guardrails are now
// immutable at runtime and enforced at both JS and database level.
...
// Public API — register/reset removed to prevent runtime bypass (SD-LEO-GEN-ENFORCE-GOVERNANCE-GUARDRAILS-001)
export {
  list,
  check,
  auditOverrides,
...
// Test-only namespace — NOT part of the public API
export const _test = { register, reset };

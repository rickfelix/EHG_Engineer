...
/**
 * SHA-256 of the artifact's raw bytes (not the parsed JSON), so trailing-whitespace or
 * encoding tampering is caught. Returns null on any read error, never throws.
 * @param {string|null|undefined} filePath

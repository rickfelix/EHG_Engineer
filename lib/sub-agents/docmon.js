...
export async function execute(sdId, subAgent, options = {}) {
  ...
  try {
    ...
    const retroFiles = await findFiles(rootDir, /retrospective.*\.md$/i, [join(rootDir, 'retrospectives'), join(rootDir, 'docs', 'reference')]);
    ...
    const handoffFiles = await findFiles(rootDir, /handoff.*\.md$/i, [join(rootDir, 'docs', 'reference')]);

...
export async function execute(rcrId, subAgent, options = {}) {
  ...
  // Initialize Supabase client with SERVICE_ROLE_KEY. SD-LEO-ORCH-CAPA-GATE-EVIDENCE-001-C
  // (FR-C1/FR-C3, PLAN-phase TESTING review evidence baded1f3): accept an injected client so
  // tests can drive this module against a fake DB, matching scripts/record-explore-evidence.js's
  // injected-store precedent -- this module previously always built its own client, making it
  // untestable without a real Supabase connection.

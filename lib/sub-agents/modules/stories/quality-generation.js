...
export function generateQualityStoryContent(criterion, prd, index, options = {}) {
  ...
  // SD-MAN-GEN-TITLE-TARGET-APPLICATION-001: Use app-aware forbidden list
  const appForbiddenList = options.targetApp
    ? getForbiddenPersonasSync(options.targetApp, options.sdType)
    : FORBIDDEN_PERSONAS;
 ...
 */
export async function generateQualityStoryContentWithLLM(criterion, prd, index, options = {}, sdContext = null) {

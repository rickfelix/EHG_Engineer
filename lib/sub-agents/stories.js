 ...
 * PAT-STORY-BENEFIT-001: Improved to handle API/technical stories
 */
function generateUserBenefit(criterion, prd, userRole) {
  const criterionLower = criterion.toLowerCase();

  // Benefit patterns based on action type
  // PAT-STORY-BENEFIT-001: Added API/technical patterns for better coverage
  const benefitMap = {
    // Standard UI actions
    ...
    // API/Technical patterns (PAT-STORY-BENEFIT-001)
    'implement': 'the system provides reliable functionality for my workflow',
    'endpoint': 'I can integrate this functionality into my workflows',
    'api': 'I can access data programmatically when needed',
    'validation': 'my data is protected from invalid inputs and errors',
    'authorization': 'my data and actions are properly secured',
    'authentication': 'only authorized users can access sensitive features',
    'realtime': 'I receive immediate feedback and updates',
    'sse': 'I see live updates without refreshing the page',
    'idempotency': 'I am protected from duplicate operations',
    'correlation': 'I can trace issues across the system easily',
    'test': 'I can trust the system works correctly',
    'coverage': 'edge cases are handled properly'
  };

  ...
  async checkBudgetOrThrow() {
    ...
    if (budgetError || !budgetData) {
      ...
      if (phaseError || !phaseBudgetData) {
        // No budget record found - log warning and allow execution
        // This handles legacy ventures without budget tracking
        console.log('   [BUDGET] No budget record found - execution allowed');
  ...
  async runAgentLoop() {
    while (this.isRunning) {
      try {
        ...
        // Handle BudgetExhaustedException specially - stop the runtime

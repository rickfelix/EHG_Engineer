...
// path import available for future file operations
import { getInstance as getMapper } from './type-mapping.js';
...
class DesignFixGenerator {
  ...
  fixColorContrast(finding) {
    const { foreground, background: _background, recommendation } = finding.metadata || {};

...
export class VentureCEORuntime {
  ...
  constructor(supabase, agentId, options = {}) {
    ...
    this.handlers = {
      ...
      mission_draft: this.handleCEOMissionDraft.bind(this),
      okr_tracking: this.handleCEOOKRTracking.bind(this),
      monthly_report: this.handleCEOMonthlyReport.bind(this)
    };
  ...
  async handleCEOMissionDraft(message) {
    return handleCEOMissionDraft(this._getContext(), message);
  }

  async handleCEOOKRTracking(message) {
    return handleCEOOKRTracking(this._getContext(), message);
  }

  async handleCEOMonthlyReport(message) {
    return handleCEOMonthlyReport(this._getContext(), message);
  }

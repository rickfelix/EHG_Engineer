 ...
 * db80264a). target_session uses the 'broadcast-coordinator' sentinel (lib/coordinator/dispatch.cjs
 * SENTINEL_TARGETS; retargeted from bare 'broadcast' by QF-20260911-753, which retired it -- 0 of
 * 91 rows on that sentinel were ever acknowledged, all-time) — this is a fleet-wide advisory, not

...
**Impact**: Every agent invocation is a missed opportunity to leverage accumulated knowledge. The RCA agent — whose entire job is to prevent recurring issues — doesn't even receive the list of known recurring issues.

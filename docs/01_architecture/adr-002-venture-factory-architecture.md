...
> - **Stage counts**: the **`venture_stages` table is the single source of truth** for the venture lifecycle. Literal stage counts in this document (25-stage, 40-stage, etc.) reflect the lifecycle *as of approval* and are NOT current — the live lifecycle has since changed (27 stages as of migration 20260828) and may change again. Read `venture_stages`, never this document, for the current stage set.
...
**Source Document**: `docs/vision/venture-engine-golden-nuggets-plan.md`
...
*Source: docs/vision/venture-engine-golden-nuggets-plan.md*

...
**Does not close:** no wake path for a venture-less resolve. Filed rather than fixed here — a
routing mechanism (capture a routable session id at record time, then notify on resolve) is new

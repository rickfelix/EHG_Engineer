...
- 2026-09-07 v1.2 — §8 names the five seat-writable verdict columns; an action intent is never seat-written (PLAN amendment, SECURITY F-2; SD-LEO-ORCH-MICHAEL-ROLE-FORMALIZATION-002-D VALIDATION condition 2).

<!-- AUTHORING SOURCE for leo_protocol_sections section_type=michael_model_posture.
     The DATABASE ROW is the source of truth once seeded; CLAUDE_MICHAEL_MODEL_POSTURE.md is generated from it.
     Seed/refresh: node scripts/one-off/_michael-role-contract-section.mjs (dry-run) / --apply.
     The seed slices from the **Venue consequence** line through just before ## Changelog.
     SD-LEO-ORCH-MICHAEL-ROLE-FORMALIZATION-002-A (FR-4). Source: docs/michael/02-SPEC.md v0.3 §3,
     chairman decisions 2b14e48d (seat model) and 6d04b3b9 (cheap tier), Solomon Q3 and Q5. -->

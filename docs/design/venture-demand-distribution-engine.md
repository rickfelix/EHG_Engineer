...
- **Motion A — Self-serve / product-led only.** No human in the funnel. **Constrains S2/S5 selection**: a venture passes only if its thesis shows the persona self-serves at the price point (low-WTP/high-volume or credit-card-authority buyers). Fits the ALL-AI premise and the bandwidth inversion exactly.

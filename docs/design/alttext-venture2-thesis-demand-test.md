...
- **C1 outreach (primary):** bounded 50-contact email sequence through the real email channel, coordinator-routed per the demand-E gate, chairman-visible. *Envelope note: the email channel is currently in degraded/redirect mode — its restoration is a PRECONDITION and is flagged as such, not silently assumed.*

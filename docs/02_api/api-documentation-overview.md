...
- [Strategic Directives](#strategic-directives)
  - [GET /api/sd](#get-apisd)
  - [GET /api/sd/:id](#get-apisdid)
- [Product Requirements Documents](#product-requirements-documents)
  - [GET /api/prd](#get-apiprd)
  - [GET /api/prd/:id](#get-apiprdid)
  - [GET /api/prd/:sd_id](#get-apiprdsd_id)
- [SDIP (Strategic Directive Input Process)](#sdip-strategic-directive-input-process)
  - [POST /api/sdip/submit](#post-apisdipsubmit)
  - [PUT /api/sdip/submissions/:id/step/:stepNumber](#put-apisdipsubmissionsidstepstepnumber)
  - [GET /api/sdip/submissions](#get-apisdipsubmissions)
  - [DELETE /api/sdip/submissions/:id](#delete-apisdipsubmissionsid)
  - [POST /api/sdip/screenshot](#post-apisdipscreenshot)
  - [GET /api/sdip/progress/:id](#get-apisdipprogressid)
  - [POST /api/sdip/create-strategic-directive](#post-apisdipcreate-strategic-directive)
- [Backlog Management](#backlog-management)
  - [GET /api/backlog/strategic-directives](#get-apibacklogstrategic-directives)
  - [GET /api/backlog/strategic-directives/:sd_id](#get-apibacklogstrategic-directivessd_id)
  - [GET /api/backlog/strategic-directives-with-items](#get-apibacklogstrategic-directives-with-items)
  - [GET /api/strategic-directives/:sd_id/backlog-summary](#get-apistrategic-directivessd_idbacklog-summary)
- [Ventures API](#ventures-api)
  - [GET /api/ventures](#get-apiventures)
  - [GET /api/ventures/:id](#get-apiventuresid)
  - [POST /api/ventures](#post-apiventures)
  - [GET /api/ventures/:id/artifacts](#get-apiventuresidartifacts)
  - [POST /api/ventures/:id/artifacts](#post-apiventuresidartifacts)
  - [PATCH /api/ventures/:id/stage](#patch-apiventuresidstage)
  - [POST /api/competitor-analysis](#post-apicompetitor-analysis)
- [Story API](#story-api)
  - [POST /api/stories/generate](#post-apistoriesgenerate)
  - [GET /api/stories](#get-apistories)
  - [POST /api/stories/verify](#post-apistoriesverify)
  - [GET /api/stories/gate](#get-apistoriesgate)
  - [GET /api/stories/health](#get-apistorieshealth)
- [Discovery API](#discovery-api)
  - [POST /api/discovery/scan](#post-apidiscoveryscan)
  - [GET /api/discovery/opportunities](#get-apidiscoveryopportunities)
  - [GET /api/discovery/scans](#get-apidiscoveryscans)
  - [POST /api/discovery/decision](#post-apidiscoverydecision)
- [Blueprints API](#blueprints-api)
  - [GET /api/blueprints](#get-apiblueprints)
  - [GET /api/blueprints/:id](#get-apiblueprintsid)
- [Calibration API (Sovereign Pipe v3.7.0)](#calibration-api-sovereign-pipe-v370)
  - [GET /api/calibration/venture/:venture_id](#get-apicalibrationventureventure_id)
  - [GET /api/calibration/threshold/:sd_id](#get-apicalibrationthresholdsd_id)
  - [POST /api/calibration/compute](#post-apicalibrationcompute)
  - [GET /api/calibration/portfolio](#get-apicalibrationportfolio)
- [Testing Campaign API](#testing-campaign-api)
  - [GET /api/testing/campaign/status](#get-apitestingcampaignstatus)
  - [GET /api/testing/campaign/health](#get-apitestingcampaignhealth)
  - [GET /api/testing/campaign/apps](#get-apitestingcampaignapps)
  - [POST /api/testing/campaign/start](#post-apitestingcampaignstart)
  - [POST /api/testing/campaign/stop](#post-apitestingcampaignstop)
  - [GET /api/testing/campaign/logs/:type](#get-apitestingcampaignlogstype)
- [PR Review System](#pr-review-system)
  - [GET /api/pr-reviews](#get-apipr-reviews)
  - [GET /api/pr-reviews/metrics](#get-apipr-reviewsmetrics)
  - [POST /api/github/pr-review-webhook](#post-apigithubpr-review-webhook)
- [Dashboard & Status](#dashboard-status)
  - [GET /api/status](#get-apistatus)
  - [GET /api/state](#get-apistate)
  - [GET /api/ees](#get-apiees)
  - [GET /api/context](#get-apicontext)
  - [GET /api/progress](#get-apiprogress)
  - [GET /api/handoff](#get-apihandoff)
  - [GET /api/eva/status](#get-apievastatus)
  - [GET /api/integrity-metrics](#get-apiintegrity-metrics)
  - [GET /api/metrics](#get-apimetrics)
- [Venture-Scoped API (v2)](#venture-scoped-api-v2)
  - [GET /api/v2/ventures/:venture_id/strategic-directives](#get-apiv2venturesventure_idstrategic-directives)
  - [GET /api/v2/ventures/:venture_id/prds](#get-apiv2venturesventure_idprds)
  - [GET /api/v2/ventures/:venture_id/backlog](#get-apiv2venturesventure_idbacklog)
- [WebSocket API](#websocket-api)
  - [Connection](#connection)
  - [Client Messages](#client-messages)
  - [Server Messages](#server-messages)
- [Error Handling](#error-handling)
  - [EVA Error Format (Sovereign Pipe v3.7.0)](#eva-error-format-sovereign-pipe-v370)

# Guides & Instructions Index

> **DATABASE-FIRST (LEO Protocol v4.3.3)**: This index helps navigate the guides directory.
> For protocol-related guides, also check `/CLAUDE.md` and `/CLAUDE_CORE.md`.
...
| [database-connection.md](database-connection.md) | Supabase connection patterns |
...
| Guide | Description |
|-------|-------------|
| [ehg-uat-script.md](ehg-uat-script.md) | UAT test scripts for EHG |
| [uat-manual-test-logical-order.md](uat-manual-test-logical-order.md) | Manual UAT test ordering |
| [enhanced-testing-integration.md](enhanced-testing-integration.md) | Enhanced testing framework |
| [enhanced-testing-troubleshooting.md](enhanced-testing-troubleshooting.md) | Testing troubleshooting guide |
| [qa-director-usage.md](qa-director-usage.md) | QA Director sub-agent usage |
| [testing-debugging-collaboration-playbook.md](testing-debugging-collaboration-playbook.md) | Testing collaboration patterns |
| [vision-qa-system.md](vision-qa-system.md) | Vision QA integration |
| [real-testing-campaign.md](real-testing-campaign.md) | Real testing campaign guide |
...
| Guide | Description |
|-------|-------------|
| [prd-creation-process.md](prd-creation-process.md) | PRD creation workflow |
...
| Guide | Description |
|-------|-------------|
| [semantic-search-deployment.md](semantic-search-deployment.md) | Semantic search deployment |
| [semantic-search-deployment-checklist.md](semantic-search-deployment-checklist.md) | Deployment checklist |
| [prompt_template_library.md](prompt_template_library.md) | Prompt template library |
| [self-improvement-system-guide.md](self-improvement-system-guide.md) | Self-improvement system |
| [learning-history-integration-guide.md](learning-history-integration-guide.md) | Learning history integration |
...
| [backlog-management.md](backlog-management.md) | Backlog management patterns |
...
- `/docs/reference/` - Quick reference and patterns

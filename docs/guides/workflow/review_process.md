...
- [Overview](#overview)
  ...
  - [Scope](#scope)
- [5-Step Review Cycle](#5-step-review-cycle)
  - [Step 1: Dossier Review](#step-1-dossier-review)
- [Purpose](#purpose)
- [Expected Deliverables](#expected-deliverables)
- [Success Criteria](#success-criteria)
- [Dependencies](#dependencies)
- [Original Intent](#original-intent)
  - [Step 2: Reality Check](#step-2-reality-check)
- [Database Tables](#database-tables)
  - [EHG Application Database](#ehg-application-database)
  - [EHG_Engineer Database](#ehg_engineer-database)
...
- [Critical Gaps (Blockers)](#critical-gaps-blockers)
  - [Gap 1: [Gap Title]](#gap-1-gap-title)
  - [Gap 2: [Gap Title]](#gap-2-gap-title)
...
- [Deviations from Dossier Intent](#deviations-from-dossier-intent)
  - [Deviation 1: [What Changed]](#deviation-1-what-changed)
- [Dependencies Impact](#dependencies-impact)
  - [Prerequisite Stages](#prerequisite-stages)
  - [Blocked Stages](#blocked-stages)
- [Recommendations Summary](#recommendations-summary)
  - [Step 4: Chairman Decision](#step-4-chairman-decision)
- [Decision](#decision)
- [Rationale](#rationale)
- [If Strategic Directive Spawned](#if-strategic-directive-spawned)
...
- [Next Stage Recommendations](#next-stage-recommendations)
- [Audit Confirmation](#audit-confirmation)
- [Governance Integration](#governance-integration)
  - [Strategic Directive Linking](#strategic-directive-linking)
  - [Stage Status Tracking](#stage-status-tracking)
- [Review Workflow Best Practices](#review-workflow-best-practices)
  - [Before Starting Review](#before-starting-review)
  - [During Review](#during-review)
  - [After Review](#after-review)
- [Quality Standards](#quality-standards)
  - [Dossier Summary Quality](#dossier-summary-quality)
  - [As-Built Inventory Quality](#as-built-inventory-quality)
  - [Gap Analysis Quality](#gap-analysis-quality)
  - [Decision Record Quality](#decision-record-quality)
  - [Outcome Log Quality](#outcome-log-quality)
- [Metrics & Success Criteria](#metrics-success-criteria)
  - [Review Completion Metrics](#review-completion-metrics)
  - [Framework Success Criteria](#framework-success-criteria)
- [Continuous Improvement](#continuous-improvement)
  - [After Each Review](#after-each-review)
  - [After 5 Reviews](#after-5-reviews)
- [Appendix: Tool Reference](#appendix-tool-reference)
  - [Database Query Tools](#database-query-tools)
  - [File Search Tools](#file-search-tools)
  - [File Read Tools](#file-read-tools)

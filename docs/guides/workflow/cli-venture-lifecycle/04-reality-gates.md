...
- [Design Philosophy](#design-philosophy)
  ...
  - [Non-Configurable Thresholds](#non-configurable-thresholds)
  - [Dependency Injection](#dependency-injection)
- [The 5 Enforced Boundaries](#the-5-enforced-boundaries)
  - [Boundary Summary](#boundary-summary)
- [Boundary Map Across Lifecycle Phases](#boundary-map-across-lifecycle-phases)
...
- [Gate Evaluation Flow](#gate-evaluation-flow)
  - [No Short-Circuiting](#no-short-circuiting)
- [Three Quality Checks](#three-quality-checks)
  - [Check 1: Artifact Existence](#check-1-artifact-existence)
  - [Check 2: Quality Score Threshold](#check-2-quality-score-threshold)
  - [Check 3: URL Reachability](#check-3-url-reachability)
- [Reason Codes](#reason-codes)
  - [Reason Object Shape](#reason-object-shape)
...
- [URL Verification](#url-verification)
  ...
  - [Dependency Injection](#dependency-injection)
- [Boundary Configuration Details](#boundary-configuration-details)
  - [Gate 1: Truth -> Engine (5 -> 6)](#gate-1-truth---engine-5---6)
  - [Gate 2: Engine -> Identity (9 -> 10)](#gate-2-engine---identity-9---10)
  - [Gate 3: Identity -> Blueprint (12 -> 13)](#gate-3-identity---blueprint-12---13)
  - [Gate 4: Blueprint -> Build (16 -> 17)](#gate-4-blueprint---build-16---17)
  - [Gate 5: Build -> Launch (20 -> 21)](#gate-5-build---launch-20---21)
- [Relationship to Stage Gates](#relationship-to-stage-gates)
  - [Key Differences](#key-differences)
  - [Overlapping Stages](#overlapping-stages)
- [Integration with Eva Orchestrator](#integration-with-eva-orchestrator)
- [Testing Strategy](#testing-strategy)
  - [Database Interaction Testing](#database-interaction-testing)
  - [URL Verification Testing](#url-verification-testing)
  - [Boundary Coverage](#boundary-coverage)
  - [Fail-Closed Coverage](#fail-closed-coverage)
...
The venture lifecycle (defined by the venture_stages SSOT; 27 stages as of the 2026-08-28 renumbering) is organized into 6 major phases. Reality

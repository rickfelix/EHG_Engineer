...
- [Kill Gate 3: Market Validation](#kill-gate-3-market-validation)
...
- [Kill Gate 5: Profitability](#kill-gate-5-profitability)
  - [Trigger Conditions](#trigger-conditions)
  - [3-Year Financial Model](#3-year-financial-model)
  - [Decision Matrix](#decision-matrix)
  - [Chairman Customization](#chairman-customization)
  - [On Kill](#on-kill)
  - [On Revise](#on-revise)
  - [On Proceed](#on-proceed)
  - [Implementation](#implementation)
- [Kill Gate 13: Tech Stack Feasibility](#kill-gate-13-tech-stack-feasibility)
  - [Trigger Conditions](#trigger-conditions)

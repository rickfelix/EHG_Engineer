...
- All 6 methodology rules from §0 hit at least once during S18 debugging (Rule 7 — *ask the consumer* — surfaced later during S19 build kickoff with Replit Agent and was retro-added to §0).

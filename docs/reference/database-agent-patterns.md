...
- [When to Invoke Database Agent](#when-to-invoke-database-agent)
  ...
  - [Action Trigger Keywords (NEW - 2026-01-23)](#action-trigger-keywords-new---2026-01-23)
...
- [Autonomy Decision Tree (NEW v1.3)](#autonomy-decision-tree-new-v13)
  - [Overview](#overview)
  - [The Problem (Pre-v1.3)](#the-problem-pre-v13)
  - [The Solution (v1.3)](#the-solution-v13)
  ...
  - [PostToolUse Hook: Automatic Migration Detection (NEW - 2026-01-23)](#posttooluse-hook-automatic-migration-detection-new---2026-01-23)
...
- [Proactive Learning Integration (NEW)](#proactive-learning-integration-new)
  - [Before Starting ANY Database Work](#before-starting-any-database-work)
  - [Known Database Issue Patterns](#known-database-issue-patterns)
  - [Integration with Phase Workflow](#integration-with-phase-workflow)
- [RLS Policy Handling (NEW)](#rls-policy-handling-new)
  - [Understanding RLS Access Levels](#understanding-rls-access-levels)
  - [When RLS Blocks Operations](#when-rls-blocks-operations)
  - [RLS Policy Design Patterns](#rls-policy-design-patterns)
- [Governance Trigger Automation Bypass (NEW)](#governance-trigger-automation-bypass-new)
  - [The Problem](#the-problem)
  - [The Solution: `automation_context`](#the-solution-automation_context)
  - [Valid Actor Roles](#valid-actor-roles)
  - [Affected Governance Triggers](#affected-governance-triggers)
  - [Audit Trail](#audit-trail)
  - [Usage Example (JavaScript)](#usage-example-javascript)
  - [Security Considerations](#security-considerations)
  - [Related](#related)
- [Schema Validation Enhancements (NEW)](#schema-validation-enhancements-new)
  - [Pre-Change Validation Checklist](#pre-change-validation-checklist)
  - [Schema Validation Tool Pattern](#schema-validation-tool-pattern)
- [Anti-Patterns to Avoid](#anti-patterns-to-avoid)
  ...
  - [❌ Anti-Pattern 8: JSON.stringify() on JSONB Fields](#-anti-pattern-8-jsonstringify-on-jsonb-fields)
- [Success Patterns](#success-patterns)
  ...
  - [Pattern 4: Proactive Learning Consultation (NEW)](#pattern-4-proactive-learning-consultation-new)
  - [Pattern 5: RLS Blocker Documentation (NEW)](#pattern-5-rls-blocker-documentation-new)
  - [Pattern 6: Schema Format Validation (NEW)](#pattern-6-schema-format-validation-new)
  - [Pattern 7: Supabase API Key Resilience (NEW - 2026-01-25)](#pattern-7-supabase-api-key-resilience-new---2026-01-25)
  - [Pattern 8: Intelligent Migration Execution (NEW - 2026-01-23)](#pattern-8-intelligent-migration-execution-new---2026-01-23)
- [Database Query Best Practices](#database-query-best-practices)
  - [Context Efficiency Principles](#context-efficiency-principles)
  ...
  - [Rule 3: Summarize Large Results](#rule-3-summarize-large-results)
  - [Rule 4: Reference Instead of Dump](#rule-4-reference-instead-of-dump)
- [PRD Workflow Integration: Design → Database Pattern](#prd-workflow-integration-design-database-pattern)
  - [Workflow Sequence](#workflow-sequence)
  - [Why This Order?](#why-this-order)
  - [DATABASE Sub-Agent Context](#database-sub-agent-context)
  - [Example Invocation](#example-invocation)
  - [PRD Metadata Storage](#prd-metadata-storage)
  - [Benefits](#benefits)
  - [Schema Documentation Access](#schema-documentation-access)
...
- [SQL Execution Intent Semantic Triggering (NEW - 2026-01-24)](#sql-execution-intent-semantic-triggering-new---2026-01-24)
  - [Overview](#overview)
  - [Intent Classification System](#intent-classification-system)
  - [Denylist Filtering (False Positive Prevention)](#denylist-filtering-false-positive-prevention)
  - [Intent Classifier Usage](#intent-classifier-usage)
  - [Confidence Scoring Algorithm](#confidence-scoring-algorithm)
  - [Configuration Parameters](#configuration-parameters)
  - [Audit Trail](#audit-trail)
  - [Environment Safety](#environment-safety)
  - [SQL Context Detection](#sql-context-detection)
  - [Integration Examples](#integration-examples)
  - [Testing](#testing)
  - [Files Added](#files-added)
  - [Metrics & Observability](#metrics-observability)
  - [When to Use Directly](#when-to-use-directly)

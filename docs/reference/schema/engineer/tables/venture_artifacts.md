...
### Check Constraints
- `venture_artifacts_artifact_type_check`: CHECK (((artifact_type)::text = ANY ((ARRAY['architecture_plan'::character varying, 'blueprint_api_contract'::character varying, 'blueprint_data_model'::character varying, 'blueprint_erd_diagram'::character varying, 'blueprint_financial_projection'::character varying, 'blueprint_launch_readiness'::character varying, 'blueprint_product_roadmap'::character varying, 'blueprint_project_plan'::character varying, 'blueprint_promotion_gate'::character varying, 'blueprint_review_summary'::character varying, 'blueprint_risk_register'::character varying, 'blueprint_schema_spec'::character varying, 'blueprint_sprint_plan'::character varying, 'blueprint_technical_architecture'::character varying, 'blueprint_token_manifest'::character varying, 'blueprint_user_story_pack'::character varying, 'blueprint_wireframes'::character varying, 'build_brief'::character varying, 'build_cicd_config'::character varying, 'build_mvp_build'::character varying, 'build_security_audit'::character varying, 'build_system_prompt'::character varying, 'build_test_coverage_report'::character varying, 'design_token_manifest'::character varying, 'economic_lens'::character varying, 'engine_business_model_canvas'::character varying, 'engine_exit_strategy'::character varying, 'engine_pricing_model'::character varying, 'engine_revenue_model'::character varying, 'engine_risk_assessment'::character varying, 'engine_risk_matrix'::character varying, 'genesis_scaffold'::character varying, 'identity_brand_guidelines'::character varying, 'identity_brand_name'::character varying, 'identity_gtm_sales_strategy'::character varying, 'identity_logo_image'::character varying, 'identity_naming_visual'::character varying, 'identity_persona_brand'::character varying, 'intake_venture_analysis'::character varying, 'launch_analytics_dashboard'::character varying, 'launch_assumptions_vs_reality'::character varying, 'launch_churn_triggers'::character varying, 'launch_deployment_runbook'::character varying, 'launch_health_scoring'::character varying, 'launch_launch_metrics'::character varying, 'launch_marketing_checklist'::character varying, 'launch_optimization_roadmap'::character varying, 'launch_production_app'::character varying, 'launch_retention_playbook'::character varying, 'launch_test_plan'::character varying, 'launch_uat_report'::character varying, 'launch_user_feedback_summary'::character varying, 'lifecycle_sd_bridge'::character varying, 'post_lifecycle_decision'::character varying, 's11_identity'::character varying, 's17_approved'::character varying, 's17_approved_png'::character varying, 's17_archetypes'::character varying, 's17_design_system'::character varying, 's17_fill_screen'::character varying, 's17_preview'::character varying, 's17_qa_report'::character varying, 's17_session_state'::character varying, 's17_strategy_recommendation'::character varying, 's17_strategy_stats'::character varying, 's17_variant_scores'::character varying, 's17_variant_wip'::character varying, 'soul_document'::character varying, 'stage10_finalization'::character varying, 'stage11_identity'::character varying, 'stage12_guidelines'::character varying, 'stage13_implementation'::character varying, 'stage14_review'::character varying, 'stage15_wireframes'::character varying, 'stage16_soul'::character varying, 'stage18_sprint'::character varying, 'stage19_deployment'::character varying, 'stage1_raw_research'::character varying, 'stage2_market_analysis'::character varying, 'stage3_competitive'::character varying, 'stage4_strategy'::character varying, 'stage5_positioning'::character varying, 'stage6_validation'::character varying, 'stage7_formulation'::character varying, 'stage8_evaluation'::character varying, 'stage9_optimization'::character varying, 'stage_0_analysis'::character varying, 'stage_10_analysis'::character varying, 'stage_11_analysis'::character varying, 'stage_12_analysis'::character varying, 'stage_13_analysis'::character varying, 'stage_14_analysis'::character varying, 'stage_15_analysis'::character varying, 'stage_16_analysis'::character varying, 'stage_17_analysis'::character varying, 'stage_17_approved_desktop'::character varying, 'stage_17_approved_mobile'::character varying, 'stage_17_refined'::character varying, 'stage_18_analysis'::character varying, 'stage_19_analysis'::character varying, 'stage_1_analysis'::character varying, 'stage_20_analysis'::character varying, 'stage_21_analysis'::character varying, 'stage_22_analysis'::character varying, 'stage_23_analysis'::character varying, 'stage_24_analysis'::character varying, 'stage_25_analysis'::character varying, 'stage_26_analysis'::character varying, 'stage_2_analysis'::character varying, 'stage_3_analysis'::character varying, 'stage_4_analysis'::character varying, 'stage_5_analysis'::character varying, 'stage_6_analysis'::character varying, 'stage_7_analysis'::character varying, 'stage_8_analysis'::character varying, 'stage_9_analysis'::character varying, 'stitch_budget'::character varying, 'stitch_curation'::character varying, 'stitch_design_export'::character varying, 'stitch_project'::character varying, 'stitch_qa_report'::character varying, 'system_devils_advocate_review'::character varying, 'truth_ai_critique'::character varying, 'truth_competitive_analysis'::character varying, 'truth_financial_model'::character varying, 'truth_idea_brief'::character varying, 'truth_problem_statement'::character varying, 'truth_target_market_analysis'::character varying, 'truth_validation_decision'::character varying, 'truth_value_proposition'::character varying, 'value_multiplier_assessment'::character varying, 'vision_document'::character varying, 'wireframe_screens'::character varying])::text[])))

...
| directive_id | `character varying(150)` | YES | - | LEGACY SD linking column. Kept for backward compatibility. Auto-synced with sd_id. |
...
| sd_id | `character varying(150)` | YES | - | CANONICAL SD linking column. Use this for all queries. Auto-synced with directive_id. |
...
- **Timing**: AFTER INSERT
- **Action**: `EXECUTE FUNCTION check_prd_creation_source()`

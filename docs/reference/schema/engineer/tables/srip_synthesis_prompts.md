...
**Generated**: 2026-03-14T11:14:42.080Z
...
### 1. srip_synthesis_prompts_delete_policy (DELETE)

- **Roles**: {public}
- **Using**: `true`

### 2. srip_synthesis_prompts_insert_policy (INSERT)

- **Roles**: {public}
- **With Check**: `true`

### 3. srip_synthesis_prompts_select_policy (SELECT)

- **Roles**: {public}
- **Using**: `true`

### 4. srip_synthesis_prompts_update_policy (UPDATE)

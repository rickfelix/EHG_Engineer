...
- `cr_target_contracts_valid`: CHECK (((cardinality(target_contracts) > 0) AND (target_contracts <@ ARRAY['adam'::text, 'coordinator'::text, 'solomon'::text, 'michael'::text, 'protocol'::text])))

...
### 1. authenticated_select_substage_transition_log (SELECT)

- **Roles**: {authenticated}
- **Using**: `true`

### 2. service_role_insert_substage_transition_log (INSERT)

- **Roles**: {service_role}
- **With Check**: `true`

### 3. service_role_select_substage_transition_log (SELECT)

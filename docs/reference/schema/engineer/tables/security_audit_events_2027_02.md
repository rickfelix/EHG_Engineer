# security_audit_events_2027_02 Table
...
### Primary Key
- `security_audit_events_2027_02_pkey`: PRIMARY KEY (id, occurred_at)
...
- `security_audit_events_2027_02_correlation_id_idx`
  ```sql
  CREATE INDEX security_audit_events_2027_02_correlation_id_idx ON public.security_audit_events_2027_02 USING btree (correlation_id) WHERE (correlation_id IS NOT NULL)
  ```
- `security_audit_events_2027_02_event_type_severity_idx`
  ```sql
  CREATE INDEX security_audit_events_2027_02_event_type_severity_idx ON public.security_audit_events_2027_02 USING btree (event_type, severity)
  ```
- `security_audit_events_2027_02_occurred_at_idx`
  ```sql
  CREATE INDEX security_audit_events_2027_02_occurred_at_idx ON public.security_audit_events_2027_02 USING btree (occurred_at DESC)
  ```
- `security_audit_events_2027_02_pat_pattern_id_idx`
  ```sql
  CREATE INDEX security_audit_events_2027_02_pat_pattern_id_idx ON public.security_audit_events_2027_02 USING btree (pat_pattern_id) WHERE (pat_pattern_id IS NOT NULL)
  ```
- `security_audit_events_2027_02_pkey`
  ```sql
  CREATE UNIQUE INDEX security_audit_events_2027_02_pkey ON public.security_audit_events_2027_02 USING btree (id, occurred_at)
  ```
- `security_audit_events_2027_02_venture_id_idx`
  ```sql

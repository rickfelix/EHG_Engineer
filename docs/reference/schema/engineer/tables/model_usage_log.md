...
### 1. service_role_insert_model_usage_log (INSERT)

- **Roles**: {service_role}
- **With Check**: `true`

### 2. service_role_select_model_usage_log (SELECT)

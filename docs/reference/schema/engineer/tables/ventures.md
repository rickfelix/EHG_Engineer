...
| autonomy_level | `text` | YES | `'L1'::text` | Venture autonomy level: L0=Manual, L1=Guided, L2=Supervised, L3=Autonomous, L4=Full Auto |
...
### trigger_create_postmortem_on_failure

- **Timing**: AFTER UPDATE
- **Action**: `EXECUTE FUNCTION create_postmortem_on_venture_failure()`

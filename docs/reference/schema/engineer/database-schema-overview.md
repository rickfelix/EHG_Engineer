...
| [claude_sessions](tables/claude_sessions.md) | 6,079 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 72,835 | ✅ | 3 | - |
...
| [leo_protocol_sections](tables/leo_protocol_sections.md) | 173 | ✅ | 4 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 775 | ✅ | 3 | RLS: Append-only for authenticated |
...
| [validation_audit_log](tables/validation_audit_log.md) | 27,669 | ✅ | 3 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |

...
| [audit_log](tables/audit_log.md) | 20,061 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 78 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 1,656 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [eva_audit_log](tables/eva_audit_log.md) | 240 | ✅ | 3 | EVA Audit Trail - All actions logged |
...
| [feedback](tables/feedback.md) | 869 | ✅ | 8 | - |
...
| [governance_audit_log](tables/governance_audit_log.md) | 223,757 | ✅ | 2 | - |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 656 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [management_reviews](tables/management_reviews.md) | 5,535 | ✅ | 2 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 14,409 | ❌ | 0 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [retrospectives](tables/retrospectives.md) | 4,720 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 1,299 | ✅ | 2 | - |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 156 | ✅ | 3 | - |
...
| [workflow_executions](tables/workflow_executions.md) | 3,004 | ✅ | 3 | - |

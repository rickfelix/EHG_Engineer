...
| [agent_artifacts](tables/agent_artifacts.md) | 10,887 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 10,939 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 22,981 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 2,060 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [brainstorm_sessions](tables/brainstorm_sessions.md) | 338 | ✅ | 2 | Tracks brainstorming sessions across domains (venture, protocol, integration, architecture) with outcome classification, quality metrics, and capability matching. Used for question effectiveness analysis and retrospective integration. |
...
| [cascade_invalidation_flags](tables/cascade_invalidation_flags.md) | 10 | ✅ | 2 | - |
| [cascade_invalidation_log](tables/cascade_invalidation_log.md) | 27 | ✅ | 2 | - |
...
| [chairman_decisions](tables/chairman_decisions.md) | 27 | ✅ | 2 | SD-HARDENING-V1-001: Chairman-only decision records.
...
| [claude_sessions](tables/claude_sessions.md) | 11,557 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [connection_selection_log](tables/connection_selection_log.md) | 1,012 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [customer_personas](tables/customer_personas.md) | 15 | ✅ | 2 | Canonical customer persona catalog. Personas can be venture-specific (source_venture_id) or global (canonical_id IS NULL). |
...
| [debate_arguments](tables/debate_arguments.md) | 477 | ✅ | 2 | - |
| [debate_circuit_breaker](tables/debate_circuit_breaker.md) | 0 | ✅ | 2 | - |
| [debate_sessions](tables/debate_sessions.md) | 55 | ✅ | 3 | - |
...
| [eva_architecture_plans](tables/eva_architecture_plans.md) | 173 | ✅ | 2 | Architecture Plans linked to Vision documents. ON DELETE RESTRICT on vision_id prevents deleting a vision that has architecture plans. |
...
| [eva_interactions](tables/eva_interactions.md) | 8,951 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_stage_gate_results](tables/eva_stage_gate_results.md) | 66 | ✅ | 2 | Tracks EVA gate evaluations with kill gate enforcement (stages 3,5,13,23 require 70% score) |
...
| [eva_translation_gates](tables/eva_translation_gates.md) | 345 | ✅ | 3 | Translation fidelity gate results for the EVA pipeline. Each gate checks upstream artifacts against downstream artifacts to detect translation gaps. |
...
| [eva_vision_documents](tables/eva_vision_documents.md) | 179 | ✅ | 2 | Stores EHG portfolio (L1) and venture-specific (L2) vision documents for the EVA Vision Governance System. L2 visions link to L1 via parent_vision_id. |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 2,828 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [execute_teams](tables/execute_teams.md) | 0 | ✅ | 2 | Multi-session execution teams spawned by /execute command. One row per team; status tracks lifecycle pending_spawn → active → stopping → stopped/crashed/completed. metadata.slots[] persists callsign/color across worker respawns. |
...
| [feedback](tables/feedback.md) | 179 | ✅ | 8 | - |
...
| [governance_audit_log](tables/governance_audit_log.md) | 158,487 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 19,069 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 538 | ✅ | 5 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
| [judge_verdicts](tables/judge_verdicts.md) | 42 | ✅ | 3 | - |
...
| [learning_decisions](tables/learning_decisions.md) | 193 | ✅ | 1 | Tracks all /learn command actions, findings, and user approvals to close the feedback loop on organizational learning. |
...
| [leo_adrs](tables/leo_adrs.md) | 182 | ✅ | 2 | - |
...
| [leo_error_log](tables/leo_error_log.md) | 186 | ✅ | 2 | LEO Protocol error log for critical failures that need operator attention. Part of SD-GENESIS-V32-PULSE resilience infrastructure. |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 10,338 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 375 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [model_usage_log](tables/model_usage_log.md) | 12,549 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [operations_audit_log](tables/operations_audit_log.md) | 28 | ✅ | 2 | - |
...
| [outcome_signals](tables/outcome_signals.md) | 1,331 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 810 | ❌ | 0 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [plan_critiques](tables/plan_critiques.md) | 4 | ✅ | 2 | Pre-PLAN adversarial critique results from devils-advocate.js critiquePlanProposal(). Phase 1: advisory only — never blocks handoffs. |
...
| [quick_fixes](tables/quick_fixes.md) | 56 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [retro_notifications](tables/retro_notifications.md) | 2,443 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 3,699 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 878 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [root_cause_reports](tables/root_cause_reports.md) | 764 | ✅ | 4 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 1,173 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 18,236 | ✅ | 11 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 10,634 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 28 | ❌ | 0 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
| [session_coordination](tables/session_coordination.md) | 11 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 5,693 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
| [ship_review_findings](tables/ship_review_findings.md) | 7 | ❌ | 0 | Audit trail for /ship review gate findings. Every PR gets a record with tier, score, and finding details. |
| [shipping_decisions](tables/shipping_decisions.md) | 1,102 | ✅ | 2 | - |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 2,495 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 19,337 | ✅ | 4 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 10,249 | ✅ | 3 | - |
...
| [system_events](tables/system_events.md) | 1,666 | ✅ | 3 | Black Box audit log for all agent actions, state transitions, and resource consumption.
...
| [taste_interaction_logs](tables/taste_interaction_logs.md) | 5 | ✅ | 1 | Append-only log of every taste gate decision. Source tag distinguishes active chairman decisions from timeout auto-proceeds. |
...
| [user_stories](tables/user_stories.md) | 7,240 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 51,384 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifacts](tables/venture_artifacts.md) | 69 | ✅ | 4 | - |
...
| [venture_stage_transitions](tables/venture_stage_transitions.md) | 32 | ✅ | 1 | - |
| [venture_stage_work](tables/venture_stage_work.md) | 34 | ✅ | 5 | - |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 39 | ✅ | 4 | Golden Nugget: Token/compute investment tracking per venture |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 291 | ✅ | 1 | - |
| [workflow_checkpoints](tables/workflow_checkpoints.md) | 2 | ✅ | 2 | Stores workflow state checkpoints for recovery |
| [workflow_executions](tables/workflow_executions.md) | 2,780 | ✅ | 3 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 376,512 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

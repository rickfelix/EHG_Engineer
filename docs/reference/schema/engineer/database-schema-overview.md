...
| [agent_artifacts](tables/agent_artifacts.md) | 5,821 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 5,829 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 8,051 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [claude_sessions](tables/claude_sessions.md) | 6,416 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
| [companies](tables/companies.md) | 80 | ✅ | 6 | - |
...
| [compliance_checks](tables/compliance_checks.md) | 9 | ✅ | 2 | Stores compliance check run history for the Always-On Compliance orchestrator |
...
| [compliance_violations](tables/compliance_violations.md) | 462 | ✅ | 3 | Stores individual compliance violations detected during checks |
...
| [crewai_flows](tables/crewai_flows.md) | 4 | ✅ | 4 | Visual workflow definitions created in React Flow builder, with generated Python code |
...
| [feedback](tables/feedback.md) | 20 | ✅ | 4 | - |
...
| [governance_audit_log](tables/governance_audit_log.md) | 73,768 | ✅ | 3 | - |
| [governance_policies](tables/governance_policies.md) | 0 | ✅ | 2 | - |
| [governance_proposals](tables/governance_proposals.md) | 2 | ✅ | 2 | - |
| [handoff_audit_log](tables/handoff_audit_log.md) | 5,031 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 39 | ✅ | 4 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [learning_decisions](tables/learning_decisions.md) | 22 | ✅ | 1 | Tracks all /learn command actions, findings, and user approvals to close the feedback loop on organizational learning. |
| [learning_inbox](tables/learning_inbox.md) | 0 | ❌ | 0 | Unified view of all learnable items from various sources (patterns, feedback, retrospectives, improvements) |
| [leo_adrs](tables/leo_adrs.md) | 0 | ✅ | 2 | - |
| [leo_agents](tables/leo_agents.md) | 3 | ✅ | 3 | - |
| [leo_artifacts](tables/leo_artifacts.md) | 0 | ✅ | 2 | - |
| [leo_audit_checklists](tables/leo_audit_checklists.md) | 10 | ❌ | 0 | Artifact requirements per SD type for health audits |
| [leo_audit_config](tables/leo_audit_config.md) | 1 | ❌ | 0 | Configuration for LEO Self-Audit automated health checks |
...
| [leo_events](tables/leo_events.md) | 1 | ✅ | 1 | Append-only event log for auditability. SD: SD-LEO-SELF-IMPROVE-001B |
| [leo_feature_flag_approvals](tables/leo_feature_flag_approvals.md) | 0 | ❌ | 0 | Approval workflow tracking for feature flag state transitions |
| [leo_feature_flag_audit](tables/leo_feature_flag_audit.md) | 12 | ❌ | 0 | Immutable audit log for all feature flag changes |
| [leo_feature_flag_audit_log](tables/leo_feature_flag_audit_log.md) | 6 | ❌ | 0 | Audit trail for all feature flag operations |
| [leo_feature_flag_policies](tables/leo_feature_flag_policies.md) | 4 | ❌ | 0 | Per-environment rollout policies for feature flags |
| [leo_feature_flags](tables/leo_feature_flags.md) | 4 | ❌ | 0 | Feature flag definitions for LEO Protocol runtime control |
| [leo_feedback](tables/leo_feedback.md) | 0 | ✅ | 2 | - |
| [leo_gate_reviews](tables/leo_gate_reviews.md) | 438 | ✅ | 2 | - |
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 2,334 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_kill_switches](tables/leo_kill_switches.md) | 1 | ❌ | 0 | Emergency kill switches for instant global disablement |
| [leo_mandatory_validations](tables/leo_mandatory_validations.md) | 2 | ✅ | 2 | - |
| [leo_nfr_requirements](tables/leo_nfr_requirements.md) | 0 | ✅ | 2 | - |
| [leo_planner_rankings](tables/leo_planner_rankings.md) | 0 | ❌ | 0 | Stores Central Planner output for stability tracking and audit |
...
| [leo_proposals](tables/leo_proposals.md) | 0 | ✅ | 4 | Protocol improvement proposals with enforced lifecycle states |
...
| [leo_protocol_sections](tables/leo_protocol_sections.md) | 179 | ✅ | 4 | - |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 3 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [leo_validation_rules](tables/leo_validation_rules.md) | 62 | ✅ | 3 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 823 | ✅ | 3 | RLS: Append-only for authenticated |
...
| [product_requirements_v2](tables/product_requirements_v2.md) | 622 | ✅ | 3 | Product Requirements Documents (PRDs) for Strategic Directives. Created by PLAN agent during PLAN_PRD phase. Contains comprehensive implementation specifications: requirements, architecture, testing, risks, and acceptance criteria. One PRD per SD (1:1 relationship via sd_uuid foreign key). |
...
| [protocol_improvement_audit_log](tables/protocol_improvement_audit_log.md) | 119 | ✅ | 2 | Audit trail for all protocol improvement actions. Tracks who approved what and when changes were applied. |
| [protocol_improvement_queue](tables/protocol_improvement_queue.md) | 76 | ✅ | 5 | Queue for protocol improvements extracted from retrospectives. Enforces database-first approach by requiring target_table and payload. |
| [public_portfolio](tables/public_portfolio.md) | 2 | ✅ | 4 | - |
| [quick_fixes](tables/quick_fixes.md) | 30 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [retro_notifications](tables/retro_notifications.md) | 949 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 729 | ✅ | 2 | - |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 435 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_capabilities](tables/sd_capabilities.md) | 8 | ✅ | 2 | Junction table tracking which capabilities were registered/updated/deprecated by which Strategic Directives. Provides full audit trail. |
| [sd_checkpoint_history](tables/sd_checkpoint_history.md) | 0 | ✅ | 3 | RLS: Append-only for authenticated |
| [sd_claims](tables/sd_claims.md) | 2,179 | ✅ | 5 | Historical record of SD claims by sessions. Supports analytics and audit trail. |
...
| [sd_governance_bypass_audit](tables/sd_governance_bypass_audit.md) | 296 | ✅ | 2 | Audit trail for governance trigger bypasses.
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 4,628 | ✅ | 8 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 3,303 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_stream_requirements](tables/sd_stream_requirements.md) | 80 | ✅ | 1 | - |
...
| [sd_type_validation_profiles](tables/sd_type_validation_profiles.md) | 16 | ✅ | 4 | Configurable validation profiles for different SD types. Each type has different requirements for completion. |
...
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 2 | ❌ | 0 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
| [shipping_decisions](tables/shipping_decisions.md) | 163 | ✅ | 2 | - |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 716 | ✅ | 4 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 12,780 | ✅ | 4 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
| [sub_agent_execution_results_archive](tables/sub_agent_execution_results_archive.md) | 2,036 | ✅ | 4 | - |
| [sub_agent_executions](tables/sub_agent_executions.md) | 96 | ✅ | 2 | - |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 5,197 | ✅ | 3 | - |
...
| [task_hydration_log](tables/task_hydration_log.md) | 323 | ✅ | 1 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [test_runs](tables/test_runs.md) | 6 | ✅ | 4 | Immutable test execution records. Part of unified test evidence architecture (LEO v4.3.4) |
...
| [uat_runs](tables/uat_runs.md) | 3 | ✅ | 6 | - |
...
| [user_stories](tables/user_stories.md) | 2,312 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 30,466 | ✅ | 3 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
### Strategic Directives (47 tables)

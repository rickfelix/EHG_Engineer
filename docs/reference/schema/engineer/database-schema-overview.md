...
| [agent_artifacts](tables/agent_artifacts.md) | 3,295 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 3,304 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [claude_sessions](tables/claude_sessions.md) | 2,942 | ✅ | 2 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 58,092 | ✅ | 3 | - |
...
| [sd_claims](tables/sd_claims.md) | 1,180 | ✅ | 2 | Historical record of SD claims by sessions. Supports analytics and audit trail. |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 8,177 | ✅ | 4 | Sub-agent execution results with optimized autovacuum settings (5% threshold).
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 2,722 | ✅ | 3 | - |

...
**Generated**: 2026-06-09T12:11:32.451Z
**Tables**: 703
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 31,338 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 129,394 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 559 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 4,513 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [eva_audit_log](tables/eva_audit_log.md) | 1,864 | ✅ | 3 | EVA Audit Trail - All actions logged |
...
| [eva_interactions](tables/eva_interactions.md) | 15,014 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 3,927 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [feedback](tables/feedback.md) | 1,821 | ✅ | 8 | - |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 9,482 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 559,600 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 24,976 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [leo_feature_flag_audit](tables/leo_feature_flag_audit.md) | 442 | ✅ | 2 | Immutable audit log for all feature flag changes |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 15,108 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 1,991 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [management_reviews](tables/management_reviews.md) | 42,412 | ✅ | 2 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 50,958 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 2,170 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 39,361 | ✅ | 1 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [retro_notifications](tables/retro_notifications.md) | 3,300 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 5,540 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 8,610 | ✅ | 2 | - |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 10,992 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 1,926 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 24,134 | ✅ | 6 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 1,132 | ✅ | 1 | - |
...
| [session_coordination](tables/session_coordination.md) | 1,810 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 18,578 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 2,438 | ✅ | 2 | - |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 3,624 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 26,976 | ✅ | 2 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [task_hydration_log](tables/task_hydration_log.md) | 3,231 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [validation_audit_log](tables/validation_audit_log.md) | 59,140 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 1,300 | ✅ | 1 | - |
...
| [venture_stages_audit](tables/venture_stages_audit.md) | 205 | ✅ | 2 | SD-LEO-INFRA-UNIFY-VENTURE-STAGE-001-A: append-only audit of venture_stages column changes. Mirrors stage_config_audit. |
...
| [workflow_trace_log](tables/workflow_trace_log.md) | 594,326 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

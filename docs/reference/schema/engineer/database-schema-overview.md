...
| [agent_artifacts](tables/agent_artifacts.md) | 6,417 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 6,425 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 8,972 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 7 | ❌ | 0 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [claude_sessions](tables/claude_sessions.md) | 7,357 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [connection_selection_log](tables/connection_selection_log.md) | 30 | ❌ | 0 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 77,038 | ✅ | 3 | - |
| [governance_policies](tables/governance_policies.md) | 0 | ✅ | 2 | - |
| [governance_proposals](tables/governance_proposals.md) | 2 | ✅ | 2 | - |
| [handoff_audit_log](tables/handoff_audit_log.md) | 5,726 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 78 | ✅ | 4 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [learning_decisions](tables/learning_decisions.md) | 44 | ✅ | 1 | Tracks all /learn command actions, findings, and user approvals to close the feedback loop on organizational learning. |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 2,652 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_planner_rankings](tables/leo_planner_rankings.md) | 3 | ✅ | 2 | Stores Central Planner output for stability tracking and audit |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 9 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [model_usage_log](tables/model_usage_log.md) | 970 | ✅ | 3 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 58 | ❌ | 0 | - |
...
| [product_requirements_v2](tables/product_requirements_v2.md) | 681 | ✅ | 3 | Product Requirements Documents (PRDs) for Strategic Directives. Created by PLAN agent during PLAN_PRD phase. Contains comprehensive implementation specifications: requirements, architecture, testing, risks, and acceptance criteria. One PRD per SD (1:1 relationship via sd_uuid foreign key). |
...
| [retro_notifications](tables/retro_notifications.md) | 1,025 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 806 | ✅ | 2 | - |
...
| [root_cause_reports](tables/root_cause_reports.md) | 21 | ✅ | 4 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 539 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_claims](tables/sd_claims.md) | 2,307 | ✅ | 5 | Historical record of SD claims by sessions. Supports analytics and audit trail. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 49 | ❌ | 0 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 5,295 | ✅ | 8 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 3,713 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 872 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
| [shipping_decisions](tables/shipping_decisions.md) | 251 | ✅ | 2 | - |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 818 | ✅ | 4 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 13,713 | ✅ | 4 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
| [sub_agent_execution_results_archive](tables/sub_agent_execution_results_archive.md) | 2,036 | ✅ | 4 | - |
| [sub_agent_executions](tables/sub_agent_executions.md) | 100 | ✅ | 2 | - |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 5,780 | ✅ | 3 | - |
...
| [task_hydration_log](tables/task_hydration_log.md) | 455 | ✅ | 1 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 2,526 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 30,595 | ✅ | 3 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
| [validation_evidence](tables/validation_evidence.md) | 0 | ✅ | 2 | - |
| [validation_gate_registry](tables/validation_gate_registry.md) | 18 | ✅ | 2 | Database-first policy for validation gate applicability per SD type and validation profile. Part of SD-LEO-INFRA-VALIDATION-GATE-REGISTRY-001. |

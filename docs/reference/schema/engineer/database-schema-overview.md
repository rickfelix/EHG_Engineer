...
**Generated**: 2026-06-30T14:13:41.887Z
**Tables**: 753
...
| [adam_adherence_ledger](tables/adam_adherence_ledger.md) | 304 | ✅ | 2 | Durable ledger of Adam recurring self-adherence audit runs/findings (SD-LEO-INFRA-AUTOMATED-RECURRING-ADAM-001). One row per probe per run; remediation_ref set when a fail sourced a propose-only remediation. |
...
| [agent_artifacts](tables/agent_artifacts.md) | 19,812 | ✅ | 2 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 19,892 | ✅ | 2 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 37,118 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 189,135 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [brand_genome_submissions](tables/brand_genome_submissions.md) | 16 | ✅ | 5 | Brand identity genome for ventures ensuring marketing consistency |
| [brand_variants](tables/brand_variants.md) | 0 | ✅ | 2 | - |
| [build_completion_forecast_log](tables/build_completion_forecast_log.md) | 197 | ✅ | 2 | SD-LEO-INFRA-BUILD-COMPLETION-FORECAST-001 FR-2/FR-3: append-only forecast runs + assumptions + prior-vs-actual error, for audit + self-correction. Dormant-safe: forecaster fail-soft dry-runs when absent. |
...
| [cascade_invalidation_flags](tables/cascade_invalidation_flags.md) | 25 | ✅ | 2 | - |
| [cascade_invalidation_log](tables/cascade_invalidation_log.md) | 420 | ✅ | 2 | - |
...
| [chairman_decision_audit](tables/chairman_decision_audit.md) | 30 | ✅ | 1 | - |
| [chairman_decisions](tables/chairman_decisions.md) | 171 | ✅ | 2 | SD-HARDENING-V1-001: Chairman-only decision records.
...
| [claude_sessions](tables/claude_sessions.md) | 12,837 | ✅ | 3 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 1,044 | ✅ | 2 | - |
| [codebase_semantic_index](tables/codebase_semantic_index.md) | 0 | ✅ | 2 | - |
| [companies](tables/companies.md) | 1,311 | ✅ | 5 | - |
...
| [competitors](tables/competitors.md) | 42 | ✅ | 5 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 7,075 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [convergence_ledger_runs](tables/convergence_ledger_runs.md) | 0 | ✅ | 2 | Convergence-walk run ledger (SD-LEO-INFRA-CONVERGENCE-LEDGER-001): one row per S19->S26 walk run. The SSOT the convergence circuit-breakers + dashboards read. |
...
| [coordination_events](tables/coordination_events.md) | 134 | ✅ | 3 | epic #4 (SD-LEO-INFRA-COORDINATION-OBSERVABILITY-ANOMALY-001): structured fleet-coordination anomaly events from the read-only detectors; written only when COORD_DETECTORS_V2 is enabled. |
...
| [customer_personas](tables/customer_personas.md) | 226 | ✅ | 2 | Canonical customer persona catalog. Personas can be venture-specific (source_venture_id) or global (canonical_id IS NULL). |
...
| [design_quality_scores](tables/design_quality_scores.md) | 948 | ✅ | 1 | Aggregated per-SD design quality scores from design-agent results. Composite formula: 35% accessibility + 25% token compliance + 20% component reuse + 20% visual polish. |
...
| [eva_architecture_plans](tables/eva_architecture_plans.md) | 235 | ✅ | 2 | Architecture Plans linked to Vision documents. ON DELETE RESTRICT on vision_id prevents deleting a vision that has architecture plans. |
...
| [eva_interactions](tables/eva_interactions.md) | 18,465 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_scheduler_queue](tables/eva_scheduler_queue.md) | 22 | ✅ | 2 | - |
...
| [eva_stage_gate_results](tables/eva_stage_gate_results.md) | 1,458 | ✅ | 2 | Tracks EVA gate evaluations with kill gate enforcement (stages 3,5,13,23 require 70% score) |
...
| [eva_venture_config](tables/eva_venture_config.md) | 5 | ✅ | 1 | Per-venture EVA feature flag and config overrides. Modeled on db_agent_config. Use key='<scope>.<flag_name>' (e.g. 'vision_repair_loop_enabled') with value as JSONB boolean or object. For per-venture scoping, use composite keys like 'venture:<uuid>:vision_repair_loop_enabled'. |
| [eva_ventures](tables/eva_ventures.md) | 22 | ✅ | 2 | EVA Operating System - Venture tracking with health metrics |
| [eva_ventures_qparity20260610](tables/eva_ventures_qparity20260610.md) | 3 | ❌ | 0 | - |
| [eva_vision_documents](tables/eva_vision_documents.md) | 283 | ✅ | 2 | Stores EHG portfolio (L1) and venture-specific (L2) vision documents for the EVA Vision Governance System. L2 visions link to L1 via parent_vision_id. |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 4,950 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [factory_guardrail_state](tables/factory_guardrail_state.md) | 9 | ✅ | 1 | CRO guardrail state per venture for Software Factory self-healing loop |
...
| [feedback](tables/feedback.md) | 4,688 | ✅ | 8 | - |
...
| [financial_models](tables/financial_models.md) | 14 | ✅ | 3 | Venture capital financial models with templates (SaaS, marketplace, etc.) |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 27,127 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 471,302 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 30,534 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [leo_adrs](tables/leo_adrs.md) | 693 | ✅ | 2 | - |
...
| [leo_feature_flag_audit](tables/leo_feature_flag_audit.md) | 3,450 | ✅ | 2 | Immutable audit log for all feature flag changes |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 18,723 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_lint_run_history](tables/leo_lint_run_history.md) | 124 | ✅ | 1 | Append-only log of every linter run. trigger=bypass rows track --skip-lint invocations for rate-limiting (3/week) and chairman dashboard reporting. SD-PROTOCOL-LINTER-001. |
...
| [leo_planner_rankings](tables/leo_planner_rankings.md) | 59 | ✅ | 2 | Stores Central Planner output for stability tracking and audit |
...
| [leo_protocol_sections](tables/leo_protocol_sections.md) | 271 | ✅ | 4 | - |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 3,349 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [mental_model_applications](tables/mental_model_applications.md) | 855 | ✅ | 2 | Tracks which models were applied to which ventures at which stages |
...
| [model_usage_log](tables/model_usage_log.md) | 53,543 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [naming_suggestions](tables/naming_suggestions.md) | 73 | ✅ | 2 | - |
...
| [operator_cash_burn_monthly](tables/operator_cash_burn_monthly.md) | 1 | ✅ | 2 | - |
...
| [outcome_signals](tables/outcome_signals.md) | 2,753 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 45,964 | ✅ | 1 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [plan_critiques](tables/plan_critiques.md) | 191 | ✅ | 2 | Pre-PLAN adversarial critique results from devils-advocate.js critiquePlanProposal(). Phase 1: advisory only — never blocks handoffs. |
...
| [quick_fixes](tables/quick_fixes.md) | 553 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [retro_notifications](tables/retro_notifications.md) | 3,893 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 6,725 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 10,135 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 2,366 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [risk_recalibration_forms](tables/risk_recalibration_forms.md) | 14 | ✅ | 2 | SD-LIFECYCLE-GAP-005: Risk re-calibration forms at phase boundary gates (Gates 3, 4, 5, 6) |
...
| [root_cause_reports](tables/root_cause_reports.md) | 1,177 | ✅ | 2 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_backlog_map](tables/sd_backlog_map.md) | 162 | ✅ | 2 | - |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 21,368 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 2,502 | ✅ | 1 | - |
...
| [sd_governance_bypass_audit](tables/sd_governance_bypass_audit.md) | 865 | ✅ | 2 | Audit trail for governance trigger bypasses.
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 29,687 | ✅ | 6 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 18,529 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 1,306 | ✅ | 1 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 1,962 | ✅ | 1 | - |
...
| [session_coordination](tables/session_coordination.md) | 9,742 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 36,642 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 3,597 | ✅ | 2 | - |
...
| [srip_brand_interviews](tables/srip_brand_interviews.md) | 14 | ✅ | 4 | SRIP: Stores 12-question brand interview answers per venture. Some answers may be auto-populated from site DNA extraction. |
...
| [srip_site_dna](tables/srip_site_dna.md) | 17 | ✅ | 4 | SRIP: Stores extracted design DNA (tokens, layout, components) from reference site URLs for venture site replication. |
...
| [stage_artifact_requirements](tables/stage_artifact_requirements.md) | 43 | ✅ | 1 | DEPRECATED (SD-LEO-INFRA-STAGE-CONTRACT-REGISTRY-001, 2026-06-10): superseded by venture_stages.required_artifacts (SSOT). Retained ONLY as the fn_advance_venture_stage legacy-fallback path. Do not hand-edit; content is a derived mirror of venture_stages and parity is enforced by the LEGACY_PARITY check in scripts/validate-stage-contract-connectivity.mjs. DROP candidate via the quarantine recipe in a follow-up SD. |
...
| [stage_executions](tables/stage_executions.md) | 3,037 | ✅ | 1 | Per-execution tracking for stage-execution-worker. Each row is one processStage() attempt with heartbeat for crash detection. |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 4,663 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 33,393 | ✅ | 2 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 19,125 | ✅ | 3 | - |
...
| [system_events](tables/system_events.md) | 14,794 | ✅ | 3 | Black Box audit log for all agent actions, state transitions, and resource consumption.
...
| [task_hydration_log](tables/task_hydration_log.md) | 5,432 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 12,494 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 13,574 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifact_summaries](tables/venture_artifact_summaries.md) | 268 | ✅ | 1 | Cached LLM-generated summaries of venture artifacts. Used by enrichment pipeline Pass 1 to avoid redundant LLM calls. |
| [venture_artifact_summaries_qparity20260610](tables/venture_artifact_summaries_qparity20260610.md) | 0 | ❌ | 0 | - |
| [venture_artifacts](tables/venture_artifacts.md) | 692 | ✅ | 4 | - |
...
| [venture_briefs](tables/venture_briefs.md) | 12 | ✅ | 1 | Stage 0 output contract - structured brief produced by the synthesis engine that becomes Stage 1 input |
...
| [venture_financial_contract](tables/venture_financial_contract.md) | 14 | ✅ | 2 | - |
...
| [venture_gvos_profile](tables/venture_gvos_profile.md) | 12 | ✅ | 4 | GVOS Composer Layer 3: per-venture archetype selection + locked_prompt_snapshot + lovable_artifact. Chairman-owned via canonical RLS helpers. SD-GVOS-COMPOSER-SNAPSHOTLOCKED-REGISTRY-ORCH-001 FR-1. |
...
| [venture_persona_mapping](tables/venture_persona_mapping.md) | 42 | ✅ | 4 | Maps customer personas to ventures with a relevance score (0.00-1.00). |
...
| [venture_provisioning_state](tables/venture_provisioning_state.md) | 10 | ✅ | 2 | Tracks venture provisioning lifecycle: repo creation, registry entry, schema setup, CI/CD config, and conformance checks. Referenced by the Stage 18 post-approval hook and create-ehg-venture --register. |
...
| [venture_resources](tables/venture_resources.md) | 27 | ✅ | 2 | Unified registry of external resources per venture (SD-LEO-INFRA-UNIFIED-VENTURE-CREATION-001-B) |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 4,002 | ✅ | 1 | - |
...
| [venture_stage_transitions](tables/venture_stage_transitions.md) | 253 | ✅ | 1 | - |
| [venture_stage_transitions_qparity20260610](tables/venture_stage_transitions_qparity20260610.md) | 4 | ❌ | 0 | - |
| [venture_stage_work](tables/venture_stage_work.md) | 270 | ✅ | 5 | - |
...
| [venture_stages_audit](tables/venture_stages_audit.md) | 2,863 | ✅ | 2 | SD-LEO-INFRA-UNIFY-VENTURE-STAGE-001-A: append-only audit of venture_stages column changes. Mirrors stage_config_audit. |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 3,410 | ✅ | 2 | Golden Nugget: Token/compute investment tracking per venture |
| [venture_tool_quotas](tables/venture_tool_quotas.md) | 0 | ✅ | 1 | - |
| [ventures](tables/ventures.md) | 22 | ✅ | 2 | - |
...
| [vision_scoring_audit_log](tables/vision_scoring_audit_log.md) | 755 | ✅ | 1 | Audit trail for vision scoring gate evaluations with dynamic threshold context. SD-CONTEXTAWARE-VISION-SCORING-DYNAMIC-ORCH-001-A |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 1,165 | ✅ | 1 | - |
| [worker_spawn_requests](tables/worker_spawn_requests.md) | 26 | ✅ | 1 | - |
| [workflow_checkpoints](tables/workflow_checkpoints.md) | 2 | ✅ | 2 | Stores workflow state checkpoints for recovery |
| [workflow_executions](tables/workflow_executions.md) | 7,199 | ✅ | 2 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 583,084 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

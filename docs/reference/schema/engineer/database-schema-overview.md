...
**Generated**: 2026-06-20T20:34:46.107Z
**Tables**: 748
...
| [adam_adherence_ledger](tables/adam_adherence_ledger.md) | 72 | ✅ | 2 | Durable ledger of Adam recurring self-adherence audit runs/findings (SD-LEO-INFRA-AUTOMATED-RECURRING-ADAM-001). One row per probe per run; remediation_ref set when a fail sourced a propose-only remediation. |
...
| [agent_artifacts](tables/agent_artifacts.md) | 18,136 | ✅ | 2 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 18,216 | ✅ | 2 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 34,418 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 166,695 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [bypass_ledger](tables/bypass_ledger.md) | 1 | ✅ | 1 | Sibling A (SD-WRITERCONSUMER-...-001-A) — insert-only ledger of every bypass event with audit_log pairing. RLS denies UPDATE/DELETE. TEXT bypass_type + advisory trigger (NOT ENUM) for future vocab additions. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 810 | ✅ | 2 | - |
| [codebase_semantic_index](tables/codebase_semantic_index.md) | 0 | ✅ | 2 | - |
| [companies](tables/companies.md) | 1,306 | ✅ | 5 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 5,939 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [coordination_events](tables/coordination_events.md) | 67 | ✅ | 3 | epic #4 (SD-LEO-INFRA-COORDINATION-OBSERVABILITY-ANOMALY-001): structured fleet-coordination anomaly events from the read-only detectors; written only when COORD_DETECTORS_V2 is enabled. |
...
| [design_quality_scores](tables/design_quality_scores.md) | 700 | ✅ | 1 | Aggregated per-SD design quality scores from design-agent results. Composite formula: 35% accessibility + 25% token compliance + 20% component reuse + 20% visual polish. |
...
| [eva_interactions](tables/eva_interactions.md) | 16,785 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_scheduler_metrics](tables/eva_scheduler_metrics.md) | 112,148 | ✅ | 2 | - |
| [eva_scheduler_metrics_qparity20260610](tables/eva_scheduler_metrics_qparity20260610.md) | 995 | ❌ | 0 | - |
| [eva_scheduler_queue](tables/eva_scheduler_queue.md) | 9 | ✅ | 2 | - |
...
| [eva_ventures](tables/eva_ventures.md) | 9 | ✅ | 2 | EVA Operating System - Venture tracking with health metrics |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 4,486 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [feedback](tables/feedback.md) | 3,329 | ✅ | 8 | - |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 20,899 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 374,493 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 28,841 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 1,412 | ✅ | 2 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [leo_feature_flag_audit](tables/leo_feature_flag_audit.md) | 2,116 | ✅ | 2 | Immutable audit log for all feature flag changes |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 16,917 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_lint_run_history](tables/leo_lint_run_history.md) | 101 | ✅ | 1 | Append-only log of every linter run. trigger=bypass rows track --skip-lint invocations for rate-limiting (3/week) and chairman dashboard reporting. SD-PROTOCOL-LINTER-001. |
...
| [leo_protocol_sections](tables/leo_protocol_sections.md) | 268 | ✅ | 4 | - |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 2,748 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [model_usage_log](tables/model_usage_log.md) | 54,568 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 2,460 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 44,149 | ✅ | 1 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [retro_notifications](tables/retro_notifications.md) | 3,600 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 6,121 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 9,389 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 2,068 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [roadmap_wave_items](tables/roadmap_wave_items.md) | 728 | ✅ | 2 | Links classified EVA intake items to roadmap waves. Tracks promotion to SDs. |
...
| [root_cause_reports](tables/root_cause_reports.md) | 1,161 | ✅ | 2 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 15,842 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 2,215 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 27,999 | ✅ | 6 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 16,874 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 992 | ✅ | 1 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 1,593 | ✅ | 1 | - |
...
| [session_coordination](tables/session_coordination.md) | 4,603 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 29,632 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 3,014 | ✅ | 2 | - |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 4,007 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 30,609 | ✅ | 2 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 17,451 | ✅ | 3 | - |
...
| [task_hydration_log](tables/task_hydration_log.md) | 4,266 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 11,569 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 21,343 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 2,806 | ✅ | 1 | - |
...
| [venture_stages_audit](tables/venture_stages_audit.md) | 1,676 | ✅ | 2 | SD-LEO-INFRA-UNIFY-VENTURE-STAGE-001-A: append-only audit of venture_stages column changes. Mirrors stage_config_audit. |
...
| [ventures](tables/ventures.md) | 9 | ✅ | 2 | - |
...
| [vision_scoring_audit_log](tables/vision_scoring_audit_log.md) | 700 | ✅ | 1 | Audit trail for vision scoring gate evaluations with dynamic threshold context. SD-CONTEXTAWARE-VISION-SCORING-DYNAMIC-ORCH-001-A |
...
| [workflow_trace_log](tables/workflow_trace_log.md) | 559,092 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

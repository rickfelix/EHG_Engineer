...
**Generated**: 2026-05-07T13:20:10.215Z
**Tables**: 662
...
| [audit_log](tables/audit_log.md) | 21,413 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 87 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 1,692 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [eva_audit_log](tables/eva_audit_log.md) | 274 | ✅ | 3 | EVA Audit Trail - All actions logged |
...
| [eva_interactions](tables/eva_interactions.md) | 12,630 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [feedback](tables/feedback.md) | 881 | ✅ | 8 | - |
...
| [governance_audit_log](tables/governance_audit_log.md) | 227,900 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 22,858 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 1,135 | ✅ | 5 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 12,789 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 673 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [management_reviews](tables/management_reviews.md) | 5,960 | ✅ | 2 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 34,295 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 1,763 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 15,294 | ❌ | 0 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [retro_notifications](tables/retro_notifications.md) | 2,889 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 4,757 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 1,348 | ✅ | 2 | - |
...
| [root_cause_reports](tables/root_cause_reports.md) | 1,015 | ✅ | 4 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 1,538 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 22,016 | ✅ | 11 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 1,736 | ✅ | 2 | - |
...
| [validation_audit_log](tables/validation_audit_log.md) | 56,475 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 190 | ✅ | 3 | - |
...
| [workflow_trace_log](tables/workflow_trace_log.md) | 504,841 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

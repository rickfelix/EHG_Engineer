...
| [agent_artifacts](tables/agent_artifacts.md) | 6,937 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 6,966 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 9,914 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 28 | ❌ | 0 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [claude_sessions](tables/claude_sessions.md) | 7,866 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [connection_selection_log](tables/connection_selection_log.md) | 604 | ❌ | 0 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 79,825 | ✅ | 3 | - |
| [governance_policies](tables/governance_policies.md) | 0 | ✅ | 2 | - |
| [governance_proposals](tables/governance_proposals.md) | 2 | ✅ | 2 | - |
| [handoff_audit_log](tables/handoff_audit_log.md) | 6,129 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 112 | ✅ | 4 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [learning_decisions](tables/learning_decisions.md) | 57 | ✅ | 1 | Tracks all /learn command actions, findings, and user approvals to close the feedback loop on organizational learning. |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 2,944 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 241 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [model_usage_log](tables/model_usage_log.md) | 1,006 | ✅ | 3 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 124 | ❌ | 0 | - |
...
| [product_requirements_v2](tables/product_requirements_v2.md) | 750 | ✅ | 3 | Product Requirements Documents (PRDs) for Strategic Directives. Created by PLAN agent during PLAN_PRD phase. Contains comprehensive implementation specifications: requirements, architecture, testing, risks, and acceptance criteria. One PRD per SD (1:1 relationship via sd_uuid foreign key). |
...
| [retro_notifications](tables/retro_notifications.md) | 1,094 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 870 | ✅ | 2 | - |
...
| [root_cause_reports](tables/root_cause_reports.md) | 53 | ✅ | 4 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 587 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_claims](tables/sd_claims.md) | 2,420 | ✅ | 5 | Historical record of SD claims by sessions. Supports analytics and audit trail. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 106 | ❌ | 0 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 5,608 | ✅ | 8 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 4,085 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 1,418 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
| [shipping_decisions](tables/shipping_decisions.md) | 349 | ✅ | 2 | - |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 866 | ✅ | 4 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 14,547 | ✅ | 4 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 6,306 | ✅ | 3 | - |
...
| [task_hydration_log](tables/task_hydration_log.md) | 528 | ✅ | 1 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 2,730 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 30,772 | ✅ | 3 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [workflow_trace_log](tables/workflow_trace_log.md) | 2,916 | ✅ | 1 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

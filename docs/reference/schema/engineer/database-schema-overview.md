...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 23,302 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 2,247 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [chairman_decision_audit](tables/chairman_decision_audit.md) | 1 | ❌ | 0 | - |
...
| [customer_personas](tables/customer_personas.md) | 33 | ✅ | 2 | Canonical customer persona catalog. Personas can be venture-specific (source_venture_id) or global (canonical_id IS NULL). |
...
| [eva_interactions](tables/eva_interactions.md) | 9,321 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [governance_audit_log](tables/governance_audit_log.md) | 160,186 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 19,459 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [leo_adrs](tables/leo_adrs.md) | 217 | ✅ | 2 | - |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 10,525 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [mental_model_applications](tables/mental_model_applications.md) | 205 | ✅ | 4 | Tracks which models were applied to which ventures at which stages |
...
| [model_usage_log](tables/model_usage_log.md) | 13,535 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 1,367 | ✅ | 1 | - |
...
| [plan_critiques](tables/plan_critiques.md) | 30 | ✅ | 2 | Pre-PLAN adversarial critique results from devils-advocate.js critiquePlanProposal(). Phase 1: advisory only — never blocks handoffs. |
...
| [retro_notifications](tables/retro_notifications.md) | 2,479 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 3,787 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 83 | ✅ | 2 | - |
...
| [root_cause_reports](tables/root_cause_reports.md) | 783 | ✅ | 4 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 1,194 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 18,626 | ✅ | 11 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 10,839 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [shipping_decisions](tables/shipping_decisions.md) | 1,141 | ✅ | 2 | - |
...
| [system_events](tables/system_events.md) | 1,707 | ✅ | 3 | Black Box audit log for all agent actions, state transitions, and resource consumption.
...
| [user_stories](tables/user_stories.md) | 7,348 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 51,807 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifacts](tables/venture_artifacts.md) | 33 | ✅ | 4 | - |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 324 | ✅ | 1 | - |
...
| [workflow_trace_log](tables/workflow_trace_log.md) | 388,388 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

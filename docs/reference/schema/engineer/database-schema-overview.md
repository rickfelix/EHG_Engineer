...
**Generated**: 2026-06-16T17:46:47.615Z
**Tables**: 747
...
| [adam_adherence_ledger](tables/adam_adherence_ledger.md) | 44 | ✅ | 2 | Durable ledger of Adam recurring self-adherence audit runs/findings (SD-LEO-INFRA-AUTOMATED-RECURRING-ADAM-001). One row per probe per run; remediation_ref set when a fail sourced a propose-only remediation. |
...
| [agent_artifacts](tables/agent_artifacts.md) | 17,720 | ✅ | 2 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 17,800 | ✅ | 2 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 33,808 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 161,579 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [brainstorm_sessions](tables/brainstorm_sessions.md) | 2,567 | ✅ | 2 | Tracks brainstorming sessions across domains (venture, protocol, integration, architecture) with outcome classification, quality metrics, and capability matching. Used for question effectiveness analysis and retrospective integration. |
...
| [bypass_ledger](tables/bypass_ledger.md) | 0 | ✅ | 1 | Sibling A (SD-WRITERCONSUMER-...-001-A) — insert-only ledger of every bypass event with audit_log pairing. RLS denies UPDATE/DELETE. TEXT bypass_type + advisory trigger (NOT ENUM) for future vocab additions. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 751 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 5,683 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [conversion_ledger](tables/conversion_ledger.md) | 561 | ✅ | 2 | Unified intake conversion ledger (SD-LEO-INFRA-UNIFY-INTAKE-POOLS-001). Normalizes 3 pools; backlog = disposition IS NULL; source rows never deleted. |
| [coordination_events](tables/coordination_events.md) | 46 | ✅ | 3 | epic #4 (SD-LEO-INFRA-COORDINATION-OBSERVABILITY-ANOMALY-001): structured fleet-coordination anomaly events from the read-only detectors; written only when COORD_DETECTORS_V2 is enabled. |
...
| [design_quality_scores](tables/design_quality_scores.md) | 638 | ✅ | 1 | Aggregated per-SD design quality scores from design-agent results. Composite formula: 35% accessibility + 25% token compliance + 20% component reuse + 20% visual polish. |
...
| [eva_event_log](tables/eva_event_log.md) | 19 | ✅ | 2 | - |
...
| [eva_interactions](tables/eva_interactions.md) | 16,404 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_scheduler_metrics](tables/eva_scheduler_metrics.md) | 65,558 | ✅ | 2 | - |
...
| [eva_todoist_intake](tables/eva_todoist_intake.md) | 305 | ✅ | 2 | - |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 4,329 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [eva_youtube_intake](tables/eva_youtube_intake.md) | 236 | ✅ | 2 | - |
| [eva_youtube_scans](tables/eva_youtube_scans.md) | 66 | ✅ | 1 | Daily scan metadata for EVA YouTube Subscription Digest - tracks each automated scan run |
| [eva_youtube_scores](tables/eva_youtube_scores.md) | 3,034 | ✅ | 1 | Per-video relevance scores from EVA scoring of YouTube subscription content |
...
| [feedback](tables/feedback.md) | 3,062 | ✅ | 8 | - |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 19,419 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 633,754 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 28,463 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 1,391 | ✅ | 2 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [leo_feature_flag_audit](tables/leo_feature_flag_audit.md) | 1,837 | ✅ | 2 | Immutable audit log for all feature flag changes |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 16,517 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 2,616 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [model_usage_log](tables/model_usage_log.md) | 53,283 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 2,395 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 43,649 | ✅ | 1 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [plan_critiques](tables/plan_critiques.md) | 184 | ✅ | 2 | Pre-PLAN adversarial critique results from devils-advocate.js critiquePlanProposal(). Phase 1: advisory only — never blocks handoffs. |
...
| [pocock_oos_findings](tables/pocock_oos_findings.md) | 17,391 | ✅ | 2 | - |
...
| [retro_notifications](tables/retro_notifications.md) | 3,535 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 5,992 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 9,195 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 1,996 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [roadmap_wave_items](tables/roadmap_wave_items.md) | 462 | ✅ | 2 | Links classified EVA intake items to roadmap waves. Tracks promotion to SDs. |
...
| [root_cause_reports](tables/root_cause_reports.md) | 1,153 | ✅ | 2 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_backlog_map](tables/sd_backlog_map.md) | 153 | ✅ | 2 | - |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 14,623 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 2,151 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 27,621 | ✅ | 6 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 16,519 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 920 | ✅ | 1 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 1,497 | ✅ | 1 | - |
...
| [session_coordination](tables/session_coordination.md) | 3,963 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 28,158 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 2,885 | ✅ | 2 | - |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 3,934 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 29,900 | ✅ | 2 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 17,037 | ✅ | 3 | - |
...
| [task_hydration_log](tables/task_hydration_log.md) | 4,014 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 11,364 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 20,952 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 2,544 | ✅ | 1 | - |
...
| [venture_stage_work](tables/venture_stage_work.md) | 94 | ✅ | 5 | - |
...
| [venture_stages_audit](tables/venture_stages_audit.md) | 1,416 | ✅ | 2 | SD-LEO-INFRA-UNIFY-VENTURE-STAGE-001-A: append-only audit of venture_stages column changes. Mirrors stage_config_audit. |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 3,236 | ✅ | 2 | Golden Nugget: Token/compute investment tracking per venture |
...
| [vision_scoring_audit_log](tables/vision_scoring_audit_log.md) | 682 | ✅ | 1 | Audit trail for vision scoring gate evaluations with dynamic threshold context. SD-CONTEXTAWARE-VISION-SCORING-DYNAMIC-ORCH-001-A |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 1,056 | ✅ | 1 | - |
...
| [workflow_executions](tables/workflow_executions.md) | 6,847 | ✅ | 2 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 544,832 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

...
**Generated**: 2026-05-16T15:08:51.232Z
**Tables**: 695
...
| [audit_log](tables/audit_log.md) | 52,275 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 200 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 2,546 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [eva_audit_log](tables/eva_audit_log.md) | 190 | ✅ | 3 | EVA Audit Trail - All actions logged |
...
| [governance_audit_log](tables/governance_audit_log.md) | 319,296 | ✅ | 2 | - |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 1,018 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [management_reviews](tables/management_reviews.md) | 16,960 | ✅ | 2 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 25,180 | ❌ | 0 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [retrospectives](tables/retrospectives.md) | 5,242 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 1,941 | ✅ | 2 | - |
...
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 8,946 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 110 | ✅ | 3 | - |

...
| [evaluation_profile_outcomes](tables/evaluation_profile_outcomes.md) | 27 | ✅ | 2 | Per-gate survival signals linking evaluation profile+version to venture outcomes at tracked boundaries |
...
| [governance_audit_log](tables/governance_audit_log.md) | 137,354 | ✅ | 3 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 2,271 | ✅ | 3 | RLS: Append-only for authenticated |
...
| [stage_events](tables/stage_events.md) | 7 | ✅ | 4 | - |
...
| [validation_audit_log](tables/validation_audit_log.md) | 41,313 | ✅ | 3 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 1,153 | ✅ | 4 | Golden Nugget: Token/compute investment tracking per venture |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 32 | ✅ | 1 | - |
| [workflow_checkpoints](tables/workflow_checkpoints.md) | 2 | ✅ | 2 | Stores workflow state checkpoints for recovery |
| [workflow_executions](tables/workflow_executions.md) | 666 | ✅ | 3 | - |

...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 32,353 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [app_config_kill_switch_changes](tables/app_config_kill_switch_changes.md) | 0 | ❌ | 0 | - |
...
| [audit_log](tables/audit_log.md) | 150,164 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [cascade_invalidation_flags](tables/cascade_invalidation_flags.md) | 22 | ✅ | 2 | - |
| [cascade_invalidation_log](tables/cascade_invalidation_log.md) | 54 | ✅ | 2 | - |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 617 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 5,065 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [coordination_events](tables/coordination_events.md) | 13 | ❌ | 0 | epic #4 (SD-LEO-INFRA-COORDINATION-OBSERVABILITY-ANOMALY-001): structured fleet-coordination anomaly events from the read-only detectors; written only when COORD_DETECTORS_V2 is enabled. |
...
| [design_quality_scores](tables/design_quality_scores.md) | 516 | ✅ | 1 | Aggregated per-SD design quality scores from design-agent results. Composite formula: 35% accessibility + 25% token compliance + 20% component reuse + 20% visual polish. |
...
| [eva_interactions](tables/eva_interactions.md) | 15,585 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_scheduler_metrics](tables/eva_scheduler_metrics.md) | 11,200 | ✅ | 2 | - |
...
| [eva_stage_gate_results](tables/eva_stage_gate_results.md) | 1,100 | ✅ | 2 | Tracks EVA gate evaluations with kill gate enforcement (stages 3,5,13,23 require 70% score) |
...
| [feedback](tables/feedback.md) | 2,257 | ✅ | 8 | - |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 13,534 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 581,992 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 25,478 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 1,352 | ✅ | 2 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [leo_feature_flag_audit](tables/leo_feature_flag_audit.md) | 1,129 | ✅ | 2 | Immutable audit log for all feature flag changes |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 15,669 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 2,292 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [model_usage_log](tables/model_usage_log.md) | 50,848 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 2,266 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 42,442 | ✅ | 1 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [quick_fixes](tables/quick_fixes.md) | 517 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [retention_archive](tables/retention_archive.md) | 196,007 | ❌ | 0 | Cold JSONB archive for rows aged out of unbounded audit/trace tables. Restore = re-insert row_data (filter by source_table/run_id). Writer: scripts/retention-enforce.js (archive-before-delete invariant). SD-LEO-INFRA-RETENTION-POLICY-UNBOUNDED-001. |
| [retention_runs](tables/retention_runs.md) | 9 | ❌ | 0 | Age-keyed liveness stamps for retention enforcement: alarm on AGE of max(ran_at), never on self-reported status. One row per run incl. dry runs. SD-LEO-INFRA-RETENTION-POLICY-UNBOUNDED-001. |
| [retro_notifications](tables/retro_notifications.md) | 3,396 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 5,723 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 8,830 | ✅ | 2 | - |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 11,617 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 2,019 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 24,636 | ✅ | 6 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 785 | ✅ | 1 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 1,270 | ✅ | 1 | - |
...
| [session_coordination](tables/session_coordination.md) | 2,595 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 24,125 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 2,625 | ✅ | 2 | - |
...
| [stage_executions](tables/stage_executions.md) | 2,818 | ✅ | 1 | Per-execution tracking for stage-execution-worker. Each row is one processStage() attempt with heartbeat for crash detection. |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 3,758 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 28,061 | ✅ | 2 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [task_hydration_log](tables/task_hydration_log.md) | 3,555 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [validation_audit_log](tables/validation_audit_log.md) | 20,078 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifacts](tables/venture_artifacts.md) | 277 | ✅ | 4 | - |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 1,898 | ✅ | 1 | - |
...
| [venture_stage_transitions](tables/venture_stage_transitions.md) | 76 | ✅ | 1 | - |
| [venture_stage_transitions_qparity20260610](tables/venture_stage_transitions_qparity20260610.md) | 4 | ❌ | 0 | - |
| [venture_stage_work](tables/venture_stage_work.md) | 90 | ✅ | 5 | - |
...
| [venture_stages_audit](tables/venture_stages_audit.md) | 783 | ✅ | 2 | SD-LEO-INFRA-UNIFY-VENTURE-STAGE-001-A: append-only audit of venture_stages column changes. Mirrors stage_config_audit. |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 1,040 | ✅ | 1 | - |
...
| [workflow_executions](tables/workflow_executions.md) | 6,792 | ✅ | 2 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 515,012 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

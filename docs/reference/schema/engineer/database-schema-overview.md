...
| [audit_log](tables/audit_log.md) | 78,034 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [brainstorm_sessions](tables/brainstorm_sessions.md) | 1,716 | ✅ | 2 | Tracks brainstorming sessions across domains (venture, protocol, integration, architecture) with outcome classification, quality metrics, and capability matching. Used for question effectiveness analysis and retrospective integration. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 313 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 3,226 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [eva_audit_log](tables/eva_audit_log.md) | 592 | ✅ | 3 | EVA Audit Trail - All actions logged |
...
| [eva_interactions](tables/eva_interactions.md) | 13,610 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 5,550 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 397,123 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 23,752 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 13,639 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 1,335 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [management_reviews](tables/management_reviews.md) | 25,549 | ✅ | 2 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 39,339 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [permission_audit_log](tables/permission_audit_log.md) | 30,506 | ❌ | 0 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [retrospectives](tables/retrospectives.md) | 6,162 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 2,908 | ✅ | 2 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 22,910 | ✅ | 11 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 11,788 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 3,285 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 23,840 | ✅ | 4 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [task_hydration_log](tables/task_hydration_log.md) | 2,388 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [validation_audit_log](tables/validation_audit_log.md) | 57,652 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 596 | ✅ | 3 | - |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 122 | ✅ | 4 | Golden Nugget: Token/compute investment tracking per venture |
...
| [workflow_executions](tables/workflow_executions.md) | 3,168 | ✅ | 3 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 541,533 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

...
**Generated**: 2026-05-17T00:57:34.213Z
**Tables**: 695
...
| [agent_artifacts](tables/agent_artifacts.md) | 13,343 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 13,410 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 27,026 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 52,635 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [brainstorm_sessions](tables/brainstorm_sessions.md) | 1,061 | ✅ | 2 | Tracks brainstorming sessions across domains (venture, protocol, integration, architecture) with outcome classification, quality metrics, and capability matching. Used for question effectiveness analysis and retrospective integration. |
...
| [chairman_decisions](tables/chairman_decisions.md) | 15 | ✅ | 2 | SD-HARDENING-V1-001: Chairman-only decision records.
...
| [claude_sessions](tables/claude_sessions.md) | 12,402 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 204 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 2,556 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [customer_personas](tables/customer_personas.md) | 177 | ✅ | 2 | Canonical customer persona catalog. Personas can be venture-specific (source_venture_id) or global (canonical_id IS NULL). |
...
| [eva_architecture_plans](tables/eva_architecture_plans.md) | 224 | ✅ | 2 | Architecture Plans linked to Vision documents. ON DELETE RESTRICT on vision_id prevents deleting a vision that has architecture plans. |
...
| [eva_audit_log](tables/eva_audit_log.md) | 198 | ✅ | 3 | EVA Audit Trail - All actions logged |
...
| [eva_consultant_recommendations](tables/eva_consultant_recommendations.md) | 263 | ✅ | 2 | Actionable recommendations generated by EVA trend analysis for chairman review |
...
| [eva_interactions](tables/eva_interactions.md) | 13,168 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_stage_gate_results](tables/eva_stage_gate_results.md) | 822 | ✅ | 2 | Tracks EVA gate evaluations with kill gate enforcement (stages 3,5,13,23 require 70% score) |
...
| [eva_translation_gates](tables/eva_translation_gates.md) | 804 | ✅ | 3 | Translation fidelity gate results for the EVA pipeline. Each gate checks upstream artifacts against downstream artifacts to detect translation gaps. |
...
| [eva_vision_documents](tables/eva_vision_documents.md) | 256 | ✅ | 2 | Stores EHG portfolio (L1) and venture-specific (L2) vision documents for the EVA Vision Governance System. L2 visions link to L1 via parent_vision_id. |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 3,577 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [eva_youtube_scans](tables/eva_youtube_scans.md) | 36 | ✅ | 3 | Daily scan metadata for EVA YouTube Subscription Digest - tracks each automated scan run |
| [eva_youtube_scores](tables/eva_youtube_scores.md) | 1,660 | ✅ | 3 | Per-video relevance scores from EVA scoring of YouTube subscription content |
| [evaluation_profile_outcomes](tables/evaluation_profile_outcomes.md) | 115 | ✅ | 2 | Per-gate survival signals linking evaluation profile+version to venture outcomes at tracked boundaries |
...
| [feedback](tables/feedback.md) | 1,079 | ✅ | 8 | - |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 4,592 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 320,323 | ✅ | 2 | - |
...
| [gvos_prompt_rubrics](tables/gvos_prompt_rubrics.md) | 2 | ✅ | 2 | Versioned + immutable scoring rubric for the GVOS prompt-quality scorer. Mirrors leo_scoring_rubrics_immutable pattern. SD-GVOS-S17-PROMPT-QUALITY-ORCH-001 / FR-2. Versioned-correction-via-new-row: never UPDATE an existing row — INSERT a new (version, active=TRUE) row and toggle prior active=FALSE via the canonical procedure deactivate_prior_rubric() defined below. |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 23,355 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 1,212 | ✅ | 5 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [leo_adrs](tables/leo_adrs.md) | 574 | ✅ | 2 | - |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 13,231 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_planner_rankings](tables/leo_planner_rankings.md) | 48 | ✅ | 2 | Stores Central Planner output for stability tracking and audit |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 1,022 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [management_reviews](tables/management_reviews.md) | 17,085 | ✅ | 2 | - |
...
| [mental_model_applications](tables/mental_model_applications.md) | 710 | ✅ | 4 | Tracks which models were applied to which ventures at which stages |
...
| [model_usage_log](tables/model_usage_log.md) | 36,589 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [operations_audit_log](tables/operations_audit_log.md) | 66 | ✅ | 2 | - |
...
| [outcome_signals](tables/outcome_signals.md) | 1,838 | ✅ | 1 | - |
...
| [pattern_subagent_mapping](tables/pattern_subagent_mapping.md) | 703 | ✅ | 3 | RLS: Service role write, authenticated read |
...
| [permission_audit_log](tables/permission_audit_log.md) | 25,262 | ❌ | 0 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [plan_critiques](tables/plan_critiques.md) | 174 | ✅ | 2 | Pre-PLAN adversarial critique results from devils-advocate.js critiquePlanProposal(). Phase 1: advisory only — never blocks handoffs. |
...
| [pocock_glossary_terms](tables/pocock_glossary_terms.md) | 10 | ✅ | 2 | - |
| [pocock_oos_findings](tables/pocock_oos_findings.md) | 2,973 | ✅ | 2 | - |
...
| [quick_fixes](tables/quick_fixes.md) | 274 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [rd_batch_runs](tables/rd_batch_runs.md) | 8 | ✅ | 2 | - |
...
| [retro_notifications](tables/retro_notifications.md) | 2,966 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 5,246 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 1,945 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 1,280 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [root_cause_reports](tables/root_cause_reports.md) | 1,066 | ✅ | 4 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_backlog_map](tables/sd_backlog_map.md) | 35 | ✅ | 2 | - |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 1,611 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 22,513 | ✅ | 11 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 13,391 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 392 | ❌ | 0 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 376 | ❌ | 0 | - |
...
| [session_coordination](tables/session_coordination.md) | 307 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 8,982 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 1,862 | ✅ | 2 | - |
...
| [stage_executions](tables/stage_executions.md) | 60 | ✅ | 1 | Per-execution tracking for stage-execution-worker. Each row is one processStage() attempt with heartbeat for crash detection. |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 3,189 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 23,048 | ✅ | 4 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 12,688 | ✅ | 3 | - |
...
| [system_events](tables/system_events.md) | 2,218 | ✅ | 3 | Black Box audit log for all agent actions, state transitions, and resource consumption.
...
| [task_hydration_log](tables/task_hydration_log.md) | 2,163 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [telemetry_analysis_runs](tables/telemetry_analysis_runs.md) | 16 | ✅ | 2 | Tracks lifecycle of telemetry auto-analysis runs (QUEUED->RUNNING->SUCCEEDED/FAILED/TIMED_OUT) |
...
| [user_stories](tables/user_stories.md) | 8,910 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 57,142 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifacts](tables/venture_artifacts.md) | 97 | ✅ | 4 | - |
...
| [venture_briefs](tables/venture_briefs.md) | 7 | ✅ | 1 | Stage 0 output contract - structured brief produced by the synthesis engine that becomes Stage 1 input |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 118 | ✅ | 3 | - |
...
| [venture_stage_transitions](tables/venture_stage_transitions.md) | 27 | ✅ | 1 | - |
| [venture_stage_work](tables/venture_stage_work.md) | 41 | ✅ | 5 | - |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 98 | ✅ | 4 | Golden Nugget: Token/compute investment tracking per venture |
...
| [vision_scoring_audit_log](tables/vision_scoring_audit_log.md) | 484 | ❌ | 0 | Audit trail for vision scoring gate evaluations with dynamic threshold context. SD-CONTEXTAWARE-VISION-SCORING-DYNAMIC-ORCH-001-A |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 852 | ✅ | 1 | - |
...
| [workflow_executions](tables/workflow_executions.md) | 3,053 | ✅ | 3 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 524,510 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

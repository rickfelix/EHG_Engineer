...
**Generated**: 2026-05-28T11:43:43.275Z
**Tables**: 700
...
| [agent_artifacts](tables/agent_artifacts.md) | 14,012 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 14,091 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 28,380 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 83,922 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [claude_sessions](tables/claude_sessions.md) | 12,562 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 334 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 3,376 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [eva_audit_log](tables/eva_audit_log.md) | 744 | ✅ | 3 | EVA Audit Trail - All actions logged |
...
| [eva_consultant_recommendations](tables/eva_consultant_recommendations.md) | 392 | ✅ | 2 | Actionable recommendations generated by EVA trend analysis for chairman review |
...
| [eva_interactions](tables/eva_interactions.md) | 13,723 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_scheduler_queue](tables/eva_scheduler_queue.md) | 17 | ✅ | 2 | - |
...
| [eva_ventures](tables/eva_ventures.md) | 17 | ✅ | 2 | EVA Operating System - Venture tracking with health metrics |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 3,680 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [eva_youtube_scans](tables/eva_youtube_scans.md) | 46 | ✅ | 3 | Daily scan metadata for EVA YouTube Subscription Digest - tracks each automated scan run |
| [eva_youtube_scores](tables/eva_youtube_scores.md) | 2,052 | ✅ | 3 | Per-video relevance scores from EVA scoring of YouTube subscription content |
...
| [feedback](tables/feedback.md) | 1,293 | ✅ | 8 | - |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 5,738 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 415,190 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 23,853 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 1,252 | ✅ | 5 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [leo_error_log](tables/leo_error_log.md) | 256 | ✅ | 2 | LEO Protocol error log for critical failures that need operator attention. Part of SD-GENESIS-V32-PULSE resilience infrastructure. |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 13,740 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_planner_rankings](tables/leo_planner_rankings.md) | 52 | ✅ | 2 | Stores Central Planner output for stability tracking and audit |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 1,412 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [leo_wiring_validations](tables/leo_wiring_validations.md) | 31 | ✅ | 1 | Persistent store of LEO Wiring Verification Framework detector outputs. Mirrors eva_vision_documents.quality_checked pattern — detector writes, trigger derives strategic_directives_v2.wiring_validated, handoff gate queries derived column. SD: SD-LEO-WIRING-VERIFICATION-FRAMEWORK-ORCH-001-D. |
...
| [management_reviews](tables/management_reviews.md) | 27,456 | ✅ | 2 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 39,694 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [operations_audit_log](tables/operations_audit_log.md) | 70 | ✅ | 2 | - |
...
| [outcome_signals](tables/outcome_signals.md) | 1,926 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 31,448 | ❌ | 0 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [pocock_glossary_terms](tables/pocock_glossary_terms.md) | 20 | ✅ | 2 | - |
| [pocock_oos_findings](tables/pocock_oos_findings.md) | 4,517 | ✅ | 2 | - |
...
| [quick_fixes](tables/quick_fixes.md) | 398 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [retro_notifications](tables/retro_notifications.md) | 3,054 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 6,425 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 3,195 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 1,415 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [root_cause_reports](tables/root_cause_reports.md) | 1,105 | ✅ | 4 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 1,693 | ✅ | 1 | - |
...
| [sd_governance_bypass_audit](tables/sd_governance_bypass_audit.md) | 753 | ✅ | 2 | Audit trail for governance trigger bypasses.
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 23,011 | ✅ | 11 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 13,927 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 474 | ❌ | 0 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 612 | ❌ | 0 | - |
...
| [session_coordination](tables/session_coordination.md) | 422 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 12,515 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
| [ship_review_findings](tables/ship_review_findings.md) | 52 | ❌ | 0 | Audit trail for /ship review gate findings. Every PR gets a record with tier, score, and finding details. |
| [shipping_decisions](tables/shipping_decisions.md) | 2,008 | ✅ | 2 | - |
...
| [stage_config_audit](tables/stage_config_audit.md) | 19 | ✅ | 2 | Append-only audit trail for stage_config mutations. SD-LEO-INFRA-UNIFIED-GATE-ENFORCEMENT-001 |
| [stage_data_contracts](tables/stage_data_contracts.md) | 2 | ✅ | 2 | - |
| [stage_events](tables/stage_events.md) | 14 | ✅ | 2 | - |
| [stage_executions](tables/stage_executions.md) | 97 | ✅ | 1 | Per-execution tracking for stage-execution-worker. Each row is one processStage() attempt with heartbeat for crash detection. |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 3,308 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 24,091 | ✅ | 4 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 13,358 | ✅ | 3 | - |
...
| [system_events](tables/system_events.md) | 2,273 | ✅ | 3 | Black Box audit log for all agent actions, state transitions, and resource consumption.
...
| [task_hydration_log](tables/task_hydration_log.md) | 2,454 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 9,323 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 57,780 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifacts](tables/venture_artifacts.md) | 233 | ✅ | 4 | - |
...
| [venture_briefs](tables/venture_briefs.md) | 11 | ✅ | 1 | Stage 0 output contract - structured brief produced by the synthesis engine that becomes Stage 1 input |
...
| [venture_stage_transitions](tables/venture_stage_transitions.md) | 67 | ✅ | 1 | - |
| [venture_stage_work](tables/venture_stage_work.md) | 98 | ✅ | 5 | - |
...
| [ventures](tables/ventures.md) | 16 | ✅ | 2 | - |
| [ventures_kill_log](tables/ventures_kill_log.md) | 0 | ✅ | 1 | - |
...
| [vision_scoring_audit_log](tables/vision_scoring_audit_log.md) | 548 | ❌ | 0 | Audit trail for vision scoring gate evaluations with dynamic threshold context. SD-CONTEXTAWARE-VISION-SCORING-DYNAMIC-ORCH-001-A |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 963 | ✅ | 1 | - |
| [worker_spawn_requests](tables/worker_spawn_requests.md) | 0 | ✅ | 1 | - |
| [workflow_checkpoints](tables/workflow_checkpoints.md) | 2 | ✅ | 2 | Stores workflow state checkpoints for recovery |
| [workflow_executions](tables/workflow_executions.md) | 3,175 | ✅ | 3 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 545,820 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |
...
**security_audit_events_2026_05**:
- `venture_id` → `ventures.id`

**security_audit_events_2026_06**:
- `venture_id` → `ventures.id`

**security_audit_events_2026_07**:
- `venture_id` → `ventures.id`
...
**security_audit_events_2026_10**:
- `venture_id` → `ventures.id`

**security_audit_events_2026_11**:
- `venture_id` → `ventures.id`

**security_audit_events_2026_12**:
- `venture_id` → `ventures.id`

**security_audit_events_2027_01**:
- `venture_id` → `ventures.id`

**security_audit_events_2027_02**:
- `venture_id` → `ventures.id`

**security_audit_events_2027_03**:
- `venture_id` → `ventures.id`

**security_audit_events_2027_04**:
- `venture_id` → `ventures.id`

**security_audit_events_2027_05**:
- `venture_id` → `ventures.id`

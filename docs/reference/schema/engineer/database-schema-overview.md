...
| [claude_sessions](tables/claude_sessions.md) | 11,028 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [eva_stage_gate_results](tables/eva_stage_gate_results.md) | 212 | ✅ | 2 | Tracks EVA gate evaluations with kill gate enforcement (stages 3,5,13,23 require 70% score) |
...
| [model_usage_log](tables/model_usage_log.md) | 5,127 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 5,055 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [stage_executions](tables/stage_executions.md) | 706 | ✅ | 1 | Per-execution tracking for stage-execution-worker. Each row is one processStage() attempt with heartbeat for crash detection. |
...
| [validation_audit_log](tables/validation_audit_log.md) | 47,661 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifacts](tables/venture_artifacts.md) | 792 | ✅ | 4 | - |
...
| [venture_stage_transitions](tables/venture_stage_transitions.md) | 123 | ✅ | 1 | - |
| [venture_stage_work](tables/venture_stage_work.md) | 102 | ✅ | 5 | - |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 2,294 | ✅ | 4 | Golden Nugget: Token/compute investment tracking per venture |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 120 | ✅ | 1 | - |
| [workflow_checkpoints](tables/workflow_checkpoints.md) | 2 | ✅ | 2 | Stores workflow state checkpoints for recovery |
| [workflow_executions](tables/workflow_executions.md) | 1,617 | ✅ | 3 | - |

...
**Generated**: 2025-12-31T03:36:12.835Z
**Tables**: 302
...
| [agent_artifacts](tables/agent_artifacts.md) | 2,012 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 2,021 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 4,570 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [claude_sessions](tables/claude_sessions.md) | 2,186 | ✅ | 2 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 53,970 | ✅ | 3 | - |
| [governance_policies](tables/governance_policies.md) | 0 | ✅ | 2 | - |
| [governance_proposals](tables/governance_proposals.md) | 2 | ✅ | 2 | - |
| [handoff_audit_log](tables/handoff_audit_log.md) | 1,970 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 922 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [model_usage_log](tables/model_usage_log.md) | 462 | ✅ | 2 | - |
...
| [product_requirements_v2](tables/product_requirements_v2.md) | 259 | ✅ | 3 | Product Requirements Documents (PRDs) for Strategic Directives. Created by PLAN agent during PLAN_PRD phase. Contains comprehensive implementation specifications: requirements, architecture, testing, risks, and acceptance criteria. One PRD per SD (1:1 relationship via sd_uuid foreign key). |
...
| [retro_notifications](tables/retro_notifications.md) | 545 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 266 | ✅ | 2 | - |
...
| [scaffold_patterns](tables/scaffold_patterns.md) | 0 | ❌ | 0 | Pattern library for AI-driven code generation in Genesis simulations |
...
| [sd_claims](tables/sd_claims.md) | 848 | ✅ | 2 | Historical record of SD claims by sessions. Supports analytics and audit trail. |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 1,603 | ✅ | 8 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 1,155 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_type_change_audit](tables/sd_type_change_audit.md) | 1 | ❌ | 0 | Audit log for SD type changes with risk assessment. Part of SD-LEO-COMPLETION-GATES-001 governance enhancement. |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 287 | ✅ | 4 | RLS enabled: service_role full access, authenticated read-only |
| [sub_agent_execution_batches](tables/sub_agent_execution_batches.md) | 2 | ✅ | 2 | - |
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 5,751 | ✅ | 4 | Sub-agent execution results with optimized autovacuum settings (5% threshold).
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 1,466 | ✅ | 3 | - |
...
| [user_stories](tables/user_stories.md) | 909 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |

...
| [advisory_checkpoints](tables/advisory_checkpoints.md) | 3 | ✅ | 2 | - |
...
| [agent_artifacts](tables/agent_artifacts.md) | 14,532 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 14,610 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 29,236 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 98,256 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [backup_leo_feature_flag_audit](tables/backup_leo_feature_flag_audit.md) | 12 | ✅ | 1 | - |
| [backup_leo_feature_flag_audit_log](tables/backup_leo_feature_flag_audit_log.md) | 6 | ✅ | 1 | - |
| [backup_leo_sub_agent_handoffs](tables/backup_leo_sub_agent_handoffs.md) | 1 | ✅ | 1 | - |
| [backup_leo_subagent_handoffs](tables/backup_leo_subagent_handoffs.md) | 1 | ✅ | 1 | - |
...
| [brainstorm_sessions](tables/brainstorm_sessions.md) | 1,751 | ✅ | 2 | Tracks brainstorming sessions across domains (venture, protocol, integration, architecture) with outcome classification, quality metrics, and capability matching. Used for question effectiveness analysis and retrospective integration. |
...
| [brand_variants](tables/brand_variants.md) | 0 | ✅ | 4 | - |
...
| [chairman_decisions](tables/chairman_decisions.md) | 96 | ✅ | 2 | SD-HARDENING-V1-001: Chairman-only decision records.
...
| [chairman_feedback](tables/chairman_feedback.md) | 0 | ✅ | 2 | - |
...
| [claude_sessions](tables/claude_sessions.md) | 12,615 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [client_error_events](tables/client_error_events.md) | 0 | ✅ | 3 | Append-only browser-error telemetry. Anon-INSERT allowed (errors fire pre-auth); chairman_user_id-scoped SELECT for authenticated users. Owner: SD-PRIVACYPATROL-AI-LEO-ORCH-SPRINT-SPRINT-2026-001-F1. |
| [codebase_health_config](tables/codebase_health_config.md) | 6 | ✅ | 2 | - |
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 407 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 3,735 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [cultural_design_styles](tables/cultural_design_styles.md) | 4 | ✅ | 3 | - |
...
| [debate_arguments](tables/debate_arguments.md) | 715 | ✅ | 2 | - |
| [debate_circuit_breaker](tables/debate_circuit_breaker.md) | 0 | ✅ | 2 | - |
| [debate_sessions](tables/debate_sessions.md) | 86 | ✅ | 3 | - |
...
| [design_quality_scores](tables/design_quality_scores.md) | 441 | ✅ | 3 | Aggregated per-SD design quality scores from design-agent results. Composite formula: 35% accessibility + 25% token compliance + 20% component reuse + 20% visual polish. |
...
| [eva_architecture_plans](tables/eva_architecture_plans.md) | 232 | ✅ | 2 | Architecture Plans linked to Vision documents. ON DELETE RESTRICT on vision_id prevents deleting a vision that has architecture plans. |
...
| [eva_audit_log](tables/eva_audit_log.md) | 1,080 | ✅ | 3 | EVA Audit Trail - All actions logged |
...
| [eva_consultant_recommendations](tables/eva_consultant_recommendations.md) | 443 | ✅ | 2 | Actionable recommendations generated by EVA trend analysis for chairman review |
...
| [eva_friday_meeting_agenda](tables/eva_friday_meeting_agenda.md) | 0 | ✅ | 3 | - |
...
| [eva_interactions](tables/eva_interactions.md) | 14,071 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_scheduler_queue](tables/eva_scheduler_queue.md) | 57 | ✅ | 2 | - |
...
| [eva_stage_gate_results](tables/eva_stage_gate_results.md) | 1,396 | ✅ | 2 | Tracks EVA gate evaluations with kill gate enforcement (stages 3,5,13,23 require 70% score) |
...
| [eva_ventures](tables/eva_ventures.md) | 57 | ✅ | 2 | EVA Operating System - Venture tracking with health metrics |
| [eva_vision_documents](tables/eva_vision_documents.md) | 272 | ✅ | 2 | Stores EHG portfolio (L1) and venture-specific (L2) vision documents for the EVA Vision Governance System. L2 visions link to L1 via parent_vision_id. |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 3,733 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
| [eva_weekly_review_templates](tables/eva_weekly_review_templates.md) | 2 | ✅ | 1 | Templates for automated weekly review generation |
| [eva_youtube_config](tables/eva_youtube_config.md) | 59 | ✅ | 4 | YouTube channel subscriptions and per-channel scoring configuration for EVA digest |
| [eva_youtube_intake](tables/eva_youtube_intake.md) | 137 | ✅ | 2 | - |
| [eva_youtube_scans](tables/eva_youtube_scans.md) | 52 | ✅ | 3 | Daily scan metadata for EVA YouTube Subscription Digest - tracks each automated scan run |
| [eva_youtube_scores](tables/eva_youtube_scores.md) | 2,276 | ✅ | 3 | Per-video relevance scores from EVA scoring of YouTube subscription content |
...
| [feedback](tables/feedback.md) | 1,396 | ✅ | 8 | - |
...
| [financial_models](tables/financial_models.md) | 4 | ✅ | 4 | Venture capital financial models with templates (SaaS, marketplace, etc.) |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 6,691 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [genesis_deployments](tables/genesis_deployments.md) | 0 | ✅ | 5 | Tracks Vercel preview deployments for Genesis simulation sessions. Part of the Virtual Bunker deployment pipeline. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 460,019 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 24,146 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 1,259 | ✅ | 5 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
| [judge_verdicts](tables/judge_verdicts.md) | 60 | ✅ | 3 | - |
...
| [leo_error_log](tables/leo_error_log.md) | 258 | ✅ | 2 | LEO Protocol error log for critical failures that need operator attention. Part of SD-GENESIS-V32-PULSE resilience infrastructure. |
...
| [leo_feedback](tables/leo_feedback.md) | 1 | ✅ | 2 | - |
| [leo_gate_reviews](tables/leo_gate_reviews.md) | 438 | ✅ | 2 | - |
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 14,137 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_lint_run_history](tables/leo_lint_run_history.md) | 41 | ✅ | 1 | Append-only log of every linter run. trigger=bypass rows track --skip-lint invocations for rate-limiting (3/week) and chairman dashboard reporting. SD-PROTOCOL-LINTER-001. |
...
| [leo_planner_rankings](tables/leo_planner_rankings.md) | 53 | ✅ | 2 | Stores Central Planner output for stability tracking and audit |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 1,595 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [management_reviews](tables/management_reviews.md) | 32,149 | ✅ | 2 | - |
...
| [mental_model_applications](tables/mental_model_applications.md) | 770 | ✅ | 4 | Tracks which models were applied to which ventures at which stages |
...
| [model_usage_log](tables/model_usage_log.md) | 44,020 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [orchestration_metrics](tables/orchestration_metrics.md) | 0 | ✅ | 2 | Performance analytics for EVA orchestration - tracks efficiency, quality, and resource utilization |
| [outcome_signals](tables/outcome_signals.md) | 1,999 | ✅ | 1 | - |
| [pattern_improvements](tables/pattern_improvements.md) | 0 | ✅ | 4 | - |
...
| [pcvp_verification_log](tables/pcvp_verification_log.md) | 0 | ✅ | 2 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 33,921 | ✅ | 1 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [portfolios](tables/portfolios.md) | 8 | ✅ | 5 | - |
| [postmortem_pattern_links](tables/postmortem_pattern_links.md) | 0 | ✅ | 3 | - |
...
| [quick_fixes](tables/quick_fixes.md) | 438 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [retro_notifications](tables/retro_notifications.md) | 3,127 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 7,119 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 3,930 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 1,514 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [root_cause_reports](tables/root_cause_reports.md) | 1,116 | ✅ | 4 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_baseline_issues](tables/sd_baseline_issues.md) | 12 | ✅ | 4 | Tracks pre-existing codebase issues that should not block unrelated SD completion. Part of LEO Protocol governance. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 1,762 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 23,304 | ✅ | 11 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 14,347 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 531 | ✅ | 1 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 768 | ✅ | 1 | - |
...
| [session_coordination](tables/session_coordination.md) | 522 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 14,267 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 2,126 | ✅ | 2 | - |
...
| [stage_executions](tables/stage_executions.md) | 1,291 | ✅ | 1 | Per-execution tracking for stage-execution-worker. Each row is one processStage() attempt with heartbeat for crash detection. |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 3,402 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 24,887 | ✅ | 4 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 13,866 | ✅ | 3 | - |
...
| [substage_transition_log](tables/substage_transition_log.md) | 0 | ✅ | 4 | Audit trail of all Stage 13 substage transitions. SD-STAGE-13-001. |
...
| [system_events](tables/system_events.md) | 4,180 | ✅ | 3 | Black Box audit log for all agent actions, state transitions, and resource consumption.
...
| [task_hydration_log](tables/task_hydration_log.md) | 2,694 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [tech_stack_references](tables/tech_stack_references.md) | 0 | ✅ | 6 | Cache for Context7 MCP and retrospective research results with 24-hour TTL |
...
| [test_results](tables/test_results.md) | 52 | ✅ | 4 | Individual test outcomes linked to test_runs |
| [test_runs](tables/test_runs.md) | 14 | ✅ | 4 | Immutable test execution records. Part of unified test evidence architecture (LEO v4.3.4) |
...
| [user_stories](tables/user_stories.md) | 9,689 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 58,144 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifacts](tables/venture_artifacts.md) | 1,513 | ✅ | 4 | - |
| [venture_asset_registry](tables/venture_asset_registry.md) | 0 | ✅ | 3 | Tracks assets owned by each venture for acquisition readiness assessment |
...
| [venture_briefs](tables/venture_briefs.md) | 54 | ✅ | 1 | Stage 0 output contract - structured brief produced by the synthesis engine that becomes Stage 1 input |
...
| [venture_decisions](tables/venture_decisions.md) | 0 | ✅ | 2 | Gate decisions for ventures - created for chairman_unified_decisions VIEW |
...
| [venture_postmortems](tables/venture_postmortems.md) | 0 | ✅ | 4 | - |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 708 | ✅ | 3 | - |
...
| [venture_stage_transitions](tables/venture_stage_transitions.md) | 172 | ✅ | 1 | - |
| [venture_stage_work](tables/venture_stage_work.md) | 257 | ✅ | 5 | - |
...
| [venture_stages_audit](tables/venture_stages_audit.md) | 87 | ✅ | 2 | SD-LEO-INFRA-UNIFY-VENTURE-STAGE-001-A: append-only audit of venture_stages column changes. Mirrors stage_config_audit. |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 1,338 | ✅ | 4 | Golden Nugget: Token/compute investment tracking per venture |
| [venture_tool_quotas](tables/venture_tool_quotas.md) | 0 | ✅ | 1 | - |
| [ventures](tables/ventures.md) | 56 | ✅ | 2 | - |
...
| [vision_scoring_audit_log](tables/vision_scoring_audit_log.md) | 567 | ✅ | 1 | Audit trail for vision scoring gate evaluations with dynamic threshold context. SD-CONTEXTAWARE-VISION-SCORING-DYNAMIC-ORCH-001-A |
| [voice_cached_responses](tables/voice_cached_responses.md) | 0 | ✅ | 4 | - |
| [voice_conversations](tables/voice_conversations.md) | 0 | ✅ | 4 | - |
| [voice_function_calls](tables/voice_function_calls.md) | 0 | ✅ | 3 | - |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 995 | ✅ | 1 | - |
...
| [workflow_executions](tables/workflow_executions.md) | 4,567 | ✅ | 3 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 558,064 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

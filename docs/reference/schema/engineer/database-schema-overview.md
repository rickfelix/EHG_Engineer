...
| [adam_adherence_ledger](tables/adam_adherence_ledger.md) | 180 | ✅ | 2 | Durable ledger of Adam recurring self-adherence audit runs/findings (SD-LEO-INFRA-AUTOMATED-RECURRING-ADAM-001). One row per probe per run; remediation_ref set when a fail sourced a propose-only remediation. |
...
| [agent_artifacts](tables/agent_artifacts.md) | 19,107 | ✅ | 2 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 19,187 | ✅ | 2 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 36,029 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 179,917 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [build_completion_forecast_log](tables/build_completion_forecast_log.md) | 90 | ✅ | 2 | SD-LEO-INFRA-BUILD-COMPLETION-FORECAST-001 FR-2/FR-3: append-only forecast runs + assumptions + prior-vs-actual error, for audit + self-correction. Dormant-safe: forecaster fail-soft dry-runs when absent. |
...
| [cascade_invalidation_log](tables/cascade_invalidation_log.md) | 70 | ✅ | 2 | - |
...
| [chairman_decisions](tables/chairman_decisions.md) | 62 | ✅ | 2 | SD-HARDENING-V1-001: Chairman-only decision records.
...
| [claude_sessions](tables/claude_sessions.md) | 12,826 | ✅ | 3 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 939 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 6,609 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [coordination_events](tables/coordination_events.md) | 105 | ✅ | 3 | epic #4 (SD-LEO-INFRA-COORDINATION-OBSERVABILITY-ANOMALY-001): structured fleet-coordination anomaly events from the read-only detectors; written only when COORD_DETECTORS_V2 is enabled. |
...
| [design_quality_scores](tables/design_quality_scores.md) | 845 | ✅ | 1 | Aggregated per-SD design quality scores from design-agent results. Composite formula: 35% accessibility + 25% token compliance + 20% component reuse + 20% visual polish. |
...
| [eva_event_log](tables/eva_event_log.md) | 29 | ✅ | 2 | - |
...
| [eva_interactions](tables/eva_interactions.md) | 17,841 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_stage_gate_results](tables/eva_stage_gate_results.md) | 1,128 | ✅ | 2 | Tracks EVA gate evaluations with kill gate enforcement (stages 3,5,13,23 require 70% score) |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 4,785 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [eva_youtube_scans](tables/eva_youtube_scans.md) | 75 | ✅ | 1 | Daily scan metadata for EVA YouTube Subscription Digest - tracks each automated scan run |
| [eva_youtube_scores](tables/eva_youtube_scores.md) | 3,437 | ✅ | 1 | Per-video relevance scores from EVA scoring of YouTube subscription content |
...
| [feedback](tables/feedback.md) | 4,192 | ✅ | 8 | - |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 26,521 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
| [fleet_worker_pulse](tables/fleet_worker_pulse.md) | 8 | ✅ | 0 | 15-min active-vs-not fleet-worker samples; chairman exec email averages the last hour. SD: chairman exec-email redesign 2026-06-14. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 433,245 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 29,912 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [leo_adrs](tables/leo_adrs.md) | 623 | ✅ | 2 | - |
...
| [leo_feature_flag_audit](tables/leo_feature_flag_audit.md) | 2,874 | ✅ | 2 | Immutable audit log for all feature flag changes |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 18,046 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_lint_run_history](tables/leo_lint_run_history.md) | 121 | ✅ | 1 | Append-only log of every linter run. trigger=bypass rows track --skip-lint invocations for rate-limiting (3/week) and chairman dashboard reporting. SD-PROTOCOL-LINTER-001. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 3,106 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [model_usage_log](tables/model_usage_log.md) | 55,076 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 2,642 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 45,360 | ✅ | 1 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [pocock_glossary_terms](tables/pocock_glossary_terms.md) | 50 | ✅ | 2 | - |
| [pocock_oos_findings](tables/pocock_oos_findings.md) | 22,919 | ✅ | 2 | - |
...
| [quick_fixes](tables/quick_fixes.md) | 543 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [retro_notifications](tables/retro_notifications.md) | 3,782 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 6,499 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 9,861 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 2,246 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 19,179 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 2,393 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 29,065 | ✅ | 6 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 17,875 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 1,190 | ✅ | 1 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 1,827 | ✅ | 1 | - |
...
| [session_coordination](tables/session_coordination.md) | 6,910 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 33,868 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 3,378 | ✅ | 2 | - |
...
| [stage_events](tables/stage_events.md) | 28 | ✅ | 2 | - |
| [stage_executions](tables/stage_executions.md) | 2,847 | ✅ | 1 | Per-execution tracking for stage-execution-worker. Each row is one processStage() attempt with heartbeat for crash detection. |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 4,412 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 32,286 | ✅ | 2 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 18,427 | ✅ | 3 | - |
...
| [task_hydration_log](tables/task_hydration_log.md) | 4,984 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 12,108 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 14,778 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifacts](tables/venture_artifacts.md) | 301 | ✅ | 4 | - |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 3,513 | ✅ | 1 | - |
...
| [venture_stage_transitions](tables/venture_stage_transitions.md) | 90 | ✅ | 1 | - |
| [venture_stage_transitions_qparity20260610](tables/venture_stage_transitions_qparity20260610.md) | 4 | ❌ | 0 | - |
| [venture_stage_work](tables/venture_stage_work.md) | 107 | ✅ | 5 | - |
...
| [venture_stages_audit](tables/venture_stages_audit.md) | 2,380 | ✅ | 2 | SD-LEO-INFRA-UNIFY-VENTURE-STAGE-001-A: append-only audit of venture_stages column changes. Mirrors stage_config_audit. |
| [venture_telemetry](tables/venture_telemetry.md) | 7 | ✅ | 2 | - |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 3,248 | ✅ | 2 | Golden Nugget: Token/compute investment tracking per venture |
...
| [vision_scoring_audit_log](tables/vision_scoring_audit_log.md) | 745 | ✅ | 1 | Audit trail for vision scoring gate evaluations with dynamic threshold context. SD-CONTEXTAWARE-VISION-SCORING-DYNAMIC-ORCH-001-A |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 1,065 | ✅ | 1 | - |
...
| [workflow_executions](tables/workflow_executions.md) | 6,890 | ✅ | 2 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 579,449 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

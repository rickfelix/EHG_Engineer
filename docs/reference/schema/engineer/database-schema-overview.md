...
**Generated**: 2026-07-02T01:52:38.389Z
**Tables**: 755
...
| [adam_task_ledger](tables/adam_task_ledger.md) | 72 | ✅ | 2 | Durable HIERARCHICAL task board for Adam project-management discipline (SD-LEO-INFRA-UPSCALE-ADAM-PROJECT-MANAGEMENT-DISCIPLINE-001-A / Child A). One task TREE via parent_id (self-FK): chairman-visible PARENT nodes + Adam-operational CHILD subtasks, with status + blocker rollup child->parent. Survives compaction/role-handoff; rehydrated idempotently from live sources via UNIQUE(source_kind, source_ref). |
...
| [agent_artifacts](tables/agent_artifacts.md) | 20,190 | ✅ | 2 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 20,270 | ✅ | 2 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 37,683 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 196,236 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [build_completion_forecast_log](tables/build_completion_forecast_log.md) | 236 | ✅ | 2 | SD-LEO-INFRA-BUILD-COMPLETION-FORECAST-001 FR-2/FR-3: append-only forecast runs + assumptions + prior-vs-actual error, for audit + self-correction. Dormant-safe: forecaster fail-soft dry-runs when absent. |
| [bypass_ledger](tables/bypass_ledger.md) | 16 | ✅ | 1 | Sibling A (SD-WRITERCONSUMER-...-001-A) — insert-only ledger of every bypass event with audit_log pairing. RLS denies UPDATE/DELETE. TEXT bypass_type + advisory trigger (NOT ENUM) for future vocab additions. |
| [campaign_content](tables/campaign_content.md) | 0 | ✅ | 2 | - |
| [campaign_enrollments](tables/campaign_enrollments.md) | 0 | ✅ | 2 | Email drip campaign enrollment + delivery state per (venture, lead, campaign). Replaces stub returns in lib/marketing/ai/email-campaigns.js shipped by SD-LEO-INFRA-PHANTOM-TABLE-REFERENCE-001-C. Added by SD-EHG-MARKETING-DISTRIBUTION-INFRASTRUCTURE-ORCH-001-A. |
...
| [cascade_invalidation_log](tables/cascade_invalidation_log.md) | 801 | ✅ | 2 | - |
...
| [claude_sessions](tables/claude_sessions.md) | 12,850 | ✅ | 3 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 1,103 | ✅ | 2 | - |
| [codebase_semantic_index](tables/codebase_semantic_index.md) | 0 | ✅ | 2 | - |
| [companies](tables/companies.md) | 1,312 | ✅ | 5 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 7,409 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [coordination_events](tables/coordination_events.md) | 146 | ✅ | 3 | epic #4 (SD-LEO-INFRA-COORDINATION-OBSERVABILITY-ANOMALY-001): structured fleet-coordination anomaly events from the read-only detectors; written only when COORD_DETECTORS_V2 is enabled. |
...
| [design_quality_scores](tables/design_quality_scores.md) | 1,003 | ✅ | 1 | Aggregated per-SD design quality scores from design-agent results. Composite formula: 35% accessibility + 25% token compliance + 20% component reuse + 20% visual polish. |
...
| [eva_interactions](tables/eva_interactions.md) | 18,808 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_scheduler_queue](tables/eva_scheduler_queue.md) | 29 | ✅ | 2 | - |
...
| [eva_ventures](tables/eva_ventures.md) | 29 | ✅ | 2 | EVA Operating System - Venture tracking with health metrics |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 5,022 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [feedback](tables/feedback.md) | 4,896 | ✅ | 8 | - |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 27,559 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 497,642 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 30,874 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [income_capture_monthly](tables/income_capture_monthly.md) | 1 | ✅ | 2 | - |
...
| [issue_patterns](tables/issue_patterns.md) | 1,463 | ✅ | 2 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [leo_feature_flag_audit](tables/leo_feature_flag_audit.md) | 3,819 | ✅ | 2 | Immutable audit log for all feature flag changes |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 19,090 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 3,529 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [marketing_feedback_cycles](tables/marketing_feedback_cycles.md) | 0 | ✅ | 2 | MEASURE-state feedback ingestion per marketing content invocation. Absorbs engagement / reply / conversion / unsubscribe signals as JSONB without schema changes. Added by SD-EHG-MARKETING-DISTRIBUTION-INFRASTRUCTURE-ORCH-001-A. |
| [marketing_pipeline_runs](tables/marketing_pipeline_runs.md) | 1 | ✅ | 2 | Per-invocation audit for marketing orchestrator pipelines. Append-only. UNIQUE(invocation_id) prevents duplicate audit rows on retry. Added by SD-EHG-MARKETING-DISTRIBUTION-INFRASTRUCTURE-ORCH-001-A. |
...
| [model_usage_log](tables/model_usage_log.md) | 55,147 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 2,812 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 45,969 | ✅ | 1 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [retro_notifications](tables/retro_notifications.md) | 3,952 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 6,850 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 10,293 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 2,437 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [sd_backlog_map](tables/sd_backlog_map.md) | 164 | ✅ | 2 | - |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 22,929 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 2,555 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 30,027 | ✅ | 6 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 18,878 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 1,365 | ✅ | 1 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 2,045 | ✅ | 1 | - |
...
| [session_coordination](tables/session_coordination.md) | 10,784 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 38,700 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
| [ship_review_findings](tables/ship_review_findings.md) | 74 | ✅ | 1 | Audit trail for /ship review gate findings. Every PR gets a record with tier, score, and finding details. |
| [shipping_decisions](tables/shipping_decisions.md) | 3,706 | ✅ | 2 | - |
...
| [stage_executions](tables/stage_executions.md) | 3,143 | ✅ | 1 | Per-execution tracking for stage-execution-worker. Each row is one processStage() attempt with heartbeat for crash detection. |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 4,795 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 34,011 | ✅ | 2 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 19,503 | ✅ | 3 | - |
...
| [system_events](tables/system_events.md) | 24,879 | ✅ | 3 | Black Box audit log for all agent actions, state transitions, and resource consumption.
...
| [task_hydration_log](tables/task_hydration_log.md) | 5,658 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 12,720 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 13,935 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_quality_findings](tables/venture_quality_findings.md) | 25 | ✅ | 2 | Canonical persistence layer for Stage 20 Unified Quality Lifecycle Loop. SD-LEO-ORCH-QUALITY-LIFECYCLE-LOOP-001-B. |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 4,360 | ✅ | 1 | - |
...
| [venture_stage_work](tables/venture_stage_work.md) | 369 | ✅ | 5 | - |
...
| [venture_stages_audit](tables/venture_stages_audit.md) | 3,213 | ✅ | 2 | SD-LEO-INFRA-UNIFY-VENTURE-STAGE-001-A: append-only audit of venture_stages column changes. Mirrors stage_config_audit. |
...
| [ventures](tables/ventures.md) | 29 | ✅ | 2 | - |
...
| [vision_scoring_audit_log](tables/vision_scoring_audit_log.md) | 758 | ✅ | 1 | Audit trail for vision scoring gate evaluations with dynamic threshold context. SD-CONTEXTAWARE-VISION-SCORING-DYNAMIC-ORCH-001-A |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 1,180 | ✅ | 1 | - |
...
| [workflow_executions](tables/workflow_executions.md) | 7,422 | ✅ | 2 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 595,601 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

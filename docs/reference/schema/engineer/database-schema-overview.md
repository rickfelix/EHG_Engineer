...
**Generated**: 2026-06-07T06:32:46.140Z
**Tables**: 702
...
| [agent_artifacts](tables/agent_artifacts.md) | 15,228 | ✅ | 2 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 15,307 | ✅ | 2 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 30,404 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 116,371 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [claude_sessions](tables/claude_sessions.md) | 12,687 | ✅ | 3 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 497 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 4,197 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [eva_audit_log](tables/eva_audit_log.md) | 1,530 | ✅ | 3 | EVA Audit Trail - All actions logged |
...
| [eva_interactions](tables/eva_interactions.md) | 14,561 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 3,829 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [eva_youtube_scans](tables/eva_youtube_scans.md) | 56 | ✅ | 1 | Daily scan metadata for EVA YouTube Subscription Digest - tracks each automated scan run |
| [eva_youtube_scores](tables/eva_youtube_scores.md) | 2,576 | ✅ | 1 | Per-video relevance scores from EVA scoring of YouTube subscription content |
...
| [feedback](tables/feedback.md) | 1,513 | ✅ | 8 | - |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 7,587 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 517,515 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 24,569 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 1,277 | ✅ | 2 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [leo_error_log](tables/leo_error_log.md) | 268 | ✅ | 2 | LEO Protocol error log for critical failures that need operator attention. Part of SD-GENESIS-V32-PULSE resilience infrastructure. |
...
| [leo_feature_flag_audit](tables/leo_feature_flag_audit.md) | 55 | ✅ | 2 | Immutable audit log for all feature flag changes |
| [leo_feature_flag_policies](tables/leo_feature_flag_policies.md) | 4 | ✅ | 2 | Per-environment rollout policies for feature flags |
| [leo_feature_flags](tables/leo_feature_flags.md) | 11 | ✅ | 2 | Feature flag definitions for LEO Protocol runtime control |
| [leo_feedback](tables/leo_feedback.md) | 1 | ✅ | 1 | - |
| [leo_gate_reviews](tables/leo_gate_reviews.md) | 438 | ✅ | 2 | - |
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 14,674 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_lint_run_history](tables/leo_lint_run_history.md) | 42 | ✅ | 1 | Append-only log of every linter run. trigger=bypass rows track --skip-lint invocations for rate-limiting (3/week) and chairman dashboard reporting. SD-PROTOCOL-LINTER-001. |
...
| [leo_protocol_sections](tables/leo_protocol_sections.md) | 261 | ✅ | 4 | - |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 1,823 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [leo_sub_agent_triggers](tables/leo_sub_agent_triggers.md) | 495 | ✅ | 3 | - |
...
| [management_reviews](tables/management_reviews.md) | 38,014 | ✅ | 2 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 49,274 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 2,095 | ✅ | 1 | - |
...
| [pattern_subagent_mapping](tables/pattern_subagent_mapping.md) | 790 | ✅ | 3 | RLS: Service role write, authenticated read |
...
| [permission_audit_log](tables/permission_audit_log.md) | 37,208 | ✅ | 1 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [quick_fixes](tables/quick_fixes.md) | 467 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [retro_notifications](tables/retro_notifications.md) | 3,224 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 5,380 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 8,263 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 1,641 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [root_cause_reports](tables/root_cause_reports.md) | 1,126 | ✅ | 2 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_backlog_map](tables/sd_backlog_map.md) | 80 | ✅ | 2 | - |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 1,852 | ✅ | 1 | - |
...
| [sd_governance_bypass_audit](tables/sd_governance_bypass_audit.md) | 769 | ✅ | 2 | Audit trail for governance trigger bypasses.
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 23,727 | ✅ | 6 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 14,865 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 609 | ✅ | 1 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 961 | ✅ | 1 | - |
...
| [session_coordination](tables/session_coordination.md) | 1,106 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 16,737 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 2,290 | ✅ | 2 | - |
...
| [stage_events](tables/stage_events.md) | 20 | ✅ | 2 | - |
| [stage_executions](tables/stage_executions.md) | 1,546 | ✅ | 1 | Per-execution tracking for stage-execution-worker. Each row is one processStage() attempt with heartbeat for crash detection. |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 3,539 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 25,999 | ✅ | 2 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 14,553 | ✅ | 3 | - |
...
| [system_events](tables/system_events.md) | 9,870 | ✅ | 3 | Black Box audit log for all agent actions, state transitions, and resource consumption.
...
| [task_hydration_log](tables/task_hydration_log.md) | 2,989 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 10,123 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 58,664 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifacts](tables/venture_artifacts.md) | 1,717 | ✅ | 4 | - |
...
| [venture_provisioning_state](tables/venture_provisioning_state.md) | 7 | ✅ | 2 | Tracks venture provisioning lifecycle: repo creation, registry entry, schema setup, CI/CD config, and conformance checks. Referenced by the Stage 18 post-approval hook and create-ehg-venture --register. |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 962 | ✅ | 1 | - |
...
| [venture_stage_transitions](tables/venture_stage_transitions.md) | 70 | ✅ | 1 | - |
| [venture_stage_work](tables/venture_stage_work.md) | 85 | ✅ | 5 | - |
...
| [venture_stages_audit](tables/venture_stages_audit.md) | 91 | ✅ | 2 | SD-LEO-INFRA-UNIFY-VENTURE-STAGE-001-A: append-only audit of venture_stages column changes. Mirrors stage_config_audit. |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 1,995 | ✅ | 2 | Golden Nugget: Token/compute investment tracking per venture |
...
| [vision_scoring_audit_log](tables/vision_scoring_audit_log.md) | 605 | ✅ | 1 | Audit trail for vision scoring gate evaluations with dynamic threshold context. SD-CONTEXTAWARE-VISION-SCORING-DYNAMIC-ORCH-001-A |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 1,026 | ✅ | 1 | - |
...
| [workflow_executions](tables/workflow_executions.md) | 5,446 | ✅ | 2 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 577,271 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

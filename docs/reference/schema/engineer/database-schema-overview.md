...
| [agent_artifacts](tables/agent_artifacts.md) | 11,259 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 11,311 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 23,642 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 2,408 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [brainstorm_sessions](tables/brainstorm_sessions.md) | 362 | ✅ | 2 | Tracks brainstorming sessions across domains (venture, protocol, integration, architecture) with outcome classification, quality metrics, and capability matching. Used for question effectiveness analysis and retrospective integration. |
...
| [chairman_decisions](tables/chairman_decisions.md) | 14 | ✅ | 2 | SD-HARDENING-V1-001: Chairman-only decision records.
...
| [claude_sessions](tables/claude_sessions.md) | 11,645 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [customer_personas](tables/customer_personas.md) | 75 | ✅ | 2 | Canonical customer persona catalog. Personas can be venture-specific (source_venture_id) or global (canonical_id IS NULL). |
...
| [debate_arguments](tables/debate_arguments.md) | 600 | ✅ | 2 | - |
| [debate_circuit_breaker](tables/debate_circuit_breaker.md) | 0 | ✅ | 2 | - |
| [debate_sessions](tables/debate_sessions.md) | 70 | ✅ | 3 | - |
...
| [eva_architecture_plans](tables/eva_architecture_plans.md) | 193 | ✅ | 2 | Architecture Plans linked to Vision documents. ON DELETE RESTRICT on vision_id prevents deleting a vision that has architecture plans. |
...
| [eva_interactions](tables/eva_interactions.md) | 9,886 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_translation_gates](tables/eva_translation_gates.md) | 489 | ✅ | 3 | Translation fidelity gate results for the EVA pipeline. Each gate checks upstream artifacts against downstream artifacts to detect translation gaps. |
...
| [eva_vision_documents](tables/eva_vision_documents.md) | 196 | ✅ | 2 | Stores EHG portfolio (L1) and venture-specific (L2) vision documents for the EVA Vision Governance System. L2 visions link to L1 via parent_vision_id. |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 2,933 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [feedback](tables/feedback.md) | 225 | ✅ | 8 | - |
...
| [governance_audit_log](tables/governance_audit_log.md) | 162,517 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 20,026 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [integration_verification_records](tables/integration_verification_records.md) | 1 | ✅ | 2 | Audit trail of integration verification gate outcomes per SD |
...
| [issue_patterns](tables/issue_patterns.md) | 680 | ✅ | 5 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
| [judge_verdicts](tables/judge_verdicts.md) | 51 | ✅ | 3 | - |
...
| [learning_decisions](tables/learning_decisions.md) | 215 | ✅ | 1 | Tracks all /learn command actions, findings, and user approvals to close the feedback loop on organizational learning. |
...
| [leo_adrs](tables/leo_adrs.md) | 315 | ✅ | 2 | - |
...
| [leo_error_log](tables/leo_error_log.md) | 206 | ✅ | 2 | LEO Protocol error log for critical failures that need operator attention. Part of SD-GENESIS-V32-PULSE resilience infrastructure. |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 10,784 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_protocol_sections](tables/leo_protocol_sections.md) | 245 | ✅ | 4 | - |
...
| [mental_model_applications](tables/mental_model_applications.md) | 385 | ✅ | 4 | Tracks which models were applied to which ventures at which stages |
...
| [model_usage_log](tables/model_usage_log.md) | 15,136 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [operations_audit_log](tables/operations_audit_log.md) | 41 | ✅ | 2 | - |
...
| [outcome_signals](tables/outcome_signals.md) | 1,420 | ✅ | 1 | - |
...
| [plan_critiques](tables/plan_critiques.md) | 38 | ✅ | 2 | Pre-PLAN adversarial critique results from devils-advocate.js critiquePlanProposal(). Phase 1: advisory only — never blocks handoffs. |
...
| [retro_notifications](tables/retro_notifications.md) | 2,535 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 3,893 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 223 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 920 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [root_cause_reports](tables/root_cause_reports.md) | 798 | ✅ | 4 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 1,234 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 19,191 | ✅ | 11 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 11,050 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 72 | ❌ | 0 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 5,869 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 1,207 | ✅ | 2 | - |
...
| [stitch_generation_metrics](tables/stitch_generation_metrics.md) | 17 | ✅ | 1 | - |
| [story_test_mappings](tables/story_test_mappings.md) | 0 | ✅ | 2 | Links user stories to test results with traceability |
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 2,600 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 19,753 | ✅ | 4 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 10,624 | ✅ | 3 | - |
...
| [system_events](tables/system_events.md) | 1,851 | ✅ | 3 | Black Box audit log for all agent actions, state transitions, and resource consumption.
...
| [user_stories](tables/user_stories.md) | 7,497 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 52,560 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 46 | ✅ | 4 | Golden Nugget: Token/compute investment tracking per venture |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 486 | ✅ | 1 | - |
| [workflow_checkpoints](tables/workflow_checkpoints.md) | 2 | ✅ | 2 | Stores workflow state checkpoints for recovery |
| [workflow_executions](tables/workflow_executions.md) | 2,817 | ✅ | 3 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 408,776 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

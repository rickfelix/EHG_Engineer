...
| [agent_artifacts](tables/agent_artifacts.md) | 13,986 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 14,065 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 28,328 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 83,022 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 330 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 3,352 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [eva_audit_log](tables/eva_audit_log.md) | 722 | ✅ | 3 | EVA Audit Trail - All actions logged |
...
| [eva_interactions](tables/eva_interactions.md) | 13,704 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 3,676 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [feedback](tables/feedback.md) | 1,287 | ✅ | 8 | - |
...
| [governance_audit_log](tables/governance_audit_log.md) | 412,507 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 23,836 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 13,721 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 1,401 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [management_reviews](tables/management_reviews.md) | 27,186 | ✅ | 2 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 39,614 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 1,923 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 31,280 | ❌ | 0 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [retro_notifications](tables/retro_notifications.md) | 3,051 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 6,386 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 3,148 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 1,410 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 1,690 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 22,994 | ✅ | 11 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 471 | ❌ | 0 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 600 | ❌ | 0 | - |
...
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 12,407 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 2,002 | ✅ | 2 | - |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 3,306 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 24,038 | ✅ | 4 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 13,332 | ✅ | 3 | - |
...
| [task_hydration_log](tables/task_hydration_log.md) | 2,442 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 9,309 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 57,758 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 728 | ✅ | 3 | - |
...
| [workflow_trace_log](tables/workflow_trace_log.md) | 545,100 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 5,671 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [learning_decisions](tables/learning_decisions.md) | 14 | ❌ | 0 | Tracks all /learn command actions, findings, and user approvals to close the feedback loop on organizational learning. |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 1,509 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [product_requirements_v2](tables/product_requirements_v2.md) | 408 | ✅ | 3 | Product Requirements Documents (PRDs) for Strategic Directives. Created by PLAN agent during PLAN_PRD phase. Contains comprehensive implementation specifications: requirements, architecture, testing, risks, and acceptance criteria. One PRD per SD (1:1 relationship via sd_uuid foreign key). |
...
| [protocol_improvement_audit_log](tables/protocol_improvement_audit_log.md) | 61 | ✅ | 2 | Audit trail for all protocol improvement actions. Tracks who approved what and when changes were applied. |
...
| [retro_notifications](tables/retro_notifications.md) | 735 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 424 | ✅ | 2 | - |
...
| [sd_claims](tables/sd_claims.md) | 1,491 | ✅ | 2 | Historical record of SD claims by sessions. Supports analytics and audit trail. |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 2,939 | ✅ | 8 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 2,074 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [user_stories](tables/user_stories.md) | 1,512 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |

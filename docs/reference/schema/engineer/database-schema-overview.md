...
| [agent_artifacts](tables/agent_artifacts.md) | 2,821 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 2,830 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 4,955 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [circuit_breaker_blocks](tables/circuit_breaker_blocks.md) | 186 | ✅ | 2 | Audit log for Circuit Breaker blocks (Law 3).
Records all handoffs rejected due to validation_score < 85%.
Part of EHG Immutable Laws v9.0.0 Manifesto enforcement. |
| [claude_sessions](tables/claude_sessions.md) | 2,731 | ✅ | 2 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [compliance_checks](tables/compliance_checks.md) | 4 | ✅ | 2 | Stores compliance check run history for the Always-On Compliance orchestrator |
...
| [compliance_violations](tables/compliance_violations.md) | 87 | ✅ | 3 | Stores individual compliance violations detected during checks |
...
| [governance_audit_log](tables/governance_audit_log.md) | 57,221 | ✅ | 3 | - |
| [governance_policies](tables/governance_policies.md) | 0 | ✅ | 2 | - |
| [governance_proposals](tables/governance_proposals.md) | 2 | ✅ | 2 | - |
| [handoff_audit_log](tables/handoff_audit_log.md) | 2,391 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 1,173 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_protocol_sections](tables/leo_protocol_sections.md) | 133 | ✅ | 4 | - |
...
| [leo_sub_agent_triggers](tables/leo_sub_agent_triggers.md) | 365 | ✅ | 3 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 557 | ✅ | 2 | - |
...
| [product_requirements_v2](tables/product_requirements_v2.md) | 317 | ✅ | 3 | Product Requirements Documents (PRDs) for Strategic Directives. Created by PLAN agent during PLAN_PRD phase. Contains comprehensive implementation specifications: requirements, architecture, testing, risks, and acceptance criteria. One PRD per SD (1:1 relationship via sd_uuid foreign key). |
...
| [protocol_improvement_audit_log](tables/protocol_improvement_audit_log.md) | 27 | ✅ | 2 | Audit trail for all protocol improvement actions. Tracks who approved what and when changes were applied. |
| [protocol_improvement_queue](tables/protocol_improvement_queue.md) | 23 | ✅ | 5 | Queue for protocol improvements extracted from retrospectives. Enforces database-first approach by requiring target_table and payload. |
...
| [retro_notifications](tables/retro_notifications.md) | 637 | ✅ | 2 | - |
| [retrospective_action_items](tables/retrospective_action_items.md) | 0 | ✅ | 2 | - |
| [retrospective_contributions](tables/retrospective_contributions.md) | 1 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 337 | ✅ | 2 | - |
...
| [runtime_audits](tables/runtime_audits.md) | 0 | ✅ | 3 | - |
| [scaffold_patterns](tables/scaffold_patterns.md) | 49 | ❌ | 0 | Pattern library for AI-driven code generation in Genesis simulations |
...
| [sd_baseline_issues](tables/sd_baseline_issues.md) | 5 | ✅ | 4 | Tracks pre-existing codebase issues that should not block unrelated SD completion. Part of LEO Protocol governance. |
| [sd_baseline_items](tables/sd_baseline_items.md) | 0 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_claims](tables/sd_claims.md) | 1,099 | ✅ | 2 | Historical record of SD claims by sessions. Supports analytics and audit trail. |
...
| [sd_governance_bypass_audit](tables/sd_governance_bypass_audit.md) | 76 | ✅ | 2 | Audit trail for governance trigger bypasses.
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 2,024 | ✅ | 8 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 1,492 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_type_change_audit](tables/sd_type_change_audit.md) | 26 | ❌ | 0 | Audit log for SD type changes with risk assessment. Part of SD-LEO-COMPLETION-GATES-001 governance enhancement. |
...
| [sd_type_validation_profiles](tables/sd_type_validation_profiles.md) | 11 | ✅ | 4 | Configurable validation profiles for different SD types. Each type has different requirements for completion. |
...
| [simulation_sessions](tables/simulation_sessions.md) | 5 | ❌ | 0 | Tracks Genesis simulation lifecycle including ephemeral deployments and incineration |
| [soul_extractions](tables/soul_extractions.md) | 0 | ❌ | 0 | Stores extracted structured requirements from simulations for regeneration gates (Stage 16/17) |
...
| [stage_events](tables/stage_events.md) | 0 | ✅ | 3 | - |
| [story_test_mappings](tables/story_test_mappings.md) | 0 | ✅ | 4 | Links user stories to test results with traceability |
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 361 | ✅ | 4 | RLS enabled: service_role full access, authenticated read-only |
| [sub_agent_execution_batches](tables/sub_agent_execution_batches.md) | 2 | ✅ | 2 | - |
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 7,268 | ✅ | 4 | Sub-agent execution results with optimized autovacuum settings (5% threshold).
...
| [sub_agent_executions](tables/sub_agent_executions.md) | 67 | ✅ | 2 | - |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 2,257 | ✅ | 3 | - |
...
| [test_runs](tables/test_runs.md) | 1 | ✅ | 4 | Immutable test execution records. Part of unified test evidence architecture (LEO v4.3.4) |
...
| [user_stories](tables/user_stories.md) | 1,131 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_evidence](tables/validation_evidence.md) | 0 | ✅ | 2 | - |
| [venture_archetypes](tables/venture_archetypes.md) | 8 | ✅ | 2 | Venture archetype templates for categorizing and styling ventures |
| [venture_artifacts](tables/venture_artifacts.md) | 0 | ✅ | 5 | - |
| [venture_decisions](tables/venture_decisions.md) | 0 | ✅ | 3 | Gate decisions for ventures - created for chairman_unified_decisions VIEW |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 0 | ✅ | 3 | Golden Nugget: Token/compute investment tracking per venture |

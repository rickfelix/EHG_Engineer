...
| [agent_artifacts](tables/agent_artifacts.md) | 16,527 | ✅ | 2 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 16,606 | ✅ | 2 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 32,354 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 150,305 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [chairman_decisions](tables/chairman_decisions.md) | 49 | ✅ | 2 | SD-HARDENING-V1-001: Chairman-only decision records.
...
| [claude_sessions](tables/claude_sessions.md) | 12,767 | ✅ | 3 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 618 | ✅ | 2 | - |
| [codebase_semantic_index](tables/codebase_semantic_index.md) | 0 | ✅ | 2 | - |
| [companies](tables/companies.md) | 1,304 | ✅ | 5 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 5,073 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [coordination_events](tables/coordination_events.md) | 13 | ✅ | 1 | epic #4 (SD-LEO-INFRA-COORDINATION-OBSERVABILITY-ANOMALY-001): structured fleet-coordination anomaly events from the read-only detectors; written only when COORD_DETECTORS_V2 is enabled. |
...
| [design_quality_scores](tables/design_quality_scores.md) | 517 | ✅ | 1 | Aggregated per-SD design quality scores from design-agent results. Composite formula: 35% accessibility + 25% token compliance + 20% component reuse + 20% visual polish. |
...
| [eva_consultant_recommendations](tables/eva_consultant_recommendations.md) | 546 | ✅ | 2 | Actionable recommendations generated by EVA trend analysis for chairman review |
...
| [eva_interactions](tables/eva_interactions.md) | 15,590 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_scheduler_metrics](tables/eva_scheduler_metrics.md) | 11,368 | ✅ | 2 | - |
| [eva_scheduler_metrics_qparity20260610](tables/eva_scheduler_metrics_qparity20260610.md) | 995 | ❌ | 0 | - |
| [eva_scheduler_queue](tables/eva_scheduler_queue.md) | 7 | ✅ | 2 | - |
...
| [eva_translation_gates](tables/eva_translation_gates.md) | 805 | ✅ | 3 | Translation fidelity gate results for the EVA pipeline. Each gate checks upstream artifacts against downstream artifacts to detect translation gaps. |
| [eva_updates](tables/eva_updates.md) | 5 | ✅ | 1 | Stores EVA weekly meeting updates including section reports, coordinator status, decisions, and chairman notes |
...
| [eva_ventures](tables/eva_ventures.md) | 7 | ✅ | 2 | EVA Operating System - Venture tracking with health metrics |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 4,076 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [eva_youtube_intake](tables/eva_youtube_intake.md) | 137 | ✅ | 2 | - |
| [eva_youtube_scans](tables/eva_youtube_scans.md) | 61 | ✅ | 1 | Daily scan metadata for EVA YouTube Subscription Digest - tracks each automated scan run |
| [eva_youtube_scores](tables/eva_youtube_scores.md) | 2,816 | ✅ | 1 | Per-video relevance scores from EVA scoring of YouTube subscription content |
...
| [feedback](tables/feedback.md) | 2,260 | ✅ | 8 | - |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 13,557 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 582,659 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 25,482 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 1,355 | ✅ | 2 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
| [judge_verdicts](tables/judge_verdicts.md) | 61 | ✅ | 1 | - |
| [key_results](tables/key_results.md) | 38 | ✅ | 2 | Measurable outcomes (the KR in OKRs) |
...
| [learning_decisions](tables/learning_decisions.md) | 282 | ✅ | 1 | Tracks all /learn command actions, findings, and user approvals to close the feedback loop on organizational learning. |
...
| [leo_error_log](tables/leo_error_log.md) | 270 | ✅ | 2 | LEO Protocol error log for critical failures that need operator attention. Part of SD-GENESIS-V32-PULSE resilience infrastructure. |
...
| [leo_feature_flag_audit](tables/leo_feature_flag_audit.md) | 1,137 | ✅ | 2 | Immutable audit log for all feature flag changes |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 15,673 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_lint_run_history](tables/leo_lint_run_history.md) | 56 | ✅ | 1 | Append-only log of every linter run. trigger=bypass rows track --skip-lint invocations for rate-limiting (3/week) and chairman dashboard reporting. SD-PROTOCOL-LINTER-001. |
...
| [leo_planner_rankings](tables/leo_planner_rankings.md) | 58 | ✅ | 2 | Stores Central Planner output for stability tracking and audit |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 2,296 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [management_reviews](tables/management_reviews.md) | 2 | ✅ | 2 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 50,856 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [objectives](tables/objectives.md) | 8 | ✅ | 2 | Qualitative goals (the O in OKRs) |
| [okr_generation_log](tables/okr_generation_log.md) | 2 | ✅ | 3 | Audit trail for automated OKR generation runs |
| [okr_snapshots](tables/okr_snapshots.md) | 40 | ✅ | 2 | Point-in-time snapshots of key result progress for trend tracking |
...
| [outcome_signals](tables/outcome_signals.md) | 2,267 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 42,458 | ✅ | 1 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [plan_critiques](tables/plan_critiques.md) | 182 | ✅ | 2 | Pre-PLAN adversarial critique results from devils-advocate.js critiquePlanProposal(). Phase 1: advisory only — never blocks handoffs. |
...
| [pocock_glossary_terms](tables/pocock_glossary_terms.md) | 40 | ✅ | 2 | - |
| [pocock_oos_findings](tables/pocock_oos_findings.md) | 11,070 | ✅ | 2 | - |
...
| [quick_fixes](tables/quick_fixes.md) | 518 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [retro_notifications](tables/retro_notifications.md) | 3,397 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 5,724 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 8,832 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 1,853 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [roadmap_wave_items](tables/roadmap_wave_items.md) | 461 | ✅ | 2 | Links classified EVA intake items to roadmap waves. Tracks promotion to SDs. |
...
| [root_cause_reports](tables/root_cause_reports.md) | 1,144 | ✅ | 2 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_backlog_map](tables/sd_backlog_map.md) | 135 | ✅ | 2 | - |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 11,651 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_burn_rate_snapshots](tables/sd_burn_rate_snapshots.md) | 5 | ✅ | 2 | Periodic snapshots of velocity metrics for trending and forecasting. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 2,020 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 24,640 | ✅ | 6 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 15,828 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_testing_status](tables/sd_testing_status.md) | 4 | ✅ | 2 | Tracks testing status for Strategic Directives. Prevents duplicate testing and provides work-down plan visualization. |
| [sd_transition_audit](tables/sd_transition_audit.md) | 786 | ✅ | 1 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 1,271 | ✅ | 1 | - |
...
| [session_coordination](tables/session_coordination.md) | 2,600 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 24,207 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 2,627 | ✅ | 2 | - |
...
| [stage_executions](tables/stage_executions.md) | 2,819 | ✅ | 1 | Per-execution tracking for stage-execution-worker. Each row is one processStage() attempt with heartbeat for crash detection. |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 3,760 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
| [strategic_roadmaps](tables/strategic_roadmaps.md) | 1 | ✅ | 2 | Top-level roadmap entities for wave-based planning. Linked to vision documents for strategic alignment. |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 28,064 | ✅ | 2 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 15,846 | ✅ | 3 | - |
...
| [system_events](tables/system_events.md) | 10,183 | ✅ | 3 | Black Box audit log for all agent actions, state transitions, and resource consumption.
...
| [task_hydration_log](tables/task_hydration_log.md) | 3,556 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 10,856 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 20,083 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 1,906 | ✅ | 1 | - |
...
| [venture_stage_work](tables/venture_stage_work.md) | 91 | ✅ | 5 | - |
...
| [venture_stages_audit](tables/venture_stages_audit.md) | 791 | ✅ | 2 | SD-LEO-INFRA-UNIFY-VENTURE-STAGE-001-A: append-only audit of venture_stages column changes. Mirrors stage_config_audit. |
...
| [ventures](tables/ventures.md) | 7 | ✅ | 2 | - |
...
| [vision_scoring_audit_log](tables/vision_scoring_audit_log.md) | 643 | ✅ | 1 | Audit trail for vision scoring gate evaluations with dynamic threshold context. SD-CONTEXTAWARE-VISION-SCORING-DYNAMIC-ORCH-001-A |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 1,041 | ✅ | 1 | - |
...
| [workflow_executions](tables/workflow_executions.md) | 6,796 | ✅ | 2 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 515,229 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

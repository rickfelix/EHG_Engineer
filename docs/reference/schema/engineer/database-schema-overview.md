...
| [agent_artifacts](tables/agent_artifacts.md) | 16,464 | ✅ | 2 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 16,543 | ✅ | 2 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 32,306 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 149,254 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [cascade_invalidation_flags](tables/cascade_invalidation_flags.md) | 20 | ✅ | 2 | - |
| [cascade_invalidation_log](tables/cascade_invalidation_log.md) | 52 | ✅ | 2 | - |
...
| [chairman_decisions](tables/chairman_decisions.md) | 47 | ✅ | 2 | SD-HARDENING-V1-001: Chairman-only decision records.
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 608 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 5,013 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [coordination_events](tables/coordination_events.md) | 8 | ❌ | 0 | epic #4 (SD-LEO-INFRA-COORDINATION-OBSERVABILITY-ANOMALY-001): structured fleet-coordination anomaly events from the read-only detectors; written only when COORD_DETECTORS_V2 is enabled. |
...
| [design_quality_scores](tables/design_quality_scores.md) | 511 | ✅ | 1 | Aggregated per-SD design quality scores from design-agent results. Composite formula: 35% accessibility + 25% token compliance + 20% component reuse + 20% visual polish. |
...
| [eva_interactions](tables/eva_interactions.md) | 15,545 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_scheduler_metrics](tables/eva_scheduler_metrics.md) | 10,280 | ✅ | 2 | - |
...
| [eva_stage_gate_results](tables/eva_stage_gate_results.md) | 1,096 | ✅ | 2 | Tracks EVA gate evaluations with kill gate enforcement (stages 3,5,13,23 require 70% score) |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 4,068 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [feedback](tables/feedback.md) | 2,217 | ✅ | 8 | - |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 13,320 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 577,806 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 25,439 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 1,345 | ✅ | 2 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [leo_feature_flag_audit](tables/leo_feature_flag_audit.md) | 1,061 | ✅ | 2 | Immutable audit log for all feature flag changes |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 15,637 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 2,266 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [model_usage_log](tables/model_usage_log.md) | 50,767 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 2,260 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 42,346 | ✅ | 1 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [retro_notifications](tables/retro_notifications.md) | 3,390 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 5,714 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 8,820 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 1,848 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 11,393 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_capabilities](tables/sd_capabilities.md) | 207 | ✅ | 3 | Junction table tracking which capabilities were registered/updated/deprecated by which Strategic Directives. Provides full audit trail. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 2,013 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 24,597 | ✅ | 6 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 15,810 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 779 | ✅ | 1 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 1,265 | ✅ | 1 | - |
...
| [session_coordination](tables/session_coordination.md) | 2,514 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 23,617 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 2,614 | ✅ | 2 | - |
...
| [stage_executions](tables/stage_executions.md) | 2,770 | ✅ | 1 | Per-execution tracking for stage-execution-worker. Each row is one processStage() attempt with heartbeat for crash detection. |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 27,970 | ✅ | 2 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 15,783 | ✅ | 3 | - |
...
| [task_hydration_log](tables/task_hydration_log.md) | 3,542 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 10,838 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 20,033 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifacts](tables/venture_artifacts.md) | 272 | ✅ | 4 | - |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 1,846 | ✅ | 1 | - |
...
| [venture_stage_transitions](tables/venture_stage_transitions.md) | 75 | ✅ | 1 | - |
| [venture_stage_transitions_qparity20260610](tables/venture_stage_transitions_qparity20260610.md) | 4 | ❌ | 0 | - |
| [venture_stage_work](tables/venture_stage_work.md) | 87 | ✅ | 5 | - |
...
| [venture_stages_audit](tables/venture_stages_audit.md) | 733 | ✅ | 2 | SD-LEO-INFRA-UNIFY-VENTURE-STAGE-001-A: append-only audit of venture_stages column changes. Mirrors stage_config_audit. |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 1,032 | ✅ | 1 | - |
...
| [workflow_executions](tables/workflow_executions.md) | 6,738 | ✅ | 2 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 513,977 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

...
**Generated**: 2026-06-07T23:59:20.135Z
**Tables**: 702
...
| [agent_artifacts](tables/agent_artifacts.md) | 15,411 | ✅ | 2 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 15,490 | ✅ | 2 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 30,755 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 120,473 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [brainstorm_sessions](tables/brainstorm_sessions.md) | 2,320 | ✅ | 2 | Tracks brainstorming sessions across domains (venture, protocol, integration, architecture) with outcome classification, quality metrics, and capability matching. Used for question effectiveness analysis and retrospective integration. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 516 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 4,299 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [eva_audit_log](tables/eva_audit_log.md) | 1,636 | ✅ | 3 | EVA Audit Trail - All actions logged |
...
| [eva_consultant_recommendations](tables/eva_consultant_recommendations.md) | 503 | ✅ | 2 | Actionable recommendations generated by EVA trend analysis for chairman review |
...
| [eva_interactions](tables/eva_interactions.md) | 14,686 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 3,847 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [feedback](tables/feedback.md) | 1,582 | ✅ | 8 | - |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 8,014 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 530,927 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 24,687 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 1,281 | ✅ | 2 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [leo_feature_flag_audit](tables/leo_feature_flag_audit.md) | 162 | ✅ | 2 | Immutable audit log for all feature flag changes |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 14,807 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_lint_run_history](tables/leo_lint_run_history.md) | 45 | ✅ | 1 | Append-only log of every linter run. trigger=bypass rows track --skip-lint invocations for rate-limiting (3/week) and chairman dashboard reporting. SD-PROTOCOL-LINTER-001. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 1,877 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [management_reviews](tables/management_reviews.md) | 39,314 | ✅ | 2 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 49,871 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 2,118 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 37,898 | ✅ | 1 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [retro_notifications](tables/retro_notifications.md) | 3,248 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 5,432 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 8,323 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 1,678 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [root_cause_reports](tables/root_cause_reports.md) | 1,129 | ✅ | 2 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_backlog_map](tables/sd_backlog_map.md) | 91 | ✅ | 2 | - |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 3,816 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 1,874 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 23,845 | ✅ | 6 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 15,020 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 632 | ✅ | 1 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 1,007 | ✅ | 1 | - |
...
| [session_coordination](tables/session_coordination.md) | 1,367 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 17,417 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 2,334 | ✅ | 2 | - |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 3,572 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 26,266 | ✅ | 2 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 14,735 | ✅ | 3 | - |
...
| [system_events](tables/system_events.md) | 9,941 | ✅ | 3 | Black Box audit log for all agent actions, state transitions, and resource consumption.
...
| [task_hydration_log](tables/task_hydration_log.md) | 3,074 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 10,236 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 58,797 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_quality_findings](tables/venture_quality_findings.md) | 12 | ✅ | 2 | Canonical persistence layer for Stage 20 Unified Quality Lifecycle Loop. SD-LEO-ORCH-QUALITY-LIFECYCLE-LOOP-001-B. |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 1,070 | ✅ | 1 | - |
...
| [venture_stages_audit](tables/venture_stages_audit.md) | 99 | ✅ | 2 | SD-LEO-INFRA-UNIFY-VENTURE-STAGE-001-A: append-only audit of venture_stages column changes. Mirrors stage_config_audit. |
...
| [vision_scoring_audit_log](tables/vision_scoring_audit_log.md) | 615 | ✅ | 1 | Audit trail for vision scoring gate evaluations with dynamic threshold context. SD-CONTEXTAWARE-VISION-SCORING-DYNAMIC-ORCH-001-A |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 1,030 | ✅ | 1 | - |
...
| [workflow_executions](tables/workflow_executions.md) | 6,695 | ✅ | 2 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 581,855 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

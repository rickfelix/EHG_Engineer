...
| [audit_log](tables/audit_log.md) | 52 | ✅ | 1 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [claude_sessions](tables/claude_sessions.md) | 7,948 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 81,342 | ✅ | 3 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 1,048 | ✅ | 3 | RLS: Append-only for authenticated |
...
| [sd_claims](tables/sd_claims.md) | 2,450 | ✅ | 5 | Historical record of SD claims by sessions. Supports analytics and audit trail. |
...
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 1,815 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [validation_audit_log](tables/validation_audit_log.md) | 31,179 | ✅ | 3 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |

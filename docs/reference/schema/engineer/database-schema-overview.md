...
| [agent_artifacts](tables/agent_artifacts.md) | 13,536 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 13,608 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 27,509 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 60,672 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [brainstorm_sessions](tables/brainstorm_sessions.md) | 1,362 | ✅ | 2 | Tracks brainstorming sessions across domains (venture, protocol, integration, architecture) with outcome classification, quality metrics, and capability matching. Used for question effectiveness analysis and retrospective integration. |
...
| [brand_genome_submissions](tables/brand_genome_submissions.md) | 3 | ✅ | 5 | Brand identity genome for ventures ensuring marketing consistency |
...
| [chairman_decision_audit](tables/chairman_decision_audit.md) | 2 | ❌ | 0 | - |
| [chairman_decisions](tables/chairman_decisions.md) | 13 | ✅ | 2 | SD-HARDENING-V1-001: Chairman-only decision records.
...
| [claude_sessions](tables/claude_sessions.md) | 12,436 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 250 | ✅ | 2 | - |
| [codebase_semantic_index](tables/codebase_semantic_index.md) | 0 | ✅ | 2 | - |
| [companies](tables/companies.md) | 1,303 | ✅ | 6 | - |
| [competitive_baselines](tables/competitive_baselines.md) | 1 | ✅ | 1 | - |
| [competitors](tables/competitors.md) | 3 | ✅ | 5 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 2,768 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [customer_personas](tables/customer_personas.md) | 189 | ✅ | 2 | Canonical customer persona catalog. Personas can be venture-specific (source_venture_id) or global (canonical_id IS NULL). |
...
| [eva_architecture_plans](tables/eva_architecture_plans.md) | 225 | ✅ | 2 | Architecture Plans linked to Vision documents. ON DELETE RESTRICT on vision_id prevents deleting a vision that has architecture plans. |
...
| [eva_audit_log](tables/eva_audit_log.md) | 260 | ✅ | 3 | EVA Audit Trail - All actions logged |
...
| [eva_consultant_recommendations](tables/eva_consultant_recommendations.md) | 336 | ✅ | 2 | Actionable recommendations generated by EVA trend analysis for chairman review |
...
| [eva_events_dlq](tables/eva_events_dlq.md) | 9 | ✅ | 2 | - |
...
| [eva_interactions](tables/eva_interactions.md) | 13,374 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
| [eva_orchestration_events](tables/eva_orchestration_events.md) | 1 | ✅ | 1 | EVA orchestration lifecycle events for Chairman Dashboard Event Feed. Real-time enabled. |
...
| [eva_scheduler_queue](tables/eva_scheduler_queue.md) | 4 | ✅ | 2 | - |
...
| [eva_stage_gate_results](tables/eva_stage_gate_results.md) | 972 | ✅ | 2 | Tracks EVA gate evaluations with kill gate enforcement (stages 3,5,13,23 require 70% score) |
...
| [eva_ventures](tables/eva_ventures.md) | 4 | ✅ | 2 | EVA Operating System - Venture tracking with health metrics |
| [eva_vision_documents](tables/eva_vision_documents.md) | 261 | ✅ | 2 | Stores EHG portfolio (L1) and venture-specific (L2) vision documents for the EVA Vision Governance System. L2 visions link to L1 via parent_vision_id. |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 3,623 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [eva_youtube_scans](tables/eva_youtube_scans.md) | 43 | ✅ | 3 | Daily scan metadata for EVA YouTube Subscription Digest - tracks each automated scan run |
| [eva_youtube_scores](tables/eva_youtube_scores.md) | 1,957 | ✅ | 3 | Per-video relevance scores from EVA scoring of YouTube subscription content |
| [evaluation_profile_outcomes](tables/evaluation_profile_outcomes.md) | 109 | ✅ | 2 | Per-gate survival signals linking evaluation profile+version to venture outcomes at tracked boundaries |
...
| [feedback](tables/feedback.md) | 1,162 | ✅ | 8 | - |
...
| [financial_models](tables/financial_models.md) | 1 | ✅ | 4 | Venture capital financial models with templates (SaaS, marketplace, etc.) |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 4,952 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 344,891 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 23,540 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 1,234 | ✅ | 5 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [lead_evaluations](tables/lead_evaluations.md) | 10 | ✅ | 2 | Stores results from LEAD Critical Evaluator framework - mandatory business value assessments |
...
| [leo_adrs](tables/leo_adrs.md) | 602 | ✅ | 2 | - |
...
| [leo_error_log](tables/leo_error_log.md) | 253 | ✅ | 2 | LEO Protocol error log for critical failures that need operator attention. Part of SD-GENESIS-V32-PULSE resilience infrastructure. |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 13,397 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_planner_rankings](tables/leo_planner_rankings.md) | 49 | ✅ | 2 | Stores Central Planner output for stability tracking and audit |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 1,121 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [leo_sub_agent_triggers](tables/leo_sub_agent_triggers.md) | 494 | ✅ | 3 | - |
...
| [leo_wiring_validations](tables/leo_wiring_validations.md) | 6 | ✅ | 1 | Persistent store of LEO Wiring Verification Framework detector outputs. Mirrors eva_vision_documents.quality_checked pattern — detector writes, trigger derives strategic_directives_v2.wiring_validated, handoff gate queries derived column. SD: SD-LEO-WIRING-VERIFICATION-FRAMEWORK-ORCH-001-D. |
...
| [management_reviews](tables/management_reviews.md) | 19,799 | ✅ | 2 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 37,719 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [naming_suggestions](tables/naming_suggestions.md) | 5 | ✅ | 2 | - |
...
| [outcome_signals](tables/outcome_signals.md) | 1,866 | ✅ | 1 | - |
...
| [pattern_subagent_mapping](tables/pattern_subagent_mapping.md) | 754 | ✅ | 3 | RLS: Service role write, authenticated read |
...
| [permission_audit_log](tables/permission_audit_log.md) | 26,951 | ❌ | 0 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [quick_fixes](tables/quick_fixes.md) | 306 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [rd_batch_runs](tables/rd_batch_runs.md) | 9 | ✅ | 2 | - |
| [rd_proposals](tables/rd_proposals.md) | 6 | ✅ | 6 | Autonomous R&D proposals generated by Monday batch job. Queued for chairman review at Friday EVA meetings. |
...
| [retro_notifications](tables/retro_notifications.md) | 2,994 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 5,434 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 2,150 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 1,319 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [risk_recalibration_forms](tables/risk_recalibration_forms.md) | 1 | ✅ | 2 | SD-LIFECYCLE-GAP-005: Risk re-calibration forms at phase boundary gates (Gates 3, 4, 5, 6) |
...
| [root_cause_reports](tables/root_cause_reports.md) | 1,089 | ✅ | 4 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_backlog_map](tables/sd_backlog_map.md) | 73 | ✅ | 2 | - |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 1,638 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 22,698 | ✅ | 11 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 13,559 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 420 | ❌ | 0 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 460 | ❌ | 0 | - |
...
| [session_coordination](tables/session_coordination.md) | 306 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 9,873 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 1,912 | ✅ | 2 | - |
...
| [srip_brand_interviews](tables/srip_brand_interviews.md) | 1 | ✅ | 4 | SRIP: Stores 12-question brand interview answers per venture. Some answers may be auto-populated from site DNA extraction. |
...
| [srip_site_dna](tables/srip_site_dna.md) | 4 | ✅ | 4 | SRIP: Stores extracted design DNA (tokens, layout, components) from reference site URLs for venture site replication. |
...
| [stage_events](tables/stage_events.md) | 6 | ✅ | 2 | - |
| [stage_executions](tables/stage_executions.md) | 30 | ✅ | 1 | Per-execution tracking for stage-execution-worker. Each row is one processStage() attempt with heartbeat for crash detection. |
...
| [stage_zero_requests](tables/stage_zero_requests.md) | 1 | ✅ | 4 | Work queue for async Stage 0 opportunity analysis. UI inserts pending rows; Claude Code CLI claims and processes them. |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 3,221 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 23,375 | ✅ | 4 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 12,879 | ✅ | 3 | - |
...
| [system_events](tables/system_events.md) | 2,246 | ✅ | 3 | Black Box audit log for all agent actions, state transitions, and resource consumption.
...
| [task_hydration_log](tables/task_hydration_log.md) | 2,252 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
| [taste_interaction_logs](tables/taste_interaction_logs.md) | 2 | ✅ | 1 | Append-only log of every taste gate decision. Source tag distinguishes active chairman decisions from timeout auto-proceeds. |
...
| [user_stories](tables/user_stories.md) | 9,032 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 57,385 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifacts](tables/venture_artifacts.md) | 81 | ✅ | 4 | - |
...
| [venture_briefs](tables/venture_briefs.md) | 1 | ✅ | 1 | Stage 0 output contract - structured brief produced by the synthesis engine that becomes Stage 1 input |
...
| [venture_financial_contract](tables/venture_financial_contract.md) | 1 | ✅ | 2 | - |
...
| [venture_gvos_profile](tables/venture_gvos_profile.md) | 1 | ✅ | 4 | GVOS Composer Layer 3: per-venture archetype selection + locked_prompt_snapshot + lovable_artifact. Chairman-owned via canonical RLS helpers. SD-GVOS-COMPOSER-SNAPSHOTLOCKED-REGISTRY-ORCH-001 FR-1. |
...
| [venture_persona_mapping](tables/venture_persona_mapping.md) | 3 | ✅ | 4 | Maps customer personas to ventures with a relevance score (0.00-1.00). |
...
| [venture_resources](tables/venture_resources.md) | 2 | ✅ | 2 | Unified registry of external resources per venture (SD-LEO-INFRA-UNIFIED-VENTURE-CREATION-001-B) |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 186 | ✅ | 3 | - |
...
| [venture_stage_transitions](tables/venture_stage_transitions.md) | 17 | ✅ | 1 | - |
| [venture_stage_work](tables/venture_stage_work.md) | 26 | ✅ | 5 | - |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 63 | ✅ | 4 | Golden Nugget: Token/compute investment tracking per venture |
| [venture_tool_quotas](tables/venture_tool_quotas.md) | 0 | ✅ | 1 | - |
| [ventures](tables/ventures.md) | 3 | ✅ | 2 | - |
...
| [vision_scoring_audit_log](tables/vision_scoring_audit_log.md) | 522 | ❌ | 0 | Audit trail for vision scoring gate evaluations with dynamic threshold context. SD-CONTEXTAWARE-VISION-SCORING-DYNAMIC-ORCH-001-A |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 937 | ✅ | 1 | - |
...
| [workflow_executions](tables/workflow_executions.md) | 3,041 | ✅ | 3 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 532,962 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

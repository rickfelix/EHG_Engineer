...
|-------|------|-----|----------|-------------|
| [_migration_metadata](tables/_migration_metadata.md) | 1 | ❌ | 0 | - |
...
| [agent_artifacts](tables/agent_artifacts.md) | 7,134 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 7,163 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 10,344 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 51 | ❌ | 0 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [brainstorm_sessions](tables/brainstorm_sessions.md) | 0 | ✅ | 2 | Tracks brainstorming sessions across domains (venture, protocol, integration, architecture) with outcome classification, quality metrics, and capability matching. Used for question effectiveness analysis and retrospective integration. |
...
| [chairman_preferences](tables/chairman_preferences.md) | 0 | ✅ | 4 | - |
...
| [claude_sessions](tables/claude_sessions.md) | 7,904 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
| [companies](tables/companies.md) | 90 | ✅ | 6 | - |
...
| [compliance_checks](tables/compliance_checks.md) | 10 | ✅ | 2 | Stores compliance check run history for the Always-On Compliance orchestrator |
...
| [compliance_violations](tables/compliance_violations.md) | 537 | ✅ | 3 | Stores individual compliance violations detected during checks |
...
| [connection_selection_log](tables/connection_selection_log.md) | 618 | ❌ | 0 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
| [connection_strategies](tables/connection_strategies.md) | 5 | ❌ | 0 | Ranked connection methods per service. Used by lib/connection-router.js to select optimal connection without trial-and-error. |
...
| [eva_idea_categories](tables/eva_idea_categories.md) | 16 | ✅ | 2 | - |
...
| [feedback](tables/feedback.md) | 27 | ✅ | 4 | - |
...
| [governance_audit_log](tables/governance_audit_log.md) | 81,094 | ✅ | 3 | - |
| [governance_policies](tables/governance_policies.md) | 0 | ✅ | 2 | - |
| [governance_proposals](tables/governance_proposals.md) | 2 | ✅ | 2 | - |
| [handoff_audit_log](tables/handoff_audit_log.md) | 6,344 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 125 | ✅ | 4 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [learning_decisions](tables/learning_decisions.md) | 63 | ✅ | 1 | Tracks all /learn command actions, findings, and user approvals to close the feedback loop on organizational learning. |
...
| [leo_error_log](tables/leo_error_log.md) | 10 | ✅ | 2 | LEO Protocol error log for critical failures that need operator attention. Part of SD-GENESIS-V32-PULSE resilience infrastructure. |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 3,100 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_planner_rankings](tables/leo_planner_rankings.md) | 4 | ✅ | 2 | Stores Central Planner output for stability tracking and audit |
...
| [leo_protocol_sections](tables/leo_protocol_sections.md) | 212 | ✅ | 4 | - |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 243 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [leo_sub_agent_triggers](tables/leo_sub_agent_triggers.md) | 477 | ✅ | 3 | - |
| [leo_sub_agents](tables/leo_sub_agents.md) | 30 | ✅ | 3 | - |
...
| [llm_canary_metrics](tables/llm_canary_metrics.md) | 0 | ❌ | 0 | Rolling window metrics. Consider BRIN index or partitioning for high volume. |
| [llm_canary_state](tables/llm_canary_state.md) | 1 | ❌ | 0 | - |
| [llm_canary_transitions](tables/llm_canary_transitions.md) | 0 | ❌ | 0 | - |
| [llm_models](tables/llm_models.md) | 9 | ✅ | 2 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 1,030 | ✅ | 3 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 155 | ❌ | 0 | - |
...
| [persona_config](tables/persona_config.md) | 3 | ❌ | 0 | Per-application persona validation rules. SD-MAN-GEN-TITLE-TARGET-APPLICATION-001 |
...
| [product_requirements_v2](tables/product_requirements_v2.md) | 779 | ✅ | 3 | Product Requirements Documents (PRDs) for Strategic Directives. Created by PLAN agent during PLAN_PRD phase. Contains comprehensive implementation specifications: requirements, architecture, testing, risks, and acceptance criteria. One PRD per SD (1:1 relationship via sd_uuid foreign key). |
...
| [protocol_constitution](tables/protocol_constitution.md) | 11 | ✅ | 4 | Immutable constitution rules for LEO self-improvement governance. Cannot be modified or deleted. |
...
| [quick_fixes](tables/quick_fixes.md) | 33 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [retro_notifications](tables/retro_notifications.md) | 1,130 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 903 | ✅ | 2 | - |
...
| [root_cause_reports](tables/root_cause_reports.md) | 66 | ✅ | 4 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 621 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_capabilities](tables/sd_capabilities.md) | 61 | ✅ | 2 | Junction table tracking which capabilities were registered/updated/deprecated by which Strategic Directives. Provides full audit trail. |
| [sd_checkpoint_history](tables/sd_checkpoint_history.md) | 0 | ✅ | 3 | RLS: Append-only for authenticated |
| [sd_claims](tables/sd_claims.md) | 2,437 | ✅ | 5 | Historical record of SD claims by sessions. Supports analytics and audit trail. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 138 | ❌ | 0 | - |
...
| [sd_gate_results](tables/sd_gate_results.md) | 1 | ✅ | 1 | LEO 5.0 Gate results - tracks individual gate validation outcomes |
| [sd_governance_bypass_audit](tables/sd_governance_bypass_audit.md) | 313 | ✅ | 2 | Audit trail for governance trigger bypasses.
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 5,798 | ✅ | 8 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 4,284 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_workflow_template_steps](tables/sd_workflow_template_steps.md) | 70 | ✅ | 2 | SD-LEO-INFRA-WORKFLOW-TEMPLATES-TYPE-001: Ordered steps with weights for each workflow template |
...
| [self_audit_findings](tables/self_audit_findings.md) | 0 | ❌ | 0 | Stores findings from LEO self-discovery routines (SD-LEO-SELF-IMPROVE-002B) |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 1,700 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
| [shipping_decisions](tables/shipping_decisions.md) | 411 | ✅ | 2 | - |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 900 | ✅ | 4 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 14,863 | ✅ | 4 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
| [sub_agent_execution_results_archive](tables/sub_agent_execution_results_archive.md) | 2,036 | ✅ | 4 | - |
| [sub_agent_executions](tables/sub_agent_executions.md) | 102 | ✅ | 2 | - |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 6,495 | ✅ | 3 | - |
...
| [task_hydration_log](tables/task_hydration_log.md) | 548 | ✅ | 1 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [telemetry_analysis_runs](tables/telemetry_analysis_runs.md) | 1 | ✅ | 2 | Tracks lifecycle of telemetry auto-analysis runs (QUEUED->RUNNING->SUCCEEDED/FAILED/TIMED_OUT) |
...
| [test_default](tables/test_default.md) | 0 | ❌ | 0 | - |
| [test_minimal](tables/test_minimal.md) | 0 | ❌ | 0 | - |
...
| [test_runs](tables/test_runs.md) | 8 | ✅ | 4 | Immutable test execution records. Part of unified test evidence architecture (LEO v4.3.4) |
...
| [uat_test_results](tables/uat_test_results.md) | 0 | ✅ | 1 | - |
| [uat_test_runs](tables/uat_test_runs.md) | 0 | ✅ | 1 | - |
...
| [user_stories](tables/user_stories.md) | 2,818 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 31,070 | ✅ | 3 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
| [validation_evidence](tables/validation_evidence.md) | 0 | ✅ | 2 | - |
| [validation_gate_registry](tables/validation_gate_registry.md) | 57 | ✅ | 2 | Database-first policy for validation gate applicability per SD type and validation profile. Part of SD-LEO-INFRA-VALIDATION-GATE-REGISTRY-001. |
...
| [ventures](tables/ventures.md) | 6 | ✅ | 5 | - |
...
| [view_definitions_backup_20260124](tables/view_definitions_backup_20260124.md) | 10 | ❌ | 0 | - |
...
| [workflow_trace_log](tables/workflow_trace_log.md) | 7,624 | ✅ | 1 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

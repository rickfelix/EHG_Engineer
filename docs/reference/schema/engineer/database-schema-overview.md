...
| [agent_artifacts](tables/agent_artifacts.md) | 6,322 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 6,330 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 8,787 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [claude_sessions](tables/claude_sessions.md) | 7,238 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [connection_selection_log](tables/connection_selection_log.md) | 8 | ❌ | 0 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 76,467 | ✅ | 3 | - |
| [governance_policies](tables/governance_policies.md) | 0 | ✅ | 2 | - |
| [governance_proposals](tables/governance_proposals.md) | 2 | ✅ | 2 | - |
| [handoff_audit_log](tables/handoff_audit_log.md) | 5,664 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 64 | ✅ | 4 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [learning_decisions](tables/learning_decisions.md) | 33 | ✅ | 1 | Tracks all /learn command actions, findings, and user approvals to close the feedback loop on organizational learning. |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 2,609 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [model_usage_log](tables/model_usage_log.md) | 957 | ✅ | 3 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 47 | ❌ | 0 | - |
...
| [product_requirements_v2](tables/product_requirements_v2.md) | 670 | ✅ | 3 | Product Requirements Documents (PRDs) for Strategic Directives. Created by PLAN agent during PLAN_PRD phase. Contains comprehensive implementation specifications: requirements, architecture, testing, risks, and acceptance criteria. One PRD per SD (1:1 relationship via sd_uuid foreign key). |
...
| [retro_notifications](tables/retro_notifications.md) | 1,014 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 791 | ✅ | 2 | - |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 492 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_claims](tables/sd_claims.md) | 2,282 | ✅ | 5 | Historical record of SD claims by sessions. Supports analytics and audit trail. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 41 | ❌ | 0 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 5,241 | ✅ | 8 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 3,641 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 754 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
| [shipping_decisions](tables/shipping_decisions.md) | 240 | ✅ | 2 | - |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 772 | ✅ | 4 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 13,575 | ✅ | 4 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 5,691 | ✅ | 3 | - |
...
| [task_hydration_log](tables/task_hydration_log.md) | 448 | ✅ | 1 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 2,490 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |

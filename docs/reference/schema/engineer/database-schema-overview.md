...
**Generated**: 2026-04-16T00:04:47.437Z
**Tables**: 644
...
| [audit_log](tables/audit_log.md) | 2,763 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [chairman_decisions](tables/chairman_decisions.md) | 0 | ✅ | 2 | SD-HARDENING-V1-001: Chairman-only decision records.
...
| [customer_personas](tables/customer_personas.md) | 102 | ✅ | 2 | Canonical customer persona catalog. Personas can be venture-specific (source_venture_id) or global (canonical_id IS NULL). |
...
| [eva_scheduler_queue](tables/eva_scheduler_queue.md) | 0 | ✅ | 2 | - |
...
| [eva_ventures](tables/eva_ventures.md) | 0 | ✅ | 2 | EVA Operating System - Venture tracking with health metrics |
| [eva_vision_documents](tables/eva_vision_documents.md) | 203 | ✅ | 2 | Stores EHG portfolio (L1) and venture-specific (L2) vision documents for the EVA Vision Governance System. L2 visions link to L1 via parent_vision_id. |
...
| [evaluation_profile_outcomes](tables/evaluation_profile_outcomes.md) | 104 | ✅ | 2 | Per-gate survival signals linking evaluation profile+version to venture outcomes at tracked boundaries |
...
| [feedback](tables/feedback.md) | 314 | ✅ | 8 | - |
...
| [governance_audit_log](tables/governance_audit_log.md) | 166,240 | ✅ | 2 | - |
...
| [leo_adrs](tables/leo_adrs.md) | 378 | ✅ | 2 | - |
...
| [mental_model_applications](tables/mental_model_applications.md) | 490 | ✅ | 4 | Tracks which models were applied to which ventures at which stages |
...
| [model_usage_log](tables/model_usage_log.md) | 16,607 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [stage_executions](tables/stage_executions.md) | 0 | ✅ | 1 | Per-execution tracking for stage-execution-worker. Each row is one processStage() attempt with heartbeat for crash detection. |
...
| [stage_zero_requests](tables/stage_zero_requests.md) | 0 | ✅ | 4 | Work queue for async Stage 0 opportunity analysis. UI inserts pending rows; Claude Code CLI claims and processes them. |
...
| [validation_audit_log](tables/validation_audit_log.md) | 53,621 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifacts](tables/venture_artifacts.md) | 0 | ✅ | 4 | - |
...
| [venture_stage_work](tables/venture_stage_work.md) | 0 | ✅ | 5 | - |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 30 | ✅ | 4 | Golden Nugget: Token/compute investment tracking per venture |
| [venture_tool_quotas](tables/venture_tool_quotas.md) | 0 | ✅ | 1 | - |
| [ventures](tables/ventures.md) | 0 | ✅ | 2 | - |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 588 | ✅ | 1 | - |
| [workflow_checkpoints](tables/workflow_checkpoints.md) | 2 | ✅ | 2 | Stores workflow state checkpoints for recovery |
| [workflow_executions](tables/workflow_executions.md) | 2,854 | ✅ | 3 | - |

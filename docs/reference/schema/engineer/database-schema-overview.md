...
| [claude_sessions](tables/claude_sessions.md) | 11,192 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 149,345 | ✅ | 2 | - |
...
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 5,215 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |

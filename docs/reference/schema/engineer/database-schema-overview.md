...
| [agent_artifacts](tables/agent_artifacts.md) | 16,322 | ✅ | 2 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 16,401 | ✅ | 2 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 32,084 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 144,316 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [chairman_decisions](tables/chairman_decisions.md) | 45 | ✅ | 2 | SD-HARDENING-V1-001: Chairman-only decision records.
...
| [claude_sessions](tables/claude_sessions.md) | 12,747 | ✅ | 3 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 596 | ✅ | 2 | - |
| [codebase_semantic_index](tables/codebase_semantic_index.md) | 0 | ✅ | 2 | - |
| [companies](tables/companies.md) | 1,303 | ✅ | 5 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 4,877 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [coordination_events](tables/coordination_events.md) | 2 | ❌ | 0 | epic #4 (SD-LEO-INFRA-COORDINATION-OBSERVABILITY-ANOMALY-001): structured fleet-coordination anomaly events from the read-only detectors; written only when COORD_DETECTORS_V2 is enabled. |
...
| [design_quality_scores](tables/design_quality_scores.md) | 491 | ✅ | 1 | Aggregated per-SD design quality scores from design-agent results. Composite formula: 35% accessibility + 25% token compliance + 20% component reuse + 20% visual polish. |
...
| [eva_architecture_plans](tables/eva_architecture_plans.md) | 234 | ✅ | 2 | Architecture Plans linked to Vision documents. ON DELETE RESTRICT on vision_id prevents deleting a vision that has architecture plans. |
...
| [eva_consultant_recommendations](tables/eva_consultant_recommendations.md) | 535 | ✅ | 2 | Actionable recommendations generated by EVA trend analysis for chairman review |
...
| [eva_interactions](tables/eva_interactions.md) | 15,417 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
| [eva_orchestration_events](tables/eva_orchestration_events.md) | 9 | ✅ | 1 | EVA orchestration lifecycle events for Chairman Dashboard Event Feed. Real-time enabled. |
...
| [eva_scheduler_metrics](tables/eva_scheduler_metrics.md) | 4,486 | ✅ | 2 | - |
| [eva_scheduler_metrics_qparity20260610](tables/eva_scheduler_metrics_qparity20260610.md) | 995 | ❌ | 0 | - |
| [eva_scheduler_queue](tables/eva_scheduler_queue.md) | 6 | ✅ | 2 | - |
...
| [eva_updates](tables/eva_updates.md) | 4 | ✅ | 1 | Stores EVA weekly meeting updates including section reports, coordinator status, decisions, and chairman notes |
...
| [eva_ventures](tables/eva_ventures.md) | 6 | ✅ | 2 | EVA Operating System - Venture tracking with health metrics |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 4,034 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [eva_youtube_scans](tables/eva_youtube_scans.md) | 60 | ✅ | 1 | Daily scan metadata for EVA YouTube Subscription Digest - tracks each automated scan run |
| [eva_youtube_scores](tables/eva_youtube_scores.md) | 2,757 | ✅ | 1 | Per-video relevance scores from EVA scoring of YouTube subscription content |
...
| [execute_teams](tables/execute_teams.md) | 7 | ✅ | 2 | Multi-session execution teams spawned by /execute command. One row per team; status tracks lifecycle pending_spawn → active → stopping → stopped/crashed/completed. metadata.slots[] persists callsign/color across worker respawns. |
...
| [feedback](tables/feedback.md) | 2,098 | ✅ | 8 | - |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 11,812 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 559,009 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 25,323 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 1,333 | ✅ | 2 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [leo_feature_flag_audit](tables/leo_feature_flag_audit.md) | 876 | ✅ | 2 | Immutable audit log for all feature flag changes |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 15,516 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_lint_run_history](tables/leo_lint_run_history.md) | 54 | ✅ | 1 | Append-only log of every linter run. trigger=bypass rows track --skip-lint invocations for rate-limiting (3/week) and chairman dashboard reporting. SD-PROTOCOL-LINTER-001. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 2,191 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [management_reviews](tables/management_reviews.md) | 1 | ✅ | 2 | - |
...
| [marketing_pipeline_runs](tables/marketing_pipeline_runs.md) | 0 | ✅ | 2 | Per-invocation audit for marketing orchestrator pipelines. Append-only. UNIQUE(invocation_id) prevents duplicate audit rows on retry. Added by SD-EHG-MARKETING-DISTRIBUTION-INFRASTRUCTURE-ORCH-001-A. |
...
| [model_usage_log](tables/model_usage_log.md) | 50,227 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [okr_snapshots](tables/okr_snapshots.md) | 30 | ✅ | 2 | Point-in-time snapshots of key result progress for trend tracking |
...
| [outcome_signals](tables/outcome_signals.md) | 2,239 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 41,689 | ✅ | 1 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [quick_fixes](tables/quick_fixes.md) | 508 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [retro_notifications](tables/retro_notifications.md) | 3,369 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 5,676 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 8,768 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 1,824 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [root_cause_reports](tables/root_cause_reports.md) | 1,142 | ✅ | 2 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_backlog_map](tables/sd_backlog_map.md) | 130 | ✅ | 2 | - |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 8,448 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_burn_rate_snapshots](tables/sd_burn_rate_snapshots.md) | 4 | ✅ | 2 | Periodic snapshots of velocity metrics for trending and forecasting. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 1,993 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 24,481 | ✅ | 6 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 15,702 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 759 | ✅ | 1 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 1,233 | ✅ | 1 | - |
...
| [session_coordination](tables/session_coordination.md) | 2,367 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 22,206 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 2,574 | ✅ | 2 | - |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 3,733 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 27,751 | ✅ | 2 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 15,647 | ✅ | 3 | - |
...
| [system_events](tables/system_events.md) | 10,172 | ✅ | 3 | Black Box audit log for all agent actions, state transitions, and resource consumption.
...
| [task_hydration_log](tables/task_hydration_log.md) | 3,470 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 10,753 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 19,899 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifacts](tables/venture_artifacts.md) | 256 | ✅ | 4 | - |
...
| [venture_quality_findings](tables/venture_quality_findings.md) | 13 | ✅ | 2 | Canonical persistence layer for Stage 20 Unified Quality Lifecycle Loop. SD-LEO-ORCH-QUALITY-LIFECYCLE-LOOP-001-B. |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 1,696 | ✅ | 1 | - |
...
| [venture_stage_transitions](tables/venture_stage_transitions.md) | 74 | ✅ | 1 | - |
...
| [venture_stages_audit](tables/venture_stages_audit.md) | 591 | ✅ | 2 | SD-LEO-INFRA-UNIFY-VENTURE-STAGE-001-A: append-only audit of venture_stages column changes. Mirrors stage_config_audit. |
...
| [ventures](tables/ventures.md) | 6 | ✅ | 2 | - |
...
| [workflow_trace_log](tables/workflow_trace_log.md) | 508,942 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

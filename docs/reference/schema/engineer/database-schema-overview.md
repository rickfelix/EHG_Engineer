...
**Generated**: 2026-06-28T20:42:00.853Z
**Tables**: 750
...
| [adam_adherence_ledger](tables/adam_adherence_ledger.md) | 255 | ✅ | 2 | Durable ledger of Adam recurring self-adherence audit runs/findings (SD-LEO-INFRA-AUTOMATED-RECURRING-ADAM-001). One row per probe per run; remediation_ref set when a fail sourced a propose-only remediation. |
...
| [agent_artifacts](tables/agent_artifacts.md) | 19,582 | ✅ | 2 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 19,662 | ✅ | 2 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 36,778 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 185,532 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [brainstorm_sessions](tables/brainstorm_sessions.md) | 2,577 | ✅ | 2 | Tracks brainstorming sessions across domains (venture, protocol, integration, architecture) with outcome classification, quality metrics, and capability matching. Used for question effectiveness analysis and retrospective integration. |
...
| [brand_genome_submissions](tables/brand_genome_submissions.md) | 7 | ✅ | 5 | Brand identity genome for ventures ensuring marketing consistency |
| [brand_variants](tables/brand_variants.md) | 0 | ✅ | 2 | - |
| [build_completion_forecast_log](tables/build_completion_forecast_log.md) | 155 | ✅ | 2 | SD-LEO-INFRA-BUILD-COMPLETION-FORECAST-001 FR-2/FR-3: append-only forecast runs + assumptions + prior-vs-actual error, for audit + self-correction. Dormant-safe: forecaster fail-soft dry-runs when absent. |
| [bypass_ledger](tables/bypass_ledger.md) | 13 | ✅ | 1 | Sibling A (SD-WRITERCONSUMER-...-001-A) — insert-only ledger of every bypass event with audit_log pairing. RLS denies UPDATE/DELETE. TEXT bypass_type + advisory trigger (NOT ENUM) for future vocab additions. |
...
| [cascade_invalidation_log](tables/cascade_invalidation_log.md) | 104 | ✅ | 2 | - |
...
| [chairman_dashboard_config_audit](tables/chairman_dashboard_config_audit.md) | 0 | ✅ | 1 | Append-only audit log for chairman_dashboard_config governance changes. Mirrors stage_config_audit. Source: SD-LEO-REFAC-GATE-AUTO-ADVANCE-001 FR-1. |
| [chairman_decision_audit](tables/chairman_decision_audit.md) | 14 | ✅ | 1 | - |
| [chairman_decisions](tables/chairman_decisions.md) | 79 | ✅ | 2 | SD-HARDENING-V1-001: Chairman-only decision records.
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 1,004 | ✅ | 2 | - |
...
| [competitors](tables/competitors.md) | 18 | ✅ | 5 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 6,913 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [coordination_events](tables/coordination_events.md) | 126 | ✅ | 3 | epic #4 (SD-LEO-INFRA-COORDINATION-OBSERVABILITY-ANOMALY-001): structured fleet-coordination anomaly events from the read-only detectors; written only when COORD_DETECTORS_V2 is enabled. |
...
| [customer_personas](tables/customer_personas.md) | 201 | ✅ | 2 | Canonical customer persona catalog. Personas can be venture-specific (source_venture_id) or global (canonical_id IS NULL). |
...
| [design_quality_scores](tables/design_quality_scores.md) | 913 | ✅ | 1 | Aggregated per-SD design quality scores from design-agent results. Composite formula: 35% accessibility + 25% token compliance + 20% component reuse + 20% visual polish. |
...
| [eva_event_log](tables/eva_event_log.md) | 30 | ✅ | 2 | - |
...
| [eva_interactions](tables/eva_interactions.md) | 18,260 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_scheduler_queue](tables/eva_scheduler_queue.md) | 14 | ✅ | 2 | - |
...
| [eva_stage_gate_results](tables/eva_stage_gate_results.md) | 1,156 | ✅ | 2 | Tracks EVA gate evaluations with kill gate enforcement (stages 3,5,13,23 require 70% score) |
...
| [eva_venture_config](tables/eva_venture_config.md) | 1 | ✅ | 1 | Per-venture EVA feature flag and config overrides. Modeled on db_agent_config. Use key='<scope>.<flag_name>' (e.g. 'vision_repair_loop_enabled') with value as JSONB boolean or object. For per-venture scoping, use composite keys like 'venture:<uuid>:vision_repair_loop_enabled'. |
| [eva_ventures](tables/eva_ventures.md) | 14 | ✅ | 2 | EVA Operating System - Venture tracking with health metrics |
| [eva_ventures_qparity20260610](tables/eva_ventures_qparity20260610.md) | 3 | ❌ | 0 | - |
| [eva_vision_documents](tables/eva_vision_documents.md) | 277 | ✅ | 2 | Stores EHG portfolio (L1) and venture-specific (L2) vision documents for the EVA Vision Governance System. L2 visions link to L1 via parent_vision_id. |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 4,889 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [eva_youtube_scans](tables/eva_youtube_scans.md) | 78 | ✅ | 1 | Daily scan metadata for EVA YouTube Subscription Digest - tracks each automated scan run |
| [eva_youtube_scores](tables/eva_youtube_scores.md) | 3,565 | ✅ | 1 | Per-video relevance scores from EVA scoring of YouTube subscription content |
...
| [factory_guardrail_state](tables/factory_guardrail_state.md) | 2 | ✅ | 1 | CRO guardrail state per venture for Software Factory self-healing loop |
...
| [feedback](tables/feedback.md) | 4,504 | ✅ | 8 | - |
...
| [financial_models](tables/financial_models.md) | 6 | ✅ | 3 | Venture capital financial models with templates (SaaS, marketplace, etc.) |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 26,817 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
| [fleet_worker_pulse](tables/fleet_worker_pulse.md) | 12 | ✅ | 0 | 15-min active-vs-not fleet-worker samples; chairman exec email averages the last hour. SD: chairman exec-email redesign 2026-06-14. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 457,929 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 30,329 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 1,460 | ✅ | 2 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [leo_adrs](tables/leo_adrs.md) | 630 | ✅ | 2 | - |
...
| [leo_feature_flag_audit](tables/leo_feature_flag_audit.md) | 3,244 | ✅ | 2 | Immutable audit log for all feature flag changes |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 18,490 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 3,265 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [mental_model_applications](tables/mental_model_applications.md) | 790 | ✅ | 2 | Tracks which models were applied to which ventures at which stages |
...
| [model_usage_log](tables/model_usage_log.md) | 52,221 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [naming_suggestions](tables/naming_suggestions.md) | 25 | ✅ | 2 | - |
...
| [outcome_signals](tables/outcome_signals.md) | 2,715 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 45,925 | ✅ | 1 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [quick_fixes](tables/quick_fixes.md) | 550 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [rd_batch_runs](tables/rd_batch_runs.md) | 14 | ✅ | 2 | - |
...
| [retro_notifications](tables/retro_notifications.md) | 3,855 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 6,647 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 10,046 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 2,324 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [risk_recalibration_forms](tables/risk_recalibration_forms.md) | 6 | ✅ | 2 | SD-LIFECYCLE-GAP-005: Risk re-calibration forms at phase boundary gates (Gates 3, 4, 5, 6) |
...
| [sd_baseline_items](tables/sd_baseline_items.md) | 20,509 | ✅ | 1 | Individual SD assignments within a baseline, including track assignment, sequence, and effort estimates. |
...
| [sd_capabilities](tables/sd_capabilities.md) | 218 | ✅ | 3 | Junction table tracking which capabilities were registered/updated/deprecated by which Strategic Directives. Provides full audit trail. |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 2,464 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 29,482 | ✅ | 6 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 18,294 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 1,268 | ✅ | 1 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 1,919 | ✅ | 1 | - |
...
| [session_coordination](tables/session_coordination.md) | 8,808 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 35,659 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 3,522 | ✅ | 2 | - |
...
| [srip_brand_interviews](tables/srip_brand_interviews.md) | 5 | ✅ | 4 | SRIP: Stores 12-question brand interview answers per venture. Some answers may be auto-populated from site DNA extraction. |
...
| [srip_site_dna](tables/srip_site_dna.md) | 8 | ✅ | 4 | SRIP: Stores extracted design DNA (tokens, layout, components) from reference site URLs for venture site replication. |
...
| [stage_events](tables/stage_events.md) | 32 | ✅ | 2 | - |
| [stage_executions](tables/stage_executions.md) | 2,870 | ✅ | 1 | Per-execution tracking for stage-execution-worker. Each row is one processStage() attempt with heartbeat for crash detection. |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 4,488 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 33,005 | ✅ | 2 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 18,896 | ✅ | 3 | - |
...
| [system_events](tables/system_events.md) | 12,233 | ✅ | 3 | Black Box audit log for all agent actions, state transitions, and resource consumption.
...
| [task_hydration_log](tables/task_hydration_log.md) | 5,276 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 12,363 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 13,365 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifact_summaries](tables/venture_artifact_summaries.md) | 142 | ✅ | 1 | Cached LLM-generated summaries of venture artifacts. Used by enrichment pipeline Pass 1 to avoid redundant LLM calls. |
| [venture_artifact_summaries_qparity20260610](tables/venture_artifact_summaries_qparity20260610.md) | 0 | ❌ | 0 | - |
| [venture_artifacts](tables/venture_artifacts.md) | 340 | ✅ | 4 | - |
...
| [venture_briefs](tables/venture_briefs.md) | 4 | ✅ | 1 | Stage 0 output contract - structured brief produced by the synthesis engine that becomes Stage 1 input |
...
| [venture_financial_contract](tables/venture_financial_contract.md) | 6 | ✅ | 2 | - |
...
| [venture_gvos_profile](tables/venture_gvos_profile.md) | 4 | ✅ | 4 | GVOS Composer Layer 3: per-venture archetype selection + locked_prompt_snapshot + lovable_artifact. Chairman-owned via canonical RLS helpers. SD-GVOS-COMPOSER-SNAPSHOTLOCKED-REGISTRY-ORCH-001 FR-1. |
...
| [venture_persona_mapping](tables/venture_persona_mapping.md) | 15 | ✅ | 4 | Maps customer personas to ventures with a relevance score (0.00-1.00). |
...
| [venture_resources](tables/venture_resources.md) | 15 | ✅ | 2 | Unified registry of external resources per venture (SD-LEO-INFRA-UNIFIED-VENTURE-CREATION-001-B) |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 3,834 | ✅ | 1 | - |
...
| [venture_stage_transitions](tables/venture_stage_transitions.md) | 106 | ✅ | 1 | - |
| [venture_stage_transitions_qparity20260610](tables/venture_stage_transitions_qparity20260610.md) | 4 | ❌ | 0 | - |
| [venture_stage_work](tables/venture_stage_work.md) | 117 | ✅ | 5 | - |
...
| [venture_stages_audit](tables/venture_stages_audit.md) | 2,693 | ✅ | 2 | SD-LEO-INFRA-UNIFY-VENTURE-STAGE-001-A: append-only audit of venture_stages column changes. Mirrors stage_config_audit. |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 3,274 | ✅ | 2 | Golden Nugget: Token/compute investment tracking per venture |
| [venture_tool_quotas](tables/venture_tool_quotas.md) | 0 | ✅ | 1 | - |
| [ventures](tables/ventures.md) | 14 | ✅ | 2 | - |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 1,136 | ✅ | 1 | - |
...
| [workflow_executions](tables/workflow_executions.md) | 6,953 | ✅ | 2 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 575,305 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

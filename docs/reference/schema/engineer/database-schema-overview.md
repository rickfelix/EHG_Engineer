...
| [agent_artifacts](tables/agent_artifacts.md) | 14,439 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 14,517 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 29,091 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [applications](tables/applications.md) | 11 | ❌ | 0 | Canonical registry of valid target_application routing values (platform repos + ventures). SD-LEO-INFRA-RECONCILE-VENTURE-BUILD-001 FR-5. Backs vw_venture_registry + applications/registry.json. |
...
| [audit_log](tables/audit_log.md) | 96,202 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [backup_leo_feature_flag_audit](tables/backup_leo_feature_flag_audit.md) | 12 | ❌ | 0 | - |
| [backup_leo_feature_flag_audit_log](tables/backup_leo_feature_flag_audit_log.md) | 6 | ❌ | 0 | - |
| [backup_leo_sub_agent_handoffs](tables/backup_leo_sub_agent_handoffs.md) | 1 | ❌ | 0 | - |
| [backup_leo_subagent_handoffs](tables/backup_leo_subagent_handoffs.md) | 1 | ❌ | 0 | - |
...
| [brainstorm_sessions](tables/brainstorm_sessions.md) | 1,750 | ✅ | 2 | Tracks brainstorming sessions across domains (venture, protocol, integration, architecture) with outcome classification, quality metrics, and capability matching. Used for question effectiveness analysis and retrospective integration. |
...
| [chairman_dashboard_config_audit](tables/chairman_dashboard_config_audit.md) | 0 | ❌ | 0 | Append-only audit log for chairman_dashboard_config governance changes. Mirrors stage_config_audit. Source: SD-LEO-REFAC-GATE-AUTO-ADVANCE-001 FR-1. |
| [chairman_decision_audit](tables/chairman_decision_audit.md) | 8 | ❌ | 0 | - |
...
| [claude_sessions](tables/claude_sessions.md) | 12,611 | ✅ | 4 | Tracks active Claude Code sessions for multi-instance coordination. Sessions auto-register and update heartbeat on sd:next/sd:claim. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 394 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 3,681 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [deep_research_budget](tables/deep_research_budget.md) | 2 | ❌ | 0 | Daily budget tracking for deep research API calls per provider |
| [deep_research_results](tables/deep_research_results.md) | 2 | ❌ | 0 | Stores results from deep research API calls (extended thinking mode) |
...
| [design_reference_library](tables/design_reference_library.md) | 137 | ❌ | 0 | - |
...
| [eva_audit_log](tables/eva_audit_log.md) | 1,028 | ✅ | 3 | EVA Audit Trail - All actions logged |
...
| [eva_consultant_recommendations](tables/eva_consultant_recommendations.md) | 431 | ✅ | 2 | Actionable recommendations generated by EVA trend analysis for chairman review |
...
| [eva_interactions](tables/eva_interactions.md) | 14,010 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_stage_gate_results](tables/eva_stage_gate_results.md) | 1,216 | ✅ | 2 | Tracks EVA gate evaluations with kill gate enforcement (stages 3,5,13,23 require 70% score) |
...
| [eva_venture_config](tables/eva_venture_config.md) | 1 | ❌ | 0 | Per-venture EVA feature flag and config overrides. Modeled on db_agent_config. Use key='<scope>.<flag_name>' (e.g. 'vision_repair_loop_enabled') with value as JSONB boolean or object. For per-venture scoping, use composite keys like 'venture:<uuid>:vision_repair_loop_enabled'. |
...
| [eva_vision_rubric_cache](tables/eva_vision_rubric_cache.md) | 0 | ❌ | 0 | SD-LEO-INFRA-VENTURE-RUBRIC-SEMANTIC-001: LLM-generated venture rubrics cached by SHA-256(vision_key+plan_key+both content_hashes). Stale-but-keyed acceptable; content_hash is the freshness signal. EHG self-scoring uses the static rubric library and never touches this table. |
| [eva_vision_scores](tables/eva_vision_scores.md) | 3,722 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [eva_youtube_scans](tables/eva_youtube_scans.md) | 50 | ✅ | 3 | Daily scan metadata for EVA YouTube Subscription Digest - tracks each automated scan run |
| [eva_youtube_scores](tables/eva_youtube_scores.md) | 2,251 | ✅ | 3 | Per-video relevance scores from EVA scoring of YouTube subscription content |
...
| [factory_guardrail_state](tables/factory_guardrail_state.md) | 2 | ❌ | 0 | CRO guardrail state per venture for Software Factory self-healing loop |
| [failure_patterns](tables/failure_patterns.md) | 10 | ✅ | 2 | - |
| [feedback](tables/feedback.md) | 1,387 | ✅ | 8 | - |
...
| [gate_failure_patterns](tables/gate_failure_patterns.md) | 0 | ❌ | 0 | Tracks recurring gate failure patterns and links to issue_patterns for learning |
| [gate_health_history](tables/gate_health_history.md) | 0 | ❌ | 0 | Weekly snapshots of gate health for trend analysis |
...
| [governance_audit_log](tables/governance_audit_log.md) | 453,593 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 24,096 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [learning_runs](tables/learning_runs.md) | 0 | ❌ | 0 | SD-LEARN-FIX-ADDRESS-PAT-AGENT-001: tracks /learn executions per SD. Consumed by LEARNING_OR_BYPASS_RESOLVED gate at LEAD-FINAL-APPROVAL to verify /learn ran when bypass was used. |
...
| [leo_error_log](tables/leo_error_log.md) | 257 | ✅ | 2 | LEO Protocol error log for critical failures that need operator attention. Part of SD-GENESIS-V32-PULSE resilience infrastructure. |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 14,062 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_lint_rules](tables/leo_lint_rules.md) | 12 | ❌ | 0 | Registry of protocol-lint rules. Severity defaults to warn; promotion to block requires 2+ clean regens (see /admin/protocol-lint). SD-PROTOCOL-LINTER-001. |
| [leo_lint_run_history](tables/leo_lint_run_history.md) | 41 | ❌ | 0 | Append-only log of every linter run. trigger=bypass rows track --skip-lint invocations for rate-limiting (3/week) and chairman dashboard reporting. SD-PROTOCOL-LINTER-001. |
| [leo_lint_violations](tables/leo_lint_violations.md) | 0 | ❌ | 0 | Append-only audit of every violation produced by the protocol linter. status=false_positive flags rules for review when FP rate exceeds 10%. SD-PROTOCOL-LINTER-001. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 1,569 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [leo_wiring_validations](tables/leo_wiring_validations.md) | 40 | ✅ | 1 | Persistent store of LEO Wiring Verification Framework detector outputs. Mirrors eva_vision_documents.quality_checked pattern — detector writes, trigger derives strategic_directives_v2.wiring_validated, handoff gate queries derived column. SD: SD-LEO-WIRING-VERIFICATION-FRAMEWORK-ORCH-001-D. |
...
| [management_reviews](tables/management_reviews.md) | 31,499 | ✅ | 2 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 42,022 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 1,983 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 33,539 | ❌ | 0 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [provider_rotation_state](tables/provider_rotation_state.md) | 1 | ❌ | 0 | Single-row table tracking current position in Latin-square provider rotation |
| [provider_seat_assignments](tables/provider_seat_assignments.md) | 0 | ❌ | 0 | Audit trail of provider/model assignments per board seat per deliberation session |
| [public_portfolio](tables/public_portfolio.md) | 0 | ✅ | 4 | - |
| [quick_fixes](tables/quick_fixes.md) | 436 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [rd_batch_runs](tables/rd_batch_runs.md) | 10 | ✅ | 2 | - |
...
| [retro_notifications](tables/retro_notifications.md) | 3,111 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 7,011 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 3,819 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 1,496 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 1,747 | ✅ | 1 | - |
...
| [sd_metadata_audit_log](tables/sd_metadata_audit_log.md) | 0 | ❌ | 0 | Immutable audit trail for governance metadata mutations on strategic_directives_v2. Board of Directors requirement (CISO). |
| [sd_overlap_analysis](tables/sd_overlap_analysis.md) | 641 | ✅ | 2 | Stores overlap analysis results between strategic directives |
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 23,254 | ✅ | 11 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 14,269 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 522 | ❌ | 0 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 737 | ❌ | 0 | - |
...
| [security_audit_events_2026_05](tables/security_audit_events_2026_05.md) | null | ❌ | 0 | - |
| [security_audit_events_2026_06](tables/security_audit_events_2026_06.md) | null | ❌ | 0 | - |
| [security_audit_events_2026_07](tables/security_audit_events_2026_07.md) | null | ❌ | 0 | - |
| [security_audit_events_2026_08](tables/security_audit_events_2026_08.md) | null | ❌ | 0 | - |
| [security_audit_events_2026_09](tables/security_audit_events_2026_09.md) | null | ❌ | 0 | - |
| [security_audit_events_2026_10](tables/security_audit_events_2026_10.md) | null | ❌ | 0 | - |
| [security_audit_events_2026_11](tables/security_audit_events_2026_11.md) | null | ❌ | 0 | - |
| [security_audit_events_2026_12](tables/security_audit_events_2026_12.md) | null | ❌ | 0 | - |
| [security_audit_events_2027_01](tables/security_audit_events_2027_01.md) | null | ❌ | 0 | - |
| [security_audit_events_2027_02](tables/security_audit_events_2027_02.md) | null | ❌ | 0 | - |
| [security_audit_events_2027_03](tables/security_audit_events_2027_03.md) | null | ❌ | 0 | - |
| [security_audit_events_2027_04](tables/security_audit_events_2027_04.md) | null | ❌ | 0 | - |
| [security_audit_events_2027_05](tables/security_audit_events_2027_05.md) | null | ❌ | 0 | - |
...
| [service_versions](tables/service_versions.md) | 1 | ❌ | 0 | - |
| [session_coordination](tables/session_coordination.md) | 518 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 14,028 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
| [ship_review_findings](tables/ship_review_findings.md) | 72 | ❌ | 0 | Audit trail for /ship review gate findings. Every PR gets a record with tier, score, and finding details. |
| [shipping_decisions](tables/shipping_decisions.md) | 2,104 | ✅ | 2 | - |
...
| [stage_artifact_requirements](tables/stage_artifact_requirements.md) | 26 | ❌ | 0 | Per-stage artifact preconditions checked by fn_advance_venture_stage before allowing advancement |
| [stage_data_contracts](tables/stage_data_contracts.md) | 2 | ✅ | 2 | - |
| [stage_events](tables/stage_events.md) | 16 | ✅ | 2 | - |
| [stage_executions](tables/stage_executions.md) | 596 | ✅ | 1 | Per-execution tracking for stage-execution-worker. Each row is one processStage() attempt with heartbeat for crash detection. |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 3,364 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 24,730 | ✅ | 4 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 13,776 | ✅ | 3 | - |
...
| [system_events](tables/system_events.md) | 2,278 | ✅ | 3 | Black Box audit log for all agent actions, state transitions, and resource consumption.
...
| [task_hydration_log](tables/task_hydration_log.md) | 2,651 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 9,624 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 58,080 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_artifact_summaries](tables/venture_artifact_summaries.md) | 34 | ❌ | 0 | Cached LLM-generated summaries of venture artifacts. Used by enrichment pipeline Pass 1 to avoid redundant LLM calls. |
| [venture_artifacts](tables/venture_artifacts.md) | 782 | ✅ | 4 | - |
...
| [venture_briefs](tables/venture_briefs.md) | 25 | ✅ | 1 | Stage 0 output contract - structured brief produced by the synthesis engine that becomes Stage 1 input |
...
| [venture_provisioning_state](tables/venture_provisioning_state.md) | 2 | ✅ | 2 | Tracks venture provisioning lifecycle: repo creation, registry entry, schema setup, CI/CD config, and conformance checks. Referenced by the Stage 18 post-approval hook and create-ehg-venture --register. |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 656 | ✅ | 3 | - |
...
| [venture_stage_transitions](tables/venture_stage_transitions.md) | 112 | ✅ | 1 | - |
| [venture_stage_work](tables/venture_stage_work.md) | 153 | ✅ | 5 | - |
...
| [venture_telemetry](tables/venture_telemetry.md) | 6 | ✅ | 2 | - |
...
| [venture_token_ledger](tables/venture_token_ledger.md) | 647 | ✅ | 4 | Golden Nugget: Token/compute investment tracking per venture |
| [venture_tool_quotas](tables/venture_tool_quotas.md) | 0 | ✅ | 1 | - |
| [ventures](tables/ventures.md) | 26 | ✅ | 2 | - |
...
| [vision_readiness_blocked](tables/vision_readiness_blocked.md) | 0 | ❌ | 0 | SD-LEO-INFRA-VISION-DOCUMENT-READINESS-001 FR-2: audit log of every vision-scorer.js graceful-failure event (verdict=human_review_floor_dims with reason=vision_not_ready). Helper at lib/eva/audit-vision-readiness.js writes rows. 60s dedup window prevents audit storm. Complementary to SD-LEO-INFRA-UNIFY-VENTURE-NON-001 (which prevents NEW unready-doc generation at the writer layer); this audit tracks consumer-side graceful failures for the 56 LEGACY unready docs. |
| [vision_scoring_audit_log](tables/vision_scoring_audit_log.md) | 567 | ❌ | 0 | Audit trail for vision scoring gate evaluations with dynamic threshold context. SD-CONTEXTAWARE-VISION-SCORING-DYNAMIC-ORCH-001-A |
...
| [worker_heartbeats](tables/worker_heartbeats.md) | 984 | ✅ | 1 | - |
...
| [workflow_executions](tables/workflow_executions.md) | 3,809 | ✅ | 3 | - |
| [workflow_recovery_state](tables/workflow_recovery_state.md) | 0 | ✅ | 2 | Tracks recovery attempts and status |
| [workflow_trace_log](tables/workflow_trace_log.md) | 556,015 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

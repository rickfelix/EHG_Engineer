...
| [agent_artifacts](tables/agent_artifacts.md) | 13,926 | ✅ | 3 | Stores large tool outputs as artifacts with summary pointers for context efficiency |
...
| [agent_task_contracts](tables/agent_task_contracts.md) | 14,005 | ✅ | 4 | Task contracts for sub-agent handoffs. Sub-agents read their contract from this table
...
| [ai_quality_assessments](tables/ai_quality_assessments.md) | 28,294 | ✅ | 3 | AI-powered quality assessments using Russian Judge rubrics (gpt-4o-mini). Stores all quality evaluations for meta-analysis and continuous improvement. |
...
| [audit_log](tables/audit_log.md) | 82,179 | ✅ | 2 | Generic audit log for tracking system events, changes, and governance actions across all LEO Protocol entities. |
...
| [codebase_health_snapshots](tables/codebase_health_snapshots.md) | 326 | ✅ | 2 | - |
...
| [connection_selection_log](tables/connection_selection_log.md) | 3,332 | ✅ | 2 | Audit trail for connection method selection. Auto-cleanup recommended at 30 days. |
...
| [eva_audit_log](tables/eva_audit_log.md) | 698 | ✅ | 3 | EVA Audit Trail - All actions logged |
...
| [eva_consultant_recommendations](tables/eva_consultant_recommendations.md) | 380 | ✅ | 2 | Actionable recommendations generated by EVA trend analysis for chairman review |
...
| [eva_interactions](tables/eva_interactions.md) | 13,675 | ✅ | 1 | Core table capturing all EVA chairman-system interactions for closed-loop learning (SD-LEO-FEAT-DATA-FLYWHEEL-001) |
...
| [eva_vision_scores](tables/eva_vision_scores.md) | 3,672 | ✅ | 2 | Append-only scoring records. rubric_snapshot is frozen at score time for immutable audit trail. sd_id is an intentional soft TEXT reference to SD keys — no FK to allow async SD creation. |
...
| [feedback](tables/feedback.md) | 1,283 | ✅ | 8 | - |
...
| [fleet_liveness_estimates](tables/fleet_liveness_estimates.md) | 5,685 | ✅ | 2 | Append-only Monte Carlo liveness estimates per fleet worker per cycle. Feeds the calibration loop: actual_liveness_t5 is back-filled 5 minutes after observed_at by comparing predicted p_alive against ground truth. |
...
| [governance_audit_log](tables/governance_audit_log.md) | 409,701 | ✅ | 2 | - |
...
| [handoff_audit_log](tables/handoff_audit_log.md) | 23,811 | ✅ | 2 | Audit trail for all handoff creation attempts, including blocked bypasses |
...
| [issue_patterns](tables/issue_patterns.md) | 1,247 | ✅ | 5 | Learning history system: stores recurring issues, proven solutions, and success metrics for cross-session knowledge retention |
...
| [leo_handoff_executions](tables/leo_handoff_executions.md) | 13,697 | ✅ | 3 | Tracks all LEO Protocol handoff executions with full audit trail. Used by unified-handoff-system.js for workflow orchestration. |
...
| [leo_scoring_rubrics](tables/leo_scoring_rubrics.md) | 1,389 | ✅ | 2 | Versioned, immutable scoring rubrics for deterministic prioritization. SD: SD-LEO-SELF-IMPROVE-001G Phase 3a |
...
| [management_reviews](tables/management_reviews.md) | 26,899 | ✅ | 2 | - |
...
| [model_usage_log](tables/model_usage_log.md) | 39,541 | ✅ | 2 | RLS: Append-only for authenticated |
...
| [outcome_signals](tables/outcome_signals.md) | 1,919 | ✅ | 1 | - |
...
| [permission_audit_log](tables/permission_audit_log.md) | 31,140 | ❌ | 0 | Audit trail for tool permission enforcement decisions. Written async (fire-and-forget) by pre-tool-enforce.cjs hook. Never blocks enforcement. |
...
| [quick_fixes](tables/quick_fixes.md) | 393 | ✅ | 2 | LEO Quick-Fix Workflow: Lightweight issue tracking for UAT-discovered bugs/polish (≤50 LOC).
...
| [retro_notifications](tables/retro_notifications.md) | 3,047 | ✅ | 2 | - |
...
| [retrospectives](tables/retrospectives.md) | 6,342 | ✅ | 2 | - |
| [retrospectives_audit](tables/retrospectives_audit.md) | 3,097 | ✅ | 2 | - |
| [risk_assessments](tables/risk_assessments.md) | 1,397 | ✅ | 2 | BMAD Enhancement: Multi-domain risk assessment for Strategic Directives |
...
| [root_cause_reports](tables/root_cause_reports.md) | 1,103 | ✅ | 4 | Root cause investigation records for failures, defects, and quality issues across LEO Protocol |
...
| [sd_effectiveness_metrics](tables/sd_effectiveness_metrics.md) | 1,686 | ✅ | 1 | - |
...
| [sd_phase_handoffs](tables/sd_phase_handoffs.md) | 22,969 | ✅ | 11 | DEPRECATED: Use leo_handoff_executions instead. This table is empty (0 records) and was created after leo_handoff_executions (166 records). Kept for backwards compatibility only. Single source of truth: leo_handoff_executions. |
...
| [sd_scope_deliverables](tables/sd_scope_deliverables.md) | 13,880 | ✅ | 2 | Tracks deliverables extracted from SD scope documents to ensure all promises are fulfilled |
...
| [sd_transition_audit](tables/sd_transition_audit.md) | 466 | ❌ | 0 | Captures pre/post state for all SD phase transitions, enabling rollback and debugging |
...
Reference: Consistency + Autonomy Architecture Plan |
| [sd_verification_results](tables/sd_verification_results.md) | 588 | ❌ | 0 | - |
...
| [session_coordination](tables/session_coordination.md) | 426 | ✅ | 1 | Cross-session messaging for fleet coordination. Written by orchestrator/sweep, read by worker hooks. |
| [session_lifecycle_events](tables/session_lifecycle_events.md) | 12,281 | ✅ | 2 | Audit log for session lifecycle events: create, heartbeat, stale, release. Part of FR-5. |
...
| [shipping_decisions](tables/shipping_decisions.md) | 1,994 | ✅ | 2 | - |
...
| [strategic_directives_v2](tables/strategic_directives_v2.md) | 3,299 | ✅ | 7 | RLS enabled: service_role full access, authenticated read-only |
...
| [sub_agent_execution_results](tables/sub_agent_execution_results.md) | 23,960 | ✅ | 4 | LEO 5.0 Sub-agent execution results - tracks individual sub-agent runs and outputs |
...
| [subagent_validation_results](tables/subagent_validation_results.md) | 13,272 | ✅ | 3 | - |
...
| [task_hydration_log](tables/task_hydration_log.md) | 2,426 | ✅ | 2 | LEO 5.0 Task hydration log - tracks phase task generation events |
...
| [user_stories](tables/user_stories.md) | 9,292 | ✅ | 3 | RLS enabled: service_role full access, authenticated read-only |
| [validation_audit_log](tables/validation_audit_log.md) | 57,729 | ✅ | 1 | Audit log for LEO Protocol validation failures including bypass detection, coverage validation, and gate failures |
...
| [venture_separability_scores](tables/venture_separability_scores.md) | 704 | ✅ | 3 | - |
...
| [workflow_trace_log](tables/workflow_trace_log.md) | 544,040 | ✅ | 2 | Stores workflow telemetry spans for bottleneck detection (SD-LEO-ENH-WORKFLOW-TELEMETRY-AUTO-001A) |

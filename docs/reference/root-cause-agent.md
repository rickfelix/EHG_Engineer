...
- [💬 Slash Command: `/rca` (NEW in v2.1)](#-slash-command-rca-new-in-v21)
  - [Command Definition](#command-definition)
  - [Usage](#usage)
  - [RCA Levels (Progressive Escalation)](#rca-levels-progressive-escalation)
  - [Integration with Sub-Agent](#integration-with-sub-agent)
- [🔍 Proactive Learning Integration (NEW in v2.0)](#-proactive-learning-integration-new-in-v20)
  - [Before Starting ANY RCA Work](#before-starting-any-rca-work)
- [⚡ Automatic RCA Trigger System (NEW in v2.1)](#-automatic-rca-trigger-system-new-in-v21)
  - [RCA Trigger SDK](#rca-trigger-sdk)
  - [Integration Points](#integration-points)
  - [Usage Example](#usage-example)
  - [Database Schema](#database-schema)
  - [Auto-Trigger Patterns (Legacy Manual Invocation)](#auto-trigger-patterns-legacy-manual-invocation)
  - [Manual Invocation Protocol (When Auto-Trigger Not Available)](#manual-invocation-protocol-when-auto-trigger-not-available)
- [🚫 Workaround Anti-Patterns (NEW in v2.0)](#-workaround-anti-patterns-new-in-v20)
  - [Response Template for Workaround Requests](#response-template-for-workaround-requests)
- [Automatic Trigger Flow (T1-T4)](#automatic-trigger-flow-t1-t4)
  - [Tier 1 (Critical) - Auto-creates P0 RCRs](#tier-1-critical---auto-creates-p0-rcrs)
  - [Tier 2 (High) - Auto-creates P1 RCRs](#tier-2-high---auto-creates-p1-rcrs)
  - [Tier 3 (Medium) - Auto-creates P2 RCRs](#tier-3-medium---auto-creates-p2-rcrs)
  - [Tier 4 (Manual) - Operator-initiated](#tier-4-manual---operator-initiated)
- [Investigation Phase (CLI Commands)](#investigation-phase-cli-commands)
  - [1. List Open RCRs](#1-list-open-rcrs)
  - [2. View RCR Details](#2-view-rcr-details)
  - [3. Check Gate Status](#3-check-gate-status)
  - [4. Get SD Status](#4-get-sd-status)
- [CAPA Generation](#capa-generation)
  - [What is a CAPA?](#what-is-a-capa)
  - [Generate CAPA](#generate-capa)
  - [Update CAPA](#update-capa)
  - [Approve CAPA](#approve-capa)
...
- [Verification Phase](#verification-phase)
  ...
  - [Verify CAPA](#verify-capa)
  - [Verification Failure](#verification-failure)
- [Learning Capture](#learning-capture)
  - [Automatic Learning Ingestion](#automatic-learning-ingestion)
  - [What Gets Captured?](#what-gets-captured)
  - [EVA Integration](#eva-integration)
- [Manual Trigger Flow](#manual-trigger-flow)
  - [When to Use Manual Triggers](#when-to-use-manual-triggers)
  - [Manual Trigger Steps](#manual-trigger-steps)
- [Gate Enforcement](#gate-enforcement)
  - [How the Gate Works](#how-the-gate-works)
  - [Example: Blocked Handoff](#example-blocked-handoff)
  - [Example: Passed Handoff](#example-passed-handoff)
- [Dashboard Queries](#dashboard-queries)
  - [Analytics Overview (Last 30 Days)](#analytics-overview-last-30-days)
  - [Pattern Recurrence Analysis](#pattern-recurrence-analysis)
  - [Comprehensive Analytics with Taxonomy](#comprehensive-analytics-with-taxonomy)
  - [RCRs Blocking Handoffs](#rcrs-blocking-handoffs)
  - [Learning Pipeline Status](#learning-pipeline-status)
- [Troubleshooting](#troubleshooting)
  - [Issue: RCR Not Auto-Created](#issue-rcr-not-auto-created)
  - [Issue: Gate Blocking Despite Verified CAPA](#issue-gate-blocking-despite-verified-capa)
  - [Issue: Learning Ingestion Failing](#issue-learning-ingestion-failing)
  - [Issue: Confidence Score Stuck at 40-50](#issue-confidence-score-stuck-at-40-50)
  - [Issue: RCRs Automatically Going STALE](#issue-rcrs-automatically-going-stale)
...
- [Integration Points](#integration-points)
  ...
  - [With Sub-Agents](#with-sub-agents)
  - [With EVA](#with-eva)
...
- [Changelog](#changelog)
  ...
  - [v2.1.0 (2026-01-26)](#v210-2026-01-26)

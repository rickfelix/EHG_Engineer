...
- **Primary Metrics**: Checklist completion, Risk score, Readiness rating
...
cat docs/workflow/stages.yaml | sed -n '873,918p'  # Stage 21 definition
cat docs/workflow/critique/stage-21.md              # Critique (71 lines)

# Regenerate dossier (if automation exists)
# node scripts/generate-stage-dossier.js --stage=20 --output=docs/workflow/dossiers/stage-21/
```

**Source Evidence**:
- Stage Definition: EHG_Engineer@6ef8cf4:docs/workflow/stages.yaml:919-964 "id: 20, title: Final Pre-Flight Check"
- Critique Analysis: EHG_Engineer@6ef8cf4:docs/workflow/critique/stage-21.md:1-71 "Overall: 3.0, Functional but needs optimization"

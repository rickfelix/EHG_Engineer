...
2. **[Quick Setup](guides/SIMPLE_PROJECT_SETUP.md)** - Get running in 5 minutes
...
- **[Documentation Standards](DOCUMENTATION_STANDARDS.md)** - How we document
...
### Cross-Phase
- **[Handoff System](reference/handoff-system-guide.md)** - Inter-phase handoffs
- **[Sub-Agent Patterns](reference/sub-agent-patterns-guide.md)** - When to invoke sub-agents
...
### Troubleshooting
- **[Connection Issues](troubleshooting/DATABASE_CONNECTION_ISSUE_SD-VISION-V2-003.md)** - Common connection problems
...
### Testing Guides
- **[Testing Overview](05_testing/README.md)** - Testing philosophy
...
- **[Deployment Guide](06_deployment/README.md)** - Deployment overview
...
### Sub-Agent System
- **[Agent Directory](../.claude/agents/README.md)** - All available agents
...
- **[Sub-Agent Patterns](reference/sub-agent-patterns-guide.md)** - Best practices
...
- [Design Patterns](reference/design-sub-agent-guide.md)
...
**Guides & How-Tos**:
- [guides/](guides/README.md) - 60+ step-by-step guides
...
**Specific Issues**:
- **Database connection**: [Database Connection Issues](troubleshooting/DATABASE_CONNECTION_ISSUE_SD-VISION-V2-003.md)
...
1. **Read Standards**: [DOCUMENTATION_STANDARDS.md](DOCUMENTATION_STANDARDS.md)
2. **Follow Structure**: [DIRECTORY_STRUCTURE.md](DIRECTORY_STRUCTURE.md)
...
| Testing guide | [05_testing/README.md](05_testing/README.md) |
| Sub-agent list | [Agent Directory](../.claude/agents/README.md) |

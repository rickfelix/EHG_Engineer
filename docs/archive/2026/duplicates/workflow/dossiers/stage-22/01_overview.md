...
---
<!-- ARCHIVED: 2026-01-26T16:26:33.926Z
     Reason: Duplicate of canonical file
     Original location: docs\workflow\dossiers\stage-22\01_overview.md
     See: docs/fixes/duplicate-consolidation-manifest.json for details
-->

# Stage 22 Operating Dossier: Iterative Development Loop
...
- **Primary Metrics**: Sprint velocity, Burn rate, Quality metrics
...
cat docs/workflow/stages.yaml | sed -n '873,918p'  # Stage 22 definition
cat docs/workflow/critique/stage-22.md              # Critique (71 lines)

# Regenerate dossier (if automation exists)
# node scripts/generate-stage-dossier.js --stage=20 --output=docs/workflow/dossiers/stage-22/
```

**Source Evidence**:
- Stage Definition: EHG_Engineer@6ef8cf4:docs/workflow/stages.yaml:965-1010 "id: 20, title: Iterative Development Loop"
- Critique Analysis: EHG_Engineer@6ef8cf4:docs/workflow/critique/stage-22.md:1-71 "Overall: 3.0, Functional but needs optimization"
...
- Provides loaded context to Stage 22 (pre-flight check)

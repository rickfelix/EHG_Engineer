...
<!-- ARCHIVED: 2026-01-26T16:26:55.212Z
     Reason: Duplicate of canonical file
     Original location: docs\workflow\dossiers\stage-22\11_acceptance-checklist.md
...
cat ../stage-25/07_recursion-blueprint.md | grep -E "Trigger SPRINT-[0-9]+" | wc -l
```
...
TRIGGERS=$(cat ../stage-25/07_recursion-blueprint.md | grep -E "Trigger SPRINT-[0-9]+" | wc -l)

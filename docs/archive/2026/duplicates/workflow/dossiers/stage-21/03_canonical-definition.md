<!-- ARCHIVED: 2026-01-26T16:26:38.574Z
     Reason: Duplicate of canonical file
     Original location: docs\workflow\dossiers\stage-21\03_canonical-definition.md
     See: docs/fixes/duplicate-consolidation-manifest.json for details
-->

# Stage 21: Canonical Definition
...
**Source File**: EHG_Engineer@6ef8cf4:docs/workflow/stages.yaml:919-964
**Commit**: 6ef8cf4
...
**Title**: "Final Pre-Flight Check"
**Evidence**: EHG_Engineer@6ef8cf4:docs/workflow/stages.yaml:874 "title: Final Pre-Flight Check"
...
**Evidence**: EHG_Engineer@6ef8cf4:docs/workflow/stages.yaml:887 "- Checklist completion"
...
**Evidence**: EHG_Engineer@6ef8cf4:docs/workflow/stages.yaml:888 "- Risk score"
**Definition**: Time to load context from cold start (no cache)
**Calculation**: Elapsed time from Stage 21 start to context available
...
**Evidence**: EHG_Engineer@6ef8cf4:docs/workflow/stages.yaml:889 "- Readiness rating"
...
**Blocker If False**: Cannot start Stage 21 (no data to load)
...
**Definition**: Risk score meets <500ms target
...
**Definition**: Checklist completion ≥90%, accuracy verified (spot-check embeddings)
...
**Interpretation**:
- **Manual**: EXEC runs Stage 21 step-by-step (6-12 hours, current state for new ventures)
- **Assisted**: Semi-automated (EXEC triggers Stage 21, automation handles substages, 2-4 hours)
- **Auto**: Fully automated (EVA triggers Stage 21 on Stage 19 completion, 1-2 hours, target state)

**Current Automation Level**: 5/5 (per critique, EHG_Engineer@6ef8cf4:docs/workflow/critique/stage-21.md:11 "Automation Leverage | 5 | Fully automatable")
...
**Resolution**: Stage 21 likely EVA-owned (fully automated, no human judgment required)

### Risk Level (Not Specified in YAML)

**Risk Level**: 2/5 (moderate, from critique)
**Evidence**: EHG_Engineer@6ef8cf4:docs/workflow/critique/stage-21.md:10 "Risk Exposure | 2 | Moderate risk level"
...
**Critique Assessment**: "Critical Path: No" (EHG_Engineer@6ef8cf4:docs/workflow/critique/stage-21.md:60)
**Dossier Assessment**: "Critical Path: YES" (per 02_stage-map.md analysis)
**Rationale for Override**: Stage 21 blocks Stage 21 (pre-flight check), which blocks Stage 22 (dev loop), making it critical

## Ambiguities and Open Questions

### Ambiguity 1: Metrics Thresholds
**Issue**: YAML defines metrics but not thresholds
**Example**: "Checklist completion" metric exists, but is 90% the target? 95%? 100%?
...
**Evidence**: EHG_Engineer@6ef8cf4:docs/workflow/critique/stage-21.md:38 "Missing: Threshold values"
...
**Canonical Status**: This YAML is the single source of truth for Stage 21 definition. All dossier files derive from this specification.

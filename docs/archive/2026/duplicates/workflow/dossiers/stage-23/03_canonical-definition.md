...
<!-- ARCHIVED: 2026-01-26T16:26:38.392Z
     Reason: Duplicate of canonical file
     Original location: docs\workflow\dossiers\stage-23\03_canonical-definition.md
     See: docs/fixes/duplicate-consolidation-manifest.json for details
-->

# Stage 23: Canonical Definition
...
**Source File**: EHG_Engineer@6ef8cf4:docs/workflow/stages.yaml:1011-1056
**Commit**: 6ef8cf4
...
**Title**: "Continuous Feedback Loops"
**Evidence**: EHG_Engineer@6ef8cf4:docs/workflow/stages.yaml:874 "title: Continuous Feedback Loops"
...
**Evidence**: EHG_Engineer@6ef8cf4:docs/workflow/stages.yaml:887 "- Feedback volume"
...
**Evidence**: EHG_Engineer@6ef8cf4:docs/workflow/stages.yaml:888 "- Response time"
**Definition**: Time to load context from cold start (no cache)
**Calculation**: Elapsed time from Stage 23 start to context available
...
**Evidence**: EHG_Engineer@6ef8cf4:docs/workflow/stages.yaml:889 "- Implementation rate"
...
**Blocker If False**: Cannot start Stage 23 (no data to load)
...
**Blocker If False**: Stage 23 cannot validate readiness (incomplete context)

#### Gate 2: Performance Optimized
**Evidence**: EHG_Engineer@6ef8cf4:docs/workflow/stages.yaml:896 "- Performance optimized"
**Definition**: Response time meets <500ms target
...
**Definition**: Feedback volume ≥90%, accuracy verified (spot-check embeddings)
...
**Interpretation**:
- **Manual**: EXEC runs Stage 23 step-by-step (6-12 hours, current state for new ventures)
- **Assisted**: Semi-automated (EXEC triggers Stage 23, automation handles substages, 2-4 hours)
- **Auto**: Fully automated (EVA triggers Stage 23 on Stage 19 completion, 1-2 hours, target state)

**Current Automation Level**: 5/5 (per critique, EHG_Engineer@6ef8cf4:docs/workflow/critique/stage-23.md:11 "Automation Leverage | 5 | Fully automatable")
...
**Resolution**: Stage 23 likely EVA-owned (fully automated, no human judgment required)

### Risk Level (Not Specified in YAML)

**Risk Level**: 2/5 (moderate, from critique)
**Evidence**: EHG_Engineer@6ef8cf4:docs/workflow/critique/stage-23.md:10 "Risk Exposure | 2 | Moderate risk level"
...
**Critique Assessment**: "Critical Path: No" (EHG_Engineer@6ef8cf4:docs/workflow/critique/stage-23.md:60)
**Dossier Assessment**: "Critical Path: YES" (per 02_stage-map.md analysis)
**Rationale for Override**: Stage 23 blocks Stage 23 (pre-flight check), which blocks Stage 22 (dev loop), making it critical

## Ambiguities and Open Questions

### Ambiguity 1: Metrics Thresholds
**Issue**: YAML defines metrics but not thresholds
**Example**: "Feedback volume" metric exists, but is 90% the target? 95%? 100%?
...
**Evidence**: EHG_Engineer@6ef8cf4:docs/workflow/critique/stage-23.md:38 "Missing: Threshold values"
...
**Canonical Status**: This YAML is the single source of truth for Stage 23 definition. All dossier files derive from this specification.

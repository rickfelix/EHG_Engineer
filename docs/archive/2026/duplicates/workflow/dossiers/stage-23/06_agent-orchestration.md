...
---
<!-- ARCHIVED: 2026-01-26T16:26:44.836Z
     Reason: Duplicate of canonical file
     Original location: docs\workflow\dossiers\stage-23\06_agent-orchestration.md
     See: docs/fixes/duplicate-consolidation-manifest.json for details
-->

# Stage 23: Agent Orchestration
...
**Crew Name**: Stage23Crew  
**Purpose**: Automate Stage 23 (Continuous Feedback Loops)  
**Owner**: EXEC/EVA  

...
---
<!-- ARCHIVED: 2026-01-26T16:26:34.114Z
     Reason: Duplicate of canonical file
     Original location: docs\workflow\dossiers\stage-20\01_overview.md
     See: docs/fixes/duplicate-consolidation-manifest.json for details
-->

# Stage 20 Operating Dossier: Enhanced Context Loading
...
- **Primary Metrics**: Context completeness, Loading performance, Memory efficiency
...
cat docs/workflow/stages.yaml | sed -n '873,918p'  # Stage 20 definition
cat docs/workflow/critique/stage-20.md              # Critique (71 lines)

# Regenerate dossier (if automation exists)
# node scripts/generate-stage-dossier.js --stage=20 --output=docs/workflow/dossiers/stage-20/
```

**Source Evidence**:
- Stage Definition: EHG_Engineer@6ef8cf4:docs/workflow/stages.yaml:873-918 "id: 20, title: Enhanced Context Loading"
- Critique Analysis: EHG_Engineer@6ef8cf4:docs/workflow/critique/stage-20.md:1-71 "Overall: 3.0, Functional but needs optimization"
...
- Provides loaded context to Stage 21 (pre-flight check)

...
<!-- ARCHIVED: 2026-01-26T16:26:55.053Z
     Reason: Duplicate of canonical file
     Original location: docs\workflow\dossiers\stage-20\11_acceptance-checklist.md
...
cat ../stage-25/07_recursion-blueprint.md | grep -E "Trigger CONTEXT-[0-9]+" | wc -l
```
...
TRIGGERS=$(cat ../stage-25/07_recursion-blueprint.md | grep -E "Trigger CONTEXT-[0-9]+" | wc -l)
